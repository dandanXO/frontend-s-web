          ...
          <div v-else class="selected-promo">
            ...
            <div class="selected-promo-wrapper">
              ...
              <div class="banner-container">
                <img
                  class="promo-content"
                  :src="require(`../assets/images/promotion/tempo/` + selectedPromo.mobileBannerUrl)"
