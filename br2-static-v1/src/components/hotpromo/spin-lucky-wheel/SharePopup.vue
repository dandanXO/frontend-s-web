<template>
  <q-dialog position="top" class="share-popup" v-model="_modelValue" @hide="hideSharePopup" @show="handleDialogShow">
    <div class="top">
      <q-btn v-close-popup class="close-btn" flat>
      ...
      <div class="popout-dialog-container">
        ...
        <div class="modal-invite-share-social">
          <a
            ...
            target="_blank"
          >
            <img src="../../../assets/images/sideMenu/socialMedia/icon-whatsapp.png" />
          </a>
          ...
          <a
            ...
            target="_blank"
          >
            <img src="../../../assets/images/sideMenu/socialMedia/icon-instagram.png" />
          </a>

          <a class="social-item" @click="handleShareToTikTok(selfTgurl)">
            <img src="../../../assets/images/sideMenu/socialMedia/icon-tiktok.png" />
          </a>
          <a ref="tiktokRef" href="tiktok://" target="_blank" :style="{ display: 'none' }" />

          <a class="social-item" @click="handleShareToYoutube(selfTgurl)">
            <img src="../../../assets/images/sideMenu/socialMedia/icon-youtube.png" />
          </a>

          <a class="social-item" @click="handleShareToSMS(selfTgurl)">
            <img src="../../../assets/images/sideMenu/socialMedia/icon-sms.png" />
          </a>

          <a class="social-item" @click="handleShareToEmail(selfTgurl)">
            <img src="../../../assets/images/sideMenu/socialMedia/icon-viber.png" />
          </a>
        </div>
      </div>
    </div>
