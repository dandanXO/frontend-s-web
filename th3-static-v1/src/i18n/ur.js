export default {
  ...
  form: {
    ...
    phone_rules_02: "فون نمبر میں 10 ہندسے ہونے چاہئیں",
    phone_rules_03: "فون نمبر '0' سے شروع ہونا چاہئے",
  ...
  btn: {
    ...
    areyounew: "کیا آپ SuperSiam پر نئے ہیں؟",
  ...
  withdraw: {
    ...
    video: "ویڈیو",
    checkReceivingLimit:
      "براہ کرم نکاسی کرنے سے پہلے یقینی بنائیں کہ آپ کے والیٹ کی وصولی کی حد کافی ہے تاکہ لین دین کی ناکامی سے بچا جا سکے۔",
    bindCardCorrectFormat: "اپنے والیٹ/بینک کارڈ کو درست فارمیٹ میں لنک کریں۔",
    dailyWalletLimit:
      "روزانہ والیٹ کی حد: THB 50,000۔ اس حد سے تجاوز نہ کریں۔ آپ نکالنے کے لیے متعدد والیٹس شامل کر سکتے ہیں۔",
    donotexceeddaily:
      "روزانہ بینک کارڈ کی حد: THB 500,000۔ اس حد سے تجاوز نہ کریں۔ آپ نکالنے کے لیے متعدد بینک کارڈز شامل کر سکتے ہیں۔",
...
انعامات کی تقسیم کا وقت: اگلے دن تھائی لینڈی وقت کے مطابق دوپہر 3:00 بجے سے شام 6:00 بجے تک۔ اس وقت کے دوران انعامات اکاؤنٹ میں منتقل کر دیے جائیں گے۔`,
      shareTitle: "SuperSiam شیئر کریں اور کمائیں",
      shareText:
        "SuperSiam شیئر کریں اور کمائیں:\nہر دوست کے لئے 1000 روپے تک کمائیں۔\nاپنے پہلے ڈپازٹ پر 5% کی رعایت حاصل کریں۔\nتمام بیٹس پر طویل مدتی 0.6% کی رعایت کا لطف اٹھائیں۔\nابھی ایپ ڈاؤن لوڈ کریں اور ایک خفیہ نقد انعام حاصل کریں!\n{url}",
      betting_table: {
        header: {
          description: "تفصیل",
  ...
  hotPromo: {
    ...
    depositSpinWheel: {
      ...
      upto: "تک",
      remainingTimes: "باقی اوقات",
      depositSpin: "1 اسپن حاصل کرنے کے لیے THB {min} جمع کریں۔",
      spin: "گھماؤ",
      rules: "قواعد",
      activityRules: "سرگرمی کے قواعد",
      rule_01:
      ...
      rule_05:
        "اس ایونٹ کی تشریح کا حق SuperSiam کے پاس محفوظ ہے۔ اگر آپ کے کوئی سوالات ہوں تو براہ کرم کسٹمر سروس سے رابطہ کریں۔",
      silver: "سلور",
      gold: "گولڈ",
      diamond: "ڈائمنڈ",
      supreme: "سپریم"
    ...
    spinReferWheel: {
      ...
      willBePaidToYourRsAccount: "آپ کے THB اکاؤنٹ میں ادائیگی کی جائے گی",
  ...
  content: {
    ...
    message1: "جب آپ کی جمع شدہ رقم 1000 THB تک پہنچ جائے، تو آپ رقم نکال سکتے ہیں۔",
    message2:
    ...
    cashRainClaimCondition:
      "ایک ہی دن میں کم از کم THB 300 جمع کروائیں اور روزانہ کی شرطیں کم از کم THB 350 تک مکمل کریں تاکہ آپ اپنا مفت بونس حاصل کر سکیں۔",
