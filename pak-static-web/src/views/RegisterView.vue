  ...
  <div class="login-container">
    <div class="margin-center login-form-wrapper">
      ...
      <!-- <a-tabs v-model:activeKey="tabActive" class="form-wrapped" @change="resetForm">
        <a-tab-pane key="username" tab="Username">
        </a-tab-pane><a-tab-pane key="mobile" tab="Mobile">
          <a-form ref="formRef" :model="regForm" :rules="rules">
            ...
            <div class="txt-center reg-protocol">
              ...
              <a class="pwd-tip" to="#" @click="openUserRegistration">
      ...
      <a-form ref="formRef" :model="regForm" :rules="rules">
        ...
        <a-form-item ref="password" name="password">
          ...
          >
            ...
            <template #suffix>
              <RiEyeFill v-if="!togglePwd" @click="togglePwd = !togglePwd" />
              <RiEyeOffFill v-if="togglePwd" @click="togglePwd = !togglePwd" />
            </template>
          </a-input>
        </a-form-item>
        <!-- <div v-if="regForm.password" class="password-str-div">
        ...
        <a-form-item ref="realName" required name="realName">
          <a-input v-model:value="regForm.realName" placeholder="Complete Name ( Including Surname)">
            <template #prefix>
              <RiUserFill />
            </template>
          </a-input>
        ...
        <a-form-item ref="telephone" name="telephone" class="inlinerow">
          <a-input v-model:value="regForm.telephone" placeholder="Mobile Number" autocomplete="off">
            <template #prefix>
              <RiSmartphoneFill />
              <span style="color: #83a3ca; margin-top: 4px">&nbsp;+63</span>
            </template>
          </a-input>
          <button
        ...
        <a-modal v-model:visible="isTelephoneVerificationModalVisible" :width="500">
          <a-form-item ref="telephoneVerifyCaptchaCode" required name="telephoneVerifyCaptchaCode">
            <a-input v-model:value="regForm.telephoneVerifyCaptchaCode" :maxlength="4" placeholder="Verification code">
              <template #prefix>
                <RiShieldCheckFill />
              </template>
            </a-input>
        ...
        <!-- <a-form-item ref="captchaCode" required name="captchaCode">
          <a-input v-model:value="regForm.captchaCode" :maxlength="4" placeholder="Verification code">
            <template #prefix>
              <RiShieldCheckFill />
            </template>
          </a-input>
        ...
        <!-- <a-form-item ref="codeAffiliate" name="codeAffiliate">
          ...
          <a-input v-if="!hasAffiliate" v-model:value="regForm.codeAffiliate" placeholder="Affiliate Code">
            <template #prefix>
              <RiQrCodeFill />
            </template>
          </a-input>
    ...
    <a-modal closable v-model:visible="isUserRegistrationModalVisible" width="90%">
      ...
      <div class="user-protocol">
        <div class="userreg-text title-sub">1. Acceptance of the Terms of Service</div>
        <p>
          These terms of service are entered into by and between Play4Win ("Company", "we" or "us"). The following terms
          of service, (collectively, these "ToS"), govern your access to and use of the Website www.play4win.cc
          ("Website"), including any content, functionality and services offered on or through the Website, whether as a
          guest or a registered user. You acknowledge and agree with our terms and conditions with and without
          reservation.
        </p>
        <p>
          These ToS come into force as soon as You access the Website, by doing which You signify to play4win.cc that
          You have read these ToS and accept them. By using any page of the Websites You signify that You agree entirely
          with these ToS and our Privacy Policy. If you do not want to agree to these ToS or the Privacy Policy, you
          must not access or use the Website.
        </p>
        <p>By using this Website, you represent, warrant, and agree that:</p>
        <p>
          You are under no legal disability that would prevent you from forming a binding contract with the Company.
          <br />
          You are at least 18 years of age or such higher minimum legal age of majority as stipulated in the laws of
          jurisdiction applicable to You.
          <br />
          You will provide accurate information to the Company for purposes of establishing a user account on this
          Website.
        </p>
        ...
        <p>
          ...
          <br />
          These terms of service are entered into by and between Play4Win ("Company", "we" or "us") operating under the
          license ( ), a limited liability company organized under the laws of (insert Play4Win country here), having
          its registered address at (insert Play4Win address here). The following terms of service, (collectively, these
          "ToS"), govern your access to and use of the Website www.play4win.cc ("Website"), including any content,
          functionality and services offered on or through the Website, whether as a guest or a guest or a registered
          user. You acknowledge and agree with our terms and conditions in with and without reservation.
        </p>
        <p>
          You are under no legal disability that would prevent you from forming a binding contract with the Company.
          <br />
        ...
        <div class="userreg-text title-sub">2. Your Obligations as a Player</div>
        <p>
          By using this Website, you represent, warrant, and agree that:
          <br />
          In the case of identification of a minor player, the account will be closed immediately.
          <br />
          You will use this Website and your play4win.cc Account solely and exclusively for the purpose of Your genuine
          participating in the Games and not for any financial or other operations, Your participation in the Games will
          be strictly in Your personal non-professional capacity for recreational and entertainment reasons only;
          <br />
          People living or having a permanent or temporary residence in these countries are not entitled to register the
          player's account on play4win.cc, or the use of service play4win.cc:
          <br />
          Aruba, Austria, Bonaire, Curacao, French Guiana, French Polynesia, Germany, Guernsey, Gibraltar, Hungary, Isle
          of Man, Jersey, Liechtenstein, Luxembourg, Martinique, Reunion, Mayotte, Netherlands, Spain, United States,
          United Kingdom.
        </p>
        <p>
          Residents from the aforementioned territories are prohibited from opening an account or in any way use the
          gaming services offered by play4win.cc.
        </p>

        <p>
          In the jurisprudence of your country or the country where You are currently staying gambling and / or games of
          chance they may be prohibited. You are responsible for making sure such restrictions and / or bans in their
          home country or the country in which he resides. It is up to You to ensure that You act in accordance with the
          laws of your home country or the country where You currently reside. You have no right to use the services
          with an anonymizing proxy, VPN or the like in order to bypass the law resulting from the blockade by
          play4win.cc countries. In case of violation of these principles play4win.cc reserves the right to block and /
          or immediately close the account and You lose all wins.
        </p>

        <p>
          All information that You provide to play4win.cc during the term of validity of this agreement is true,
          complete, and correct, and that You shall immediately notify play4win.cc of any change of such information;
        </p>

        <p>
          You are solely responsible for reporting and accounting for any taxes applicable to You under relevant laws
          for any winnings that You receive from play4win.cc.
        </p>

        <p>
          Bonus and promotion abuse:
          <br />
          If Play4Win notices that any promotional offer is being abused and/or our terms are being breached, we may
          take the following actions against such abusers:
        </p>

        <p>
          Revoke and/or cancel any bonuses and confiscate bonus winnings that we regard may have been redeemed by misuse
          of the system or creating multiple accounts
          <br />
        ...
        <p>
          ...
          <br />
          Evidence that an offer is being claimed or benefits the same person or group of persons, acting in an attempt
          to defraud us, is considered bonus abuse and any potential winnings generated from that offer will be
          canceled/confiscated
          <br />
          Equal, zero or low margin bets
          <br />
          Wagering bonuses on excluded games
          <br />
          Co-operation, collusion or organization of bets from the same source
          <br />
          Manipulation of software, exploitation of loopholes or other technical forms of abuse or other behavior which
          amounts to deliberate cheating
          <br />
        ...
        <p>
          ...
          please check the policy periodically for any updates.
        </p>

        <p>
          From time to time, We may collect several types of information from and about users of our Website, including
          information:
          <br />
          By which you may be personally identified, such as name, screen name, postal address, e-mail address, and
          ...
          IP addresses and information collected through cookies, web beacons and other tracking technologies; and
          <br />
          ...
          persons.
          <br />
          In order to make Your visit to the Websites more user-friendly, to keep track of visits to the Websites and to
          improve the service, play4win.cc collects a small piece of information sent from Your browser, called a
          cookie. You can, if You wish, turn off the collection of cookies (please refer to Your browser instructions as
          to how to do this). You must note, however, that turning off cookies may restrict Your use of the Websites.
        </p>

        <div class="userreg-text title-sub">4. Limitation of liability</div>
        <p>
          You enter the Website and participate in the Games at Your own risk. The Website and the Games are provided
          with a limited warranty.
          <br />
          play4win.cc does not guarantee continuous availability and functionality of all products. play4win.cc cannot
          be held liable for any damages, gambling losses or lost winnings, which were caused by the unavailability of
          products offered by play4win.cc, however we will do our due diligence in determining the best outcome for both
          parties.
          <br />
          play4win.cc cannot be held liable for damages caused by incorrect, delayed, manipulated or improper way of
          data on the Website. play4win.cc places particular emphasis on the technological and financial proper way to
          store and protect customer data. Despite the behavior of such procedures, play4win.cc is not responsible for
          monitoring the processing of customer information by third parties for loss or damage resulting therefrom. In
          this context, you cannot claim any claims with respect to play4win.cc.
          <br />
          You are responsible for any damage or loss caused by the breach of the ToS or other provisions relating to the
          Games. You are obliged to play4win.cc to compensation for any third party claims resulting from violation of
          those principles.
          <br />
          play4win.cc will not be held liable for your damage or loss, that were beyond the normal control and provided
          by play4win.cc at the time of entry with the exclusion for any liability of damages and losses that result
          from carelessness. play4win.cc is not responsible for lost winnings, however we will do our due diligence in
          determining the best outcome for both parties.
          <br />
          Without prejudice to the generality of the preceding provision, play4win.cc, its directors, employees,
        ...
        <p>
          ...
          consequential, incidental or otherwise, arising in relation to Your use of the Websites or Your participation
          in the Games, however we will do our due diligence in determining the best outcome for both parties.
        </p>

        <p>
          You hereby agree to fully indemnify and hold harmless play4win.cc, its directors, employees, partners, and
          service providers for any cost, expense, loss, damages, claims and liabilities to whatever extent caused that
          may arise in relation to Your use of the Website or participation in the Games.
        </p>
        <div class="userreg-text title-sub">5. Responsible gaming</div>
        <p>
          On request, we will close any account for a minimum period of 6 months during which time it will not be
          possible for the account to be reopened for any reason.
          <br />
          You can close your account under our responsible gaming self-exclusion policy at anytime by contacting our
          Customer Support team.
          <br />
          Upon expiry of the self-exclusion period you may request to reopen a closed account by contacting our Customer
          Support team.
        </p>

        <div class="userreg-text title-sub">6. Entire Agreement</div>
        <p>
          The Terms of service and our Privacy Policy constitute the sole and entire agreement between you and the
          Company with respect to the Website and supersede all prior and contemporaneous understandings, agreements,
          representations and warranties, both written and oral, with respect to the Website.
        </p>

        <div class="userreg-text title-sub">7. Changes to the Terms of service</div>
        <p>
          ...
          apply to any disputes for which the parties have actual notice on or prior to the date the change is posted on
          the Website. Your continued use of the Website following the posting of revised Terms of service means that
          you accept and agree to the changes. You are expected to check this page from time to time so you are aware of
          any changes, as they are binding on you.
          <br />
          These ToS shall be published in English, and may also be published in a number of other languages. All
          language versions shall reflect the same principles. In case of any discrepancy between the English language
          version and the non-English language version of these ToS, the English version shall prevail. Your continued
          use of the Website following the posting of revised Terms of service means that you accept and agree to the
