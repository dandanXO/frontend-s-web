export default {
  lang: {
    ...
    share_tnc_para_02: "Simply refer customers to join at CITY8 and you will receive a bonus of 300 원 each.",
    ...
    share_tnc_para_03_b_ii: "Never registered at CITY8 and do not have any other account at CITY8.",
    ...
    share_tnc_para_08: "CITY8 reserves the right to modify, refuse or cancel this Promotion without prior notice.",
    share_tnc_para_09: "The program can be applied at the same time with all promotions at CITY8.",
    ...
    vip_terms_para_01:
      "The program applies to all members who have a valid 원 account at CITY8. The program is based on the player's total monthly valid bet from 00:00:00 first day of month to 23:59:59 last day of month (GMT +8).",
    vip_terms_para_02:
    ...
    vip_terms_para_09:
      "CITY8 reserves the right to modify, refuse or cancel this VIP membership program at any time without prior notice.",
    ...
    affiliate_01_para_04:
      "CITY8 monitor all affiliate’s user and have our own criterion (risk level, deposit amount, betting index…) when evaluate such users. If they fail to meet our criterion, we reverse the right to refuse to release commission to affiliate.",
