const resources = {
  en: {
    translation: {
      ...
      "carousel.pigeon.title": "Power up your customer support with MiniFun",
      ...
      "texas.title": "Inferno",
      "texas.desc": '"Connect and Chat Anytime, Anywhere."',
      "pigeon.title": "Inferno",
      ...
      "footer.directoryLink.texas": "Inferno",
      "footer.directoryLink.pigeon": "Inferno",
  ...
  zh: {
    translation: {
      ...
      "carousel.texas.title": "随时随地使用我们的聊天应用程序保持联系。",
      "carousel.pigeon.title": "使用Inferno提升您的客户支持",
  ...
  jp: {
    translation: {
      ...
      "carousel.pigeon.title": "Infernoで顧客サポートを強化する",
      ...
      "texas.title": "Inferno",
      "texas.desc": "いつでもどこでも接続してチャットできます。",
      "pigeon.title": "Inferno",
  ...
  kr: {
    translation: {
      ...
      "carousel.pigeon.title": "Inferno으로 고객 지원 업그레이드",
      ...
      "texas.title": "Inferno",
      "texas.desc": "언제 어디서나 연결하고 채팅하십시오.",
      "pigeon.title": "Inferno",
