...
انعامات کی تقسیم کا وقت: اگلے دن پاکستانی وقت کے مطابق دوپہر 3:00 بجے سے شام 6:00 بجے تک۔ اس وقت کے دوران انعامات اکاؤنٹ میں منتقل کر دیے جائیں گے۔`,
  ...
  hotPromo: {
    ...
    appLoginBonus: {
      ...
      termsCondition4: "اگر ممبر غلطی سے کسی غیر مخصوص گیم کیٹیگری میں حصہ لیتا ہے تو بونس کالعدم سمجھا جائے گا، اور win7.gam متعلقہ بونس اور منافع کٹوتی کا حق رکھتا ہے۔",
      termsCondition5: "ہر ممبر کے لیے صرف ایک اکاؤنٹ کی اجازت ہے (بشمول ڈپازٹ اکاؤنٹ، نکاسی اکاؤنٹ، IP ایڈریس)۔ متعدد اکاؤنٹس کی صورت میں بونس کالعدم ہو جائے گا، اور خلاف ورزی کی صورت میں win7.gam اکاؤنٹ منسوخ کرنے اور بونس منسوخ کرنے کا حق رکھتا ہے۔",
      ...
      termsCondition9: "تمام شرائط کی حتمی وضاحت کا حق win7.gam کے پاس محفوظ ہے، اور وہ کسی بھی تنازعے سے انکار کا حق رکھتا ہے۔"
    }
  },
  shareAffiliate: {
    login: 'لاگ ان کریں',
