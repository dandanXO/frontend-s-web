export default {
  ...
  btn: {
    ...
    areyounew: "کیا آپ PK1 پر نئے ہیں؟",
  ...
  vip: {
    ...
    extra: "اضافی",
    rewardss: "انعامات",
    upgradeRewards: "اپ گریڈ انعامات",
    monthlyRewards: "ماہانہ انعامات",
    monthlyRewardsText:
...
انعامات کی تقسیم کا وقت: اگلے دن پاکستانی وقت کے مطابق دوپہر 3:00 بجے سے شام 6:00 بجے تک۔ اس وقت کے دوران انعامات اکاؤنٹ میں منتقل کر دیے جائیں گے۔`,
  ...
  customerServiceVerifier: {
    ...
    contentPara01:
      "PK1.GAME کی فہرست کا استعمال کرتے ہوئے دھوکہ دہی سے بچنے کے لیے، آپ جس ٹیلیگرام یا ڈسکارڈ اکاؤنٹ سے بات کر رہے ہیں، اسے تصدیق&nbsp;کر&nbsp;سکتے&nbsp;ہیں",
  ...
  hotPromo: {
    ...
    depositSpinWheel: {
      ...
      rule_05:
        "اس ایونٹ کی تشریح کا حق PK1.game کے پاس محفوظ ہے۔ اگر آپ کے کوئی سوالات ہوں تو براہ کرم کسٹمر سروس سے رابطہ کریں۔",
      silver: "سلور",
      gold: "گولڈ",
      diamond: "ڈائمنڈ",
      supreme: "سپریم"
    ...
    appLoginBonus: {
      newlyRegistered1: "نئے رجسٹرڈ",
      pk1: "PK1",
      newlyRegistered2: "ممبرز، ایپلیکیشن ڈاؤن لوڈ اور انسٹال کریں، اور حاصل کریں رینڈم فری بونس، زیادہ سے زیادہ",
      bdt888: "888BDT",
      newlyRegistered5: "۔",
      claimNow: "ابھی کلیم کریں",
      downloadApp: "ایپ ڈاؤن لوڈ کریں",
      claimed: "کلیم ہو چکا",
      beginnersGuide: "ابتدائی رہنمائی",
      rewardDetails: "انعام کی تفصیلات",
      beginnersGuideTxt1_1: "1. واٹس ایپ فالو کریں اور سبسکرائب کریں",
      pk1game: "PK1.game",
      beginnersGuideTxt1_2: "چینل کو",
      beginnersGuideTxt2: "2. ای میل ایڈریس کو منسلک کریں اور تصدیق کریں",
      rewardDetailTxt1: "زیادہ سے زیادہ بونس ہو سکتا ہے",
      rewardDetailTxt2: "",
      rewardDetailTxt3: "صرف نئے صارفین کے لیے",
      thingsToNote1: "انعام صرف ایپ کے ذریعے لاگ ان اور تصدیق مکمل کرنے کے بعد ہی کلیم کیا جا سکتا ہے",
      thingsToNote2: "ایپلیکیشن لازمی",
      thingsToNote3: "ڈاؤن لوڈ کی گئی ہو",
      thingsToNote4: "اور",
      thingsToNote5: "انسٹال کی گئی ہو",
      thingsToNote6: "",
      depositAmt: "ڈپازٹ کی رقم",
      giveawayBonus: "گفٹ بونس",
      turnoverRequirements: "ٹرن اوور کی شرائط",
      applicableGames: "قابل اطلاق گیمز",
      conditionsForReceiving: "حصول کی شرائط",
      slotMachines: "سلاٹ مشینز",
      depositPayment: "ڈپازٹ کی ادائیگی",
      selectDepositChannel: "ڈپازٹ چینل منتخب کریں",
      checkDepositOffer: "پہلے ڈپازٹ کی پیشکش چیک کریں",
      downloadAndInstall1: "ڈاؤن لوڈ کریں اور انسٹال کریں",
      downloadAndInstall2: "آفیشل ایپلیکیشن۔",
      downloadAndInstall3: "سبسکرائب کریں",
      downloadAndInstall4: "آفیشل چینل",
      downloadAndInstall5: "واٹس ایپ چینل:",
      downloadAndInstall6:
        "ممبر اکاؤنٹ رجسٹر کریں اور اپنا اصل نام درج کریں (جو آپ کے منسلک نکاسی اکاؤنٹ کے نام سے مطابقت رکھتا ہو)",
      downloadAndInstall7: "منسلک نکاسی اکاؤنٹ",
      downloadAndInstall8:
        "[ڈسکاؤنٹ سینٹر] میں جائیں، چیک کریں اور کلیم کریں، اور حاصل کریں رینڈم انعام جو کہ زیادہ سے زیادہ ہو سکتا ہے",
      downloadAndInstall9: "۔",
      termsCondition1: "یہ بونس صرف نئے ممبر اکاؤنٹس کے لیے ہے اور صرف ان کے پہلے ڈپازٹ پر دستیاب ہے۔",
      termsCondition2:
        "رقم نکالنے کی شرط: آپ کو کم از کم 10 گنا ٹرن اوور مکمل کرنا ہوگا۔ فارمولا: (ڈپازٹ رقم + بونس رقم) × 10",
      termsCondition3: "یہ بونس صرف سلاٹ گیم کیٹیگری کے لیے دستیاب ہے۔",
      termsCondition4:
        "اگر ممبر غلطی سے کسی غیر مخصوص گیم کیٹیگری میں حصہ لیتا ہے تو بونس کالعدم سمجھا جائے گا، اور pk1.game متعلقہ بونس اور منافع کٹوتی کا حق رکھتا ہے۔",
      termsCondition5:
        "ہر ممبر کے لیے صرف ایک اکاؤنٹ کی اجازت ہے (بشمول ڈپازٹ اکاؤنٹ، نکاسی اکاؤنٹ، IP ایڈریس)۔ متعدد اکاؤنٹس کی صورت میں بونس کالعدم ہو جائے گا، اور خلاف ورزی کی صورت میں pk1.game اکاؤنٹ منسوخ کرنے اور بونس منسوخ کرنے کا حق رکھتا ہے۔",
      termsCondition6:
        "پہلی نکاسی کی درخواست سے پہلے، منسلک بینک اکاؤنٹ اور فون نمبر تبدیل نہیں کیے جا سکتے۔ اگر تبدیلی کی گئی تو بونس اور اس سے حاصل شدہ منافع منسوخ کر دیا جائے گا۔",
      termsCondition7:
        "یہ بونس صرف مخصوص گیم کیٹیگری کے کھلاڑیوں کے لیے ہے۔ یہ بونس بیٹنگ ٹرن اوور جمع کرنے، آربیٹریج یا تکنیکی طریقوں سے فائدہ اٹھانے کے لیے استعمال نہیں کیا جا سکتا۔ خلاف ورزی کی صورت میں بونس کالعدم، تمام منافع منسوخ، اور اکاؤنٹ بند کیا جا سکتا ہے۔",
      termsCondition8: "PK1.game کسی بھی وقت بغیر اطلاع کے اس آفر کو تبدیل، معطل یا ختم کرنے کا حق رکھتا ہے۔",
      termsCondition9:
        "تمام شرائط کی حتمی وضاحت کا حق pk1.game کے پاس محفوظ ہے، اور وہ کسی بھی تنازعے سے انکار کا حق رکھتا ہے۔"
    }
  },
  csVerifier: {
  ...
  shareAffiliate: {
    login: "لاگ ان کریں",
    secondLevelTitle: "دوسری سطح کے ایجنٹ-ڈویڈنڈ سسٹم",
    agentType: "ایجنٹ کی قسم",
    merchantModel: "تاجروں کا ماہانہ ڈویڈنڈ ماڈل (مجموعی)",
    ...
    profitFormula:
      "خالص منافع = جیت/ہار - ڈسکاؤنٹ، کوڈ واشنگ - آپریٹنگ لاگت (8% پلیٹ فارم فیس) - ریچارج فیس لاگت (جمع رقم * 5%)",
    ...
    lossBySuperior:
      "- اگر کسی اعلیٰ ایجنٹ کی بائیں اور دائیں لائن ایک دوسرے کو منسوخ کرتی ہیں، تو اعلیٰ ایجنٹ اس کا نقصان برداشت کرے گا",
    noSuperiorLoss:
      "- لیکن اگر اعلیٰ ایجنٹ کو ملنے والے ڈویڈنڈز ماتحت ایجنٹس کو ادائیگی کے لیے ناکافی ہوں، تو پلیٹ فارم فرق پورا کرے گا",

    generalCalculation: "عام حساب:",
    calcExample1:
      `B1 ڈویڈنڈ = -200 x 30% = -60 -> 0<br>` +
      `B2 ڈویڈنڈ = 300 x 20% = 60<br>` +
      `A کا نفع و نقصان = B1 + B2 = 100<br>` +
      `A کا ڈویڈنڈ = 100 x 40% = 40<br>` +
      `A کو B1 کو 60 ادا کرنا ہے، جس میں سے 20 پلیٹ فارم کی سبسڈی ہے، اور A کی خالص آمدنی 0 ہے<br>` +
      `پلیٹ فارم 60 ادا کرتا ہے`,
    noGeneralCalculation: "کوئی عام حساب نہیں",
    sameCalc: "- بنیادی حساب کتاب ویسا ہی ہے",
  ...
  error: {
    ...
    30008: "استعمال شدہ ڈیوائس/پلیٹ فارم مطلوبہ معیار پر پورا نہیں اترتا۔",
