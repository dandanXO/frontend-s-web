...
انعامات کی تقسیم کا وقت: اگلے دن پاکستانی وقت کے مطابق دوپہر 3:00 بجے سے شام 6:00 بجے تک۔ اس وقت کے دوران انعامات اکاؤنٹ میں منتقل کر دیے جائیں گے۔`,
  ...
  hotPromo: {
    ...
    appLoginBonus: {
      ...
      downloadAndInstall6: "ممبر اکاؤنٹ رجسٹر کریں اور اپنا اصل نام درج کریں (جو آپ کے منسلک نکاسی اکاؤنٹ کے نام سے مطابقت رکھتا ہو)",
      downloadAndInstall7: "منسلک نکاسی اکاؤنٹ",
      downloadAndInstall8: "[ڈسکاؤنٹ سینٹر] میں جائیں، چیک کریں اور کلیم کریں، اور حاصل کریں رینڈم انعام جو کہ زیادہ سے زیادہ ہو سکتا ہے",
      downloadAndInstall9: "۔",
      termsCondition1: "یہ بونس صرف نئے ممبر اکاؤنٹس کے لیے ہے اور صرف ان کے پہلے ڈپازٹ پر دستیاب ہے۔",
      termsCondition2: "رقم نکالنے کی شرط: آپ کو کم از کم 10 گنا ٹرن اوور مکمل کرنا ہوگا۔ فارمولا: (ڈپازٹ رقم + بونس رقم) × 10",
      termsCondition3: "یہ بونس صرف سلاٹ گیم کیٹیگری کے لیے دستیاب ہے۔",
      termsCondition4: "اگر ممبر غلطی سے کسی غیر مخصوص گیم کیٹیگری میں حصہ لیتا ہے تو بونس کالعدم سمجھا جائے گا، اور b9.game متعلقہ بونس اور منافع کٹوتی کا حق رکھتا ہے۔",
      termsCondition5: "ہر ممبر کے لیے صرف ایک اکاؤنٹ کی اجازت ہے (بشمول ڈپازٹ اکاؤنٹ، نکاسی اکاؤنٹ، IP ایڈریس)۔ متعدد اکاؤنٹس کی صورت میں بونس کالعدم ہو جائے گا، اور خلاف ورزی کی صورت میں b9.game اکاؤنٹ منسوخ کرنے اور بونس منسوخ کرنے کا حق رکھتا ہے۔",
      termsCondition6: "پہلی نکاسی کی درخواست سے پہلے، منسلک بینک اکاؤنٹ اور فون نمبر تبدیل نہیں کیے جا سکتے۔ اگر تبدیلی کی گئی تو بونس اور اس سے حاصل شدہ منافع منسوخ کر دیا جائے گا۔",
      termsCondition7: "یہ بونس صرف مخصوص گیم کیٹیگری کے کھلاڑیوں کے لیے ہے۔ یہ بونس بیٹنگ ٹرن اوور جمع کرنے، آربیٹریج یا تکنیکی طریقوں سے فائدہ اٹھانے کے لیے استعمال نہیں کیا جا سکتا۔ خلاف ورزی کی صورت میں بونس کالعدم، تمام منافع منسوخ، اور اکاؤنٹ بند کیا جا سکتا ہے۔",
      termsCondition8: "B9.game کسی بھی وقت بغیر اطلاع کے اس آفر کو تبدیل، معطل یا ختم کرنے کا حق رکھتا ہے۔",
      termsCondition9: "تمام شرائط کی حتمی وضاحت کا حق b9.game کے پاس محفوظ ہے، اور وہ کسی بھی تنازعے سے انکار کا حق رکھتا ہے۔"
    }
  },
  shareAffiliate: {
    login: 'لاگ ان کریں',
