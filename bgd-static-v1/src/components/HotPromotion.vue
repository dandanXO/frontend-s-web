<template>
  <div class="hot-promo">
    ...
    <AppLoginBonus
      ...
      :promocode="list.promoCode"
    />
    <NewPlayerFreeTrialPromo v-if="list.redirectUrl === 'bgd-new-player-free-trial' && !isCommonPromo && store.token" />
  </div>
...
import NewPlayerFreeTrialPromo from "./hotpromo/newPlayerFreeTrial/NewPlayerFreeTrialPromo.vue";
...
export default defineComponent({
  ...
  mounted() {
    ...
    if (
      ...
      this.list.redirectUrl === "bgd-new-player-free-trial" ||
      this.list.id === 40
    ) {
