        ...
        <div class="socials">
            <div class="social-item">
                <a class="social-item"
                    ...
                    <img class="social-icon"
                        src="../../../assets/images/promotion/hotpromo/refer-spinwheel/whatsapp-icon.svg" />
                </a>
            ...
            <div class="social-item">
                <a class="social-item"
                    ...
                    target="_blank">
                    <img class="social-icon"
                        src="../../../assets/images/promotion/hotpromo/refer-spinwheel/facebook-icon.svg" />
                </a>
            ...
            <div class="social-item">
                <a class="social-item" @click="handleShareToTikTok(selfTgurl)">
                    <img class="social-icon"
                        src="../../../assets/images/promotion/hotpromo/refer-spinwheel/tiktok-icon.svg" />
                </a>
            ...
            <div class="social-item">
                <a class="social-item" :href="`instagram://sharesheet?text=${encodeURIComponent(
                    $t('hotPromo.referWheel.shareSocialText', { url: selfTgurl })
                )}`" target="_blank">
                    <img class="social-icon"
                        src="../../../assets/images/promotion/hotpromo/refer-spinwheel/instagram-icon.svg" />
                </a>
