export default {
  ...
  header: {
    ...
    write: "Write",
    logout: "Logout",
    activitiesDetails: "Activity Details",
    moneyChange: "Exchange Money",
    financeFeedback: "Financial Feedback",
    helpRecord: "Fund Assistance Record",
  ...
  form: {
    ...
    accountNumber_rules_01: "Please enter the account number",
    accountNumber_rules_02: "Please enter a valid account number",
    accountNumber_rules_03: "Account number cannot contain decimals",
    holderName: "Account Holder Name",
    holderName_placeholder: "Enter Account Holder Name",
    holderName_rules_01: "Please enter the account holder name",
    holderName_rules_02: "Please enter at least 2 characters",
    bank_title: "Add Bank Account",
    bank_selectionTitle: "Bank",
    bank_select: "Select Bank",
    bank_selectError: "Please select a bank",
    bank_type: "Account Number",
    crypto_title: "Add Crypto Wallet",
    crypto_selectionTitle: "Crypto",
    crypto_select: "Select Crypto",
    crypto_selectError: "Please select a crypto",
    crypto_type: "Crypto Card Number",
    ewallet_title: "Add eWallet",
    ewallet_selectionTitle: "eWallet",
    ewallet_select: "Select eWallet",
    ewallet_selectError: "Please select an eWallet",
