<template>
  ...
  <div class="home-header-section" style="height: 64px;">
  ...
  <!--        </div>-->
  <!--      &lt;!&ndash; <router-link v-if="!store.token" to="/register" class="login">-->
