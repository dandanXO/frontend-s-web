<template>
  <div class="negativeprofit">
    <div class="coin">
      <img src="../../../assets/images/promo/hotpromo/vislotnetloss/icon.png" />
    </div>
    <div class="input">
...
import { submitSlotNewLossBonus, refundSlotBonus } from "../../../api/index/promo";
...
function chooseNewLossBonus() {
  ...
  submitSlotNewLossBonus(newLossBonus.value)
    .then((res) => {
      if (res.code === 0) {
        $q.notify({
          type: "positive",
