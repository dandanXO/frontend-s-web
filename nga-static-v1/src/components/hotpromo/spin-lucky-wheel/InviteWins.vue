<template>
  <div class="invite-win-container">
    ...
    <div class="qr-wrapper invite-win-section">
      ...
      <span class="desc">Do you want to unlock your {{`${store.currency.value} 5000`}} reward right away? Invite your friends for a free spin!</span>
...
const copyShareLink = (selfTgurl) => {
  const copiedText = `Do you want to unlock your ${store.currency.value} 5000 reward right away? Click the link: ${selfTgurl}`;
