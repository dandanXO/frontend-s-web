    ...
    <div class="livepoker-rebate-container">
      ...
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="little-title">
          ...
          <div class="right">2025 年 2 月 14 日至 2025 年 2 月 23 日</div>
        </div>
        <div class="little-title">
          <div class="ribbon">活动内容</div>
          <div class="right">
            活动期间在 PGL 克卢日纳波卡 2025 总有效投注≥5,000 元即可获得最高 1,888 元的投注金。
          </div>
        </div>
        ...
        <div class="livepoker-rebate-game-bottom">
          <div class="livepoker-rebate-game-bottom-left-title">
            ...
            会员在 PGL 克卢日纳波卡 2025 赛事期间总有效投注 50,000 元，在 2 月 24 日 24 小时内可获得彩金：188 元
          </div>
        </div>
      </div>
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              活动期间，活动仅计算电竞场馆中 PGL 克卢日纳波卡 2025 赛事，会员在 PGL 克卢日纳波卡 2025 赛事期间内累计有效投注≥5,000 元即可获得对应彩金，有效投注过期清零；
              <div class="hint">注：奖金不叠加派发，奖金按最高档位派发一次。</div>
            </div>
          </div>
          <div class="item">
            <div class="item-num">2</div>
            活动期间，活动仅计算 PGL 克卢日纳波卡 2025 已结算的赛事总有效投注，2 月 24 日 24
...
import { getPGLOnFireBuenosAires2025, claimPGLOnFireBuenosAires2025 } from "../../../api/index/promo";
...
const handleClaimBonus = () => {
  ...
  claimPGLOnFireBuenosAires2025(promoCode.value)
    .then((res) => {
      if (res.code === 0) {
        notify({
          type: "success",
...
const fetchData = async () => {
  loadingClaim.value = true;
  getPGLOnFireBuenosAires2025(promoCode.value)
    .then((res) => {
      if (res.code === 0) {
