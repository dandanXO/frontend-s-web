      ...
      <div class="livepoker-rebate-section">
        <div class="livepoker-rebate-section-left">
          ...
          <div class="reward-info">
            <div class="reward-info-icon">
              <img
                src="../../../assets/images/promotion/hotpromo/dy2-s14/reward-icon1.png"
                alt=""
                width="100%"
              />
            </div>
          ...
          <div class="reward-info">
            <div class="reward-info-icon">
              <img
                src="../../../assets/images/promotion/hotpromo/dy2-s14/reward-icon2.png"
                alt=""
                width="100%"
              />
            </div>
        ...
        <div class="livepoker-rebate-section-right">
          <div class="bonus-image" @click="handleClaimBonus">
            <img
              src="../../../assets/images/promotion/hotpromo/dy2-s14/reward-btn.png"
              alt=""
              width="100%"
            />
          </div>
