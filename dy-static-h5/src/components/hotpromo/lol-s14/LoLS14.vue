    ...
    <div class="livepoker-rebate-container">
      <div class="livepoker-rebate-section">
        <div class="livepoker-rebate-section-left">
          <div class="livepoker-rebate-section-title">
            <div>
              <img
                src="../../../assets/images/promotion/hotpromo/dy2-s14/section-title-img.png"
          ...
          <div class="reward-info">
            <div class="reward-info-icon">
              <img src="../../../assets/images/promotion/hotpromo/dy2-s14/reward-icon1.png" alt="" width="100%" />
            </div>
          ...
          <div class="reward-info">
            <div class="reward-info-icon">
              <img src="../../../assets/images/promotion/hotpromo/dy2-s14/reward-icon2.png" alt="" width="100%" />
            </div>
            <div class="reward-info-content">
              可领彩金：
        ...
        <div class="livepoker-rebate-section-right">
          <div class="bonus-image" @click="handleClaimBonus">
            <img src="../../../assets/images/promotion/hotpromo/dy2-s14/reward-btn.png" alt="" width="100%" />
          </div>
        </div>
      </div>
      <div class="livepoker-rebate-game-info">
        ...
        <div class="little-title" style="flex-direction: column; align-items: flex-start">
          ...
          <div class="right">2024 年 9 月 25 日起</div>
        </div>
        <div class="little-title" style="flex-direction: column; align-items: flex-start">
          <div class="left">活动内容</div>
          <div class="right">活动期间，当日 S14 全球总决赛有效投注≥1,500 元即可获得 最高 1888 元的奖励金</div>
        </div>
        ...
        <div class="livepoker-rebate-game-bottom">
          <div class="livepoker-rebate-game-bottom-left-title">
            例：会员 A 在电竞 LOL 传奇杯比赛中投注 5,000 元在次日可获传奇礼金 28 元。
      ...
      <div class="livepoker-rebate-game-bottom-rule">
        ...
        <div class="content">
          <div class="item">
            ...
            活动期间，活动仅计算电竞场馆中 LOL 传奇杯比赛赛事，会员在当日 LOL 传奇杯比赛累计有效投注≥3000 元即可获得对应彩金，有效投注次日清零；注：奖金不叠加派发，奖金按最高档位每日派发一次。

            <span style="color: #ff0000; display: contents">注：奖金不叠加派发，奖金按最高档位每日派发一次。</span>
          </div>
          <div class="item">
            <div class="item-num">2</div>
            活动期间，活动仅计算当日 LOL 传奇杯比赛已结算的赛事总有效投注，次日 24 小时内在活动页面点击【点击领取】按钮领取。逾期未领取则视为放弃，彩金 5 倍流水即可出款；
...
.livepoker-rebate-section {
  ...
  background: url("../../../assets/images/promotion/hotpromo/dy2-s14/section-bg.png");
...
.livepoker-rebate-game-info {
  ...
  .title {
    background-image: url("../../../assets/images/promotion/hotpromo/dy2-s14/info-title.png");
  ...
  .little-title {
    ...
    gap: 10px;
    .left {
      background-image: url("../../../assets/images/promotion/hotpromo/dy2-s14/info-little-title-bg.png");
      background-repeat: no-repeat;
      background-size: 100% 100%;
      width: 64px;
      height: 20px;
...
.livepoker-rebate-game-bottom-rule {
  ...
  align-items: center;
  .title {
    background-image: url("../../../assets/images/promotion/hotpromo/dy2-s14/rule-title.png");
    background-repeat: no-repeat;
    background-size: 100% 100%;
    width: 240px;
    height: 20px;
