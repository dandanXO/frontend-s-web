      ...
      <div class="livepoker-rebate-game-info">
        ...
        <div class="livepoker-rebate-game-bottom">
          <div class="livepoker-rebate-game-bottom-left-title">
            ...
            会员A在IEM里约大师赛时，在IM电竞投注5,000元后又在东赢电竞投注IEM赛事投注5,000元，可在次日领取东赢专属金38元。
          </div>
        </div>
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              <div>
                活动期间，会员投注IEM里约大师赛有效投注≥3,000元可获得对应投注嘉奖，若在东赢电竞场馆进行投注IEM 里约大师赛可获更高奖励金额。
              </div>
          ...
          <div class="item">
            ...
            IEM 里约大师赛投注嘉奖在结算后24小时内有效，可登入优惠界面点击【领取】按钮获得，彩金5倍流水即可提款；
          </div>
          <div class="item">
...
import { getIEMRioInit, claimIEMRioBonus } from "../../../api/index/promo";
...
const fetchData = async () => {
  try {
    const res = await getIEMRioInit(promoCode.value);
