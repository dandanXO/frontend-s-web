    ...
    <div class="livepoker-rebate-container">
      ...
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="little-title">
          ...
          <div class="right">2025年5月10日至2025年 5月18</div>
        </div>
        <div class="little-title">
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              动期间，活动仅计算电竞场馆中PGL 阿斯塔纳 2025赛事，会员在PGL 阿斯塔纳 2025赛事期间当日累计有效投注≥1,500元即可获得对应彩金，有效投注过期清零； 
              <div class="hint">注：奖金不叠加派发，奖金按最高档位每日派发一次。</div>
            </div>
          </div>
          <div class="item">
            <div class="item-num">2</div>
            活动期间，活动仅计算PGL 阿斯塔纳 2025已结算的赛事当日总有效投注，次日 24 小时内在活动页面点击【点击领取】按钮领取。逾期未领取则视为放弃，彩金 6倍流水即可出款； 
          </div>
          <div class="item">
