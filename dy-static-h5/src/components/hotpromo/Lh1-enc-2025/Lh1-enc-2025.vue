    ...
    <div class="livepoker-rebate-container">
      ...
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="little-title">
          ...
          <div class="right">2025年5月20日至2025年5月24日</div>
        </div>
        <div class="little-title">
          <div class="ribbon">活动对象</div>
          <div class="right">投注Elisa 北欧冠军联赛 2025的会员</div>
        </div>
        <div class="little-title">
        ...
        <div class="little-title">
          ...
          <div class="right">会员在本站电竞场馆中，北京时间当日负盈利达到2000元及以上，次日即可领取荣耀金，最高可达1,888元！</div>
        </div>
        ...
        <div class="livepoker-rebate-game-bottom">
          <div class="livepoker-rebate-game-bottom-left-title">
            ...
            会员A在电竞场馆投注Elisa 北欧冠军联赛 2025,当日产生负盈利为60000元,次日即可获得荣耀金388元。
          </div>
        </div>
      </div>
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              活动期间，活动仅计算电竞场馆中Elisa 北欧冠军联赛 2025赛事，会员在当日Elisa 北欧冠军联赛 2025中累计负盈利≥2,000 元即可获得对应荣耀金，负盈利次日清零； 
              <div class="hint">注：奖金不叠加派发，奖金按最高档位每日派发一次。</div>
            </div>
          </div>
          <div class="item">
            <div class="item-num">2</div>
            活动期间，活动仅计算Elisa 北欧冠军联赛 2025已结算的赛事总负盈利，次日 24 小时内在活动页面点击【立即领取】按钮领取。逾期未领取则视为放弃，彩金6倍流水即可出款；
          </div>
          <div class="item">
...
const fetchData = async () => {
  loadingClaim.value = true;
  getCompetitionLossInit(promoCode.value)
    .then((res) => {
      if (res.code === 0) {
        totalValidBet.value = res.data.totalLoss;
