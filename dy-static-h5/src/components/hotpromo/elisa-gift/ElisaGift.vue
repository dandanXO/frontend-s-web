      ...
      <div class="livepoker-rebate-game-info">
        ...
        <div class="livepoker-rebate-game-bottom">
          <div class="livepoker-rebate-game-bottom-left-title">
            ...
            10月16日会员A在Elisa大师赛赛事期间存款500元并且累计有效投注为20000元，10月17日即可在优惠页面点击【领取】获得投注奖金，根据规则会员可获得58元投注奖金，奖金仅需8倍水即可出款
          </div>
        </div>
      </div>
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              <div>
                活动期间，会员当日投注Elisa大师赛有效投注≥1,000元且存款≥200元可获得对应投注奖金，有效投注额仅对当日投注当日已结算并产生输赢结果的注单进行计算，满足条件的会员可进入优惠界面点击【领取】按钮获得投注奖金，奖金8倍流水即可提款；
              </div>
          ...
          <div class="item">
            ...
            Elisa大师赛投注奖金在结算后24小时内有效，每天只能领取一次，超出活动时间未领取不予补偿；
          </div>
          <div class="item">
