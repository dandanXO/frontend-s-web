<template>
    <div>
          <div class="receive-container">
              ...
              <div @click="getPromotion" v-if="!promoNotReady && !bonusOpened" class="receive-btn"><img src="../../../assets/images/promotion/hotpromo/hongbaoyu/package_light.png"></div>
...
import { ref } from "vue";
    ...
    const getPromotion = () => {
         eventapi.put("/bonus/claim/red-packet-rain")
            .then((res) => {
            if (res.code === 0) {
