    ...
    <div class="livepoker-rebate-container">
      ...
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="little-title">
          ...
          <div class="right">2025 年 03 月 19 日至 2025 年 03 月 30 日 </div>
        </div>
        <div class="little-title">
          <div class="ribbon">活动对象</div>
          <div class="right">投注 BLAST 里斯本公开赛 2025 的会员</div>
        </div>
        <div class="little-title">
      ...
      <div class="livepoker-rebate-game-bottom-rule section-bg">
        ...
        <div class="content">
          ...
          <div class="item">
            ...
            活动期间，活动仅计算当日 梦幻联赛 S25 已结算的赛事总有效投注，次日 活动期间，活动仅计算 BLAST 里斯本公开赛
            2025 赛事已结算的赛事当日总负盈利，次日 24
...
const fetchData = async () => {
  try {
    const res = await getCompetitionLossInit(promoCode.value);
