  ...
  <div class="livepoker-rebate-wrapper">
    <div class="livepoker-rebate-container">
      ...
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="little-title" style="flex-wrap: nowrap;flex-direction: row;">
          <div class="ribbon">活动时间</div>
          <div class="right">2025年6月1日至2025年6月30日</div>
        </div>
        <div class="little-title" style="flex-wrap: nowrap;flex-direction: row;">
          <div class="ribbon">活动对象</div>
          <div class="right">投注体育场馆的会员</div>
        </div>
        <div class="little-title">
          <div class="ribbon">活动内容</div>
          <div class="right">
            <div>1.活动期间，会员在体育场馆中，北京时间当日累计有效投注≥2000元，次日即可领取加码金，最高可达11,888元！</div>
            <div>2.活动期间，会员通过【推广赚钱】的推广链接或二维码邀请好友完成注册，被邀请的好友同时投注体育场馆并达到活动流水要求，即可将加码金翻倍，邀请人最高获得1.1倍加码金。</div>
          </div>
        </div>
        <table class="livepoker-rebate-game-info-table section-table">
          ...
          <tbody>
            <tr>
              <td>≥2,000元</td>
              <td>8元</td>
              <td rowspan="3">≥2000元</td>
              <td rowspan="3">0.8倍</td>
            </tr>
            <tr>
              <td>≥5,000元</td>
              <td>18元</td>
            ...
            <tr>
              <td>≥30,000元</td>
              <td>68元</td>
              <td rowspan="4">≥30,000元</td>
              <td rowspan="4">0.9倍</td>
            </tr>
            <tr>
              <td>≥50,000元</td>
              <td>128元</td>
            ...
            <tr>
              <td>≥500,000元</td>
              <td>1,288元</td>
              <td rowspan="4">≥50,000元</td>
              <td rowspan="4">1.1倍</td>
            </tr>
            <tr>
              <td>≥1,000,000元</td>
              <td>2,688元</td>
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              活动期间，活动仅计算体育场馆的每日累计有效投注，每日累计有效投注≥2,000元即可获得对应加码金，若好友完成相应活动要求可领取翻倍加码金，累计有效投注次日清零；
              <div class="hint">注：奖金不叠加派发，奖金按最高档位每日派发一次。</div>
            </div>
          </div>
          <div class="item">
            <div class="item-num">2</div>
            活动期间，活动仅计算每日体育场馆已结算赛事的累计有效投注，次日 24 小时内在活动页面点击【立即领取】按钮领取。逾期未领取则视为放弃，彩金5倍流水即可出款；
          </div>
          <div class="item">
...
const handleClaimBonus = () => {
  ...
  claimGameTypeBonus(promoCode.value)
    .then((res) => {
      if (res.code === 0) {
        notify({
          type: "success",
...
const fetchData = async () => {
  loadingClaim.value = true;
  getGameTypeBonusInit(promoCode.value)
    .then((res) => {
      if (res.code === 0) {
