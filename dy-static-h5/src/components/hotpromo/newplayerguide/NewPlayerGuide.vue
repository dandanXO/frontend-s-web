        ...
        <div>
          <ol class="rules-content">
            ...
            <li>
              ...
              <div class="content">此活动最终解释权归东赢所有；</div>
            </li>
          </ol>
        </div>
      </div>
    ...
    if (status === "NO") {
      if (promoCode === "new-user-setup-bonus-telephone") {
        if (window.location.pathname === "/promotion") {
          ...
          router.push("/account/personal?redirect=promo?name=dy2-newplayer-guide");
        }
      } else if (promoCode === "new-user-setup-bonus-first-withdrawal") {
        if (window.location.pathname === "/promotion") {
          document.location.href = `app://withdraw`;
        } else {
          router.push("/finance/withdraw?redirect=promo?name=dy2-newplayer-guide");
        }
      } else {
        if (window.location.pathname === "/promotion") {
          document.location.href = `app://deposit`;
        } else {
          router.push("/account/withdraw?redirect=promo?name=dy2-newplayer-guide");
        }
      }
    } else if (status === "YES") {
      getBonus(promoCode);
