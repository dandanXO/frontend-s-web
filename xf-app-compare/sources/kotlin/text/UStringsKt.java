...
public final class UStringsKt {
    ...
    public static final String m1380toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1382toStringolVBNx4(short s, int i) {
    ...
    public static final String m1381toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1379toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m177unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m437unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m255unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m333unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m255unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m204constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m122boximpl(UByte.m128constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m255unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m204constructorimpl(SupportMenu.USER_MASK)) > 0) {
            return null;
        }
        return UShort.m382boximpl(UShort.m388constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r5 = UInt.m204constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m457uintDivideJ1ME1BU(-1, r5);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
            }
            int r3 = UInt.m204constructorimpl(i2 * r5);
            int r8 = UInt.m204constructorimpl(UInt.m204constructorimpl(digitOf) + r3);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r9 = ULong.m282constructorimpl((long) i2);
        long j2 = 0;
        ...
        while (i3 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m459ulongDivideeb3DHEI(j, r9);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long r11 = ULong.m282constructorimpl(j2 * r9);
            long r4 = ULong.m282constructorimpl(ULong.m282constructorimpl(((long) UInt.m204constructorimpl(digitOf)) & 4294967295L) + r11);
