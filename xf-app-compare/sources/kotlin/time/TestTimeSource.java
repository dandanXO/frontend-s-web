...
public final class TestTimeSource extends AbstractLongTimeSource {
    ...
    public final void m1522plusAssignLRDsOJo(long j) {
        long j2;
        long r0 = Duration.m1440toLongimpl(j, getUnit());
        if (r0 == Long.MIN_VALUE || r0 == Long.MAX_VALUE) {
            double r2 = ((double) this.reading) + Duration.m1437toDoubleimpl(j, getUnit());
    ...
    private final void m1521overflowLRDsOJo(long j) {
        throw new IllegalStateException("TestTimeSource will overflow if its reading " + this.reading + "ns is advanced by " + Duration.m1443toStringimpl(j) + '.');
    }
}
