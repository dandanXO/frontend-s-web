...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1388getAdjustmentUwyO8pc() {
    ...
    public long m1387elapsedNowUwyO8pc() {
        return Duration.m1429minusLRDsOJo(this.mark.m1523elapsedNowUwyO8pc(), m1388getAdjustmentUwyO8pc());
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1389plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1430plusLRDsOJo(m1388getAdjustmentUwyO8pc(), j), (DefaultConstructorMarker) null);
    }
}
