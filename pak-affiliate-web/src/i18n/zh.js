export default {
  ...
  fields: {
    ...
    dashboard_title: '首页列表',
    total_downline_count: '总下线代理数',
    total_straight_count: '总直属会员数',
    total_member_count: '总会员数',
    total_deposit_count: '总存款会员数',
    total_withdraw_count: '总提款会员数',
    total_bet_count: '总投注会员数',

    total_deposit_amt: '总存款金额',
    total_withdraw_amt: '总提款金额',
    total_sum_amt: '存提差',
    total_privilege_amt: '总奖金',
    total_remaining_amt: '总余额',
    total_validbet_amt: '总有效投注',
    total_losewin_amt: '总输赢',
  ...
  message: {
    ...
    required_6_to_12: '由6-12位数字或字母组成',
    requried_password: '登录密码不能为空',
    required_captcha: '验证码不能为空',
    required_4_digits: '由4位数字组成',
