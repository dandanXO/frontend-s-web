...
.info-wrapper {
  .info-container {
    ...
    .info-row {
      display: flex;
      background: linear-gradient(180deg, rgba(0, 67, 11, 0.8) 0%, rgba(0, 174, 0, 0.4) 100%);
      border-radius: 12px;
      margin-bottom: 15px;
...
.share-title {
  background: radial-gradient(50% 75% at 50% 50%, rgba(92, 70, 231, 0) 0%, #019303 0.01%, rgba(92, 70, 231, 0) 100%);
  font-size: 1.5rem;
  font-weight: 700;
  text-align: center;
  height: 50px;
...
.copy-link-container {
  ...
  .link-wrapper {
    background: linear-gradient(325.86deg, #123616 5.38%, #166121 98.11%);
    border: 2px solid #123616;
