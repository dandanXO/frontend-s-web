<template>
  <div class="fifa-world-cup-2025">
    <div class="claim-banner">
      <div class="claim-btn" @click="claimBonus">
        {{ $t("lang.fifaWorldCup2025.claimNow") }}
      </div>
    </div>
    <div class="section-bg">
      <div class="title-wrapper">
        <img src="@/assets/images/promotion/hotpromo/fifa-world-cup-2025/title-img-left.png" />
        <span>{{ $t("lang.fifaWorldCup2025.promotionDetails") }}</span>
        <img src="@/assets/images/promotion/hotpromo/fifa-world-cup-2025/title-img-right.png" />
      </div>
      <div class="little-title">
        <div class="right bold">{{ $t("lang.fifaWorldCup2025.promotionPeriod") }}</div>
      </div>
      <div class="little-title">
        <div class="ribbon">{{ $t("lang.fifaWorldCup2025.applicableFor") }}</div>
        <div class="right bold">{{ $t("lang.fifaWorldCup2025.applicableForText") }}</div>
      </div>

      <div class="little-title">
        <div class="ribbon">{{ $t("lang.fifaWorldCup2025.applicableProducts") }}</div>
        <div class="right bold">{{ $t("lang.fifaWorldCup2025.applicableProductsText") }}</div>
      </div>

      <div class="little-title">
        <div class="ribbon">{{ $t("lang.fifaWorldCup2025.promotionDetails") }}</div>
        <div class="right bold">{{ $t("lang.fifaWorldCup2025.promotionDetailsText") }}</div>
      </div>

      <div class="tasks-container">
        <h3>{{ $t("lang.fifaWorldCup2025.dailyTask") }}:</h3>
        <ol class="task-list">
          <li>{{ $t("lang.fifaWorldCup2025.dailyTaskPt1") }}</li>
          <li>{{ $t("lang.fifaWorldCup2025.dailyTaskPt2") }}</li>
        </ol>
        <p>{{ $t("lang.fifaWorldCup2025.dailyTaskDescription") }}</p>
      </div>
    </div>
    <div class="section-bg">
      <div class="title-wrapper">
        <img src="@/assets/images/promotion/hotpromo/fifa-world-cup-2025/title-img-left.png" />
        <span>{{ $t("lang.fifaWorldCup2025.termsAndConditions") }}</span>
        <img src="@/assets/images/promotion/hotpromo/fifa-world-cup-2025/title-img-right.png" />
      </div>
      ...
      <div class="content">
        <div class="item">
          ...
          <div class="item-desc">
            <div class="hint">{{ $t("lang.fifaWorldCup2025.condition1") }}</div>
          </div>
        </div>
        ...
        <div class="item">
          ...
          <div class="item-desc">
            <div class="hint">{{ $t("lang.fifaWorldCup2025.condition2") }}</div>
          </div>
        </div>
        ...
        <div class="item">
          ...
          <div class="item-desc">
            <div class="hint">{{ $t("lang.fifaWorldCup2025.condition3") }}</div>
          </div>
        </div>
        ...
        <div class="item">
          ...
          <div class="item-desc">
            <div class="hint">{{ $t("lang.fifaWorldCup2025.condition4") }}</div>
          </div>
        </div>
        ...
        <div class="item">
          ...
          <div class="item-desc">
            <div class="hint">{{ $t("lang.fifaWorldCup2025.condition5") }}</div>
          </div>
        </div>
        ...
        <div class="item">
          ...
          <div class="item-desc">
            <div class="hint">{{ $t("lang.fifaWorldCup2025.condition6") }}</div>
          </div>
        </div>
        ...
        <div class="item">
          ...
          <div class="item-desc">
            <div class="hint">{{ $t("lang.fifaWorldCup2025.condition7") }}</div>
          </div>
        </div>
      </div>
    </div>
  ...
  <q-dialog v-model="showPrizePopup">
    <div class="prizePopupContainer-fifa" @click="showPrizePopup = false">
      <div class="wrapper">
...
import { claimWeeklyBonus, weeklyBonusInit } from "@/api/promo/weeklyBonus";
...
const initPage = () => {
  weeklyBonusInit(props.promoCode).then((res) => {
    if (res.code === 0) {
      const { data } = res;
