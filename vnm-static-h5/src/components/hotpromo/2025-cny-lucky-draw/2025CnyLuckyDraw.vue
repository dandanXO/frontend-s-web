s<template>
    ...
    <div class="new-player-wrapper">
        ...
        <div class="rule-block">
            ...
            <div class="rule-block-rule" style="flex-direction: column; align-items: flex-start;">
                <div class="rule-block-rule__title">Sản phẩm</div>
                <span class="rule-block-rule__description">Trong thời gian khuyến mãi, Thành viên đạt đủ doanh thu cược
                    theo yêu
                    cầu sẽ có cơ hội tham gia đập trứng vàng để nhận thưởng hấp dẫn, bao gồm tiền mặt ngẫu nhiên từ 18
                    VNDP đến
            ...
            <div class="promo-view-container">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td style="background: linear-gradient(180deg, #70CBFB 0%, #4AA5FF 49%, #4AA5FF 91.5%, #6EC7FD 100%); color: white">
                            ...
                            <td style="background: linear-gradient(180deg, #70CBFB 0%, #4AA5FF 49%, #4AA5FF 91.5%, #6EC7FD 100%); color: white">Thời gian hiệu lực của
                ...
                <div class="hint">*Khi tổng số tiền cược hợp lệ của Thành Viên trong ngày là 15,000 VNDP, sẽ nhận được
                    ba cơ hội
                    đập trứng vàng.</div>
            </div>
        </div>
        ...
        <div class="mission-block">
            ...
            <p style="margin: 0">
                1. Thành Viên tham gia đặt cược và tích luỹ đủ số tiền cược hợp lệ tương ứng để nhận cơ hội đập trứng
                vàng.<br>
                2. Lượt đập trứng sẽ được cập nhật vào ngày hôm sau, Thành Viên cần đăng nhập vào tài khoản, truy cập
                trang
            ...
            <p style="margin: 0">
                1. Lượt đập trứng vàng sẽ có hiệu lực 3 ngày kể từ khi cập nhật vào tài khoản. Lượt chưa sử dụng sẽ tự
                động hết hạn khi quá thời gian.<br>
                2. Tiền thưởng nhận được cần hoàn thành 5 vòng cược trước khi thực hiện rút tiền.<br>
                3. Tất cả cược HÒA, cược HỦY, cược 2 BÊN, vé cược đặt tại tỷ lệ cược: DEC &lt; 1.75, MY -0.6 đến 0.75,
                Thể thao ảo, Đua ngựa, Number Game sẽ không được áp dụng cho chương trình này.<br>
                4. Các tài khoản có cùng IP hoặc thông tin dữ liệu tương tự sẽ không được tham gia chương trình khuyến
                mãi này.<br>
                5. Chương trình không thể kết hợp cùng các khuyến mãi nạp khác tại TF88.<br>
                6. TF88 có quyền chỉnh sửa, từ chối hoặc hủy bỏ chương trình Khuyến mãi này bất cứ thời gian nào mà
                không cần báo trước.<br>
...
.new-player-wrapper {
    ...
    background: url('../../../assets/images/promo/hotpromo/2025-cny-lucky-draw/bg-top.png') top no-repeat, url('../../../assets/images/promo/hotpromo/2025-cny-lucky-draw/bg-content.png') center no-repeat, url('../../../assets/images/promo/hotpromo/2025-cny-lucky-draw/bg-bottom.png') bottom no-repeat;
