export default {
  lang: {
    ...
    share_table_header_01: "Tên Tài Khoản",
    share_table_header_02: "Thời gian đăng ký",
    share_table_header_03: "Tổng Nạp",
    ...
    deposit_maxamount: "Tối đa",
    deposit_minamount: "Tối thiểu",
    ...
    withdraw_estimatedarrival: "Số coin thực nhận",
    withdraw_usdtspecialnote: "Hệ thống thu phí 1 $ cho mỗi lần giao dịch rút USDT!",
    withdraw_ewalletspecialnote: "Tên của ví rút tiền và tài khoản game phải giống nhau.",
    ...
    bd_please_enter_bank_card: "Vui lòng nhập số tài khoản ngân hàng",
    ...
    vipenny_claim_now_sport: "Sản Phẩm Thể Thao",
    vipenny_claim_now_other: "Sản Phẩm Khác",
    ...
    upgrade: "Nâng cấp",
    vip_level: "Cấp độ",
    vip_monthly_reload: "THƯỞNG NAP LẠI HÀNG THÁNG",
    vip_exclusive_promotions: "ƯU ĐÃI VÀ LỢI ÍCH ĐẶC QUYỀN",
    ...
    vip_percent_monthlyreload: "Phần trăm nạp lại hàng tháng",
    vip_min_deposit: "Tiền nạp tối thiểu",
    vip_max_bonus: "Thưởng tối đa",
    vip_return_over: "Vòng cược yêu cầu",
    ...
    vip_poker_rebate: "Poker",
    vip_slot_rebate: "Nổ Hũ",
