export default {
  lang: {
    ...
    deposit_tipdesc: "Để đảm bảo an toàn cho số tiền, bạn cần xác minh số điện thoại di động của mình trước khi nạp tiền",
    deposit_proceedverify: "Tiếp tục xác minh",
    deposit_encounterproblem: "Nếu gặp vấn đề về việc nạp tiền, vui lòng liên hệ ngay với dịch vụ khách hàng trực tuyến để giải quyết!",
    ...
    withdraw_tipdesc: "Để đảm bảo an toàn cho số tiền, bạn cần xác minh số điện thoại di động của mình trước khi rút tiền",
    ...
    vip_tnc_para_1:
      "โปรแกรมนี้ใช้กับสมาชิกวีไอพีที่มีบัญชีที่ถูกต้อง การอัปเกรด VIP ขึ้นอยู่กับยอดรวมของสมาชิก ยอดเงินฝากสะสม ยอดฝากสำเร็จรวมรายวันคำนวณจาก 00:00:01 ถึง 23:59:59 (GMT+8)",
    vip_tnc_para_2:
      "ระบบจะอัปเกรดระดับ VIP โดยอัตโนมัติหลังเวลา 00:00:00 น. (GMT+8) ของวันถัดไป ระดับ VIP สามารถอัพเกรดได้เพียงระดับเดียวต่อวันหากจำนวนเงินฝากทั้งหมดของสมาชิกมีสิทธิ์สำหรับระดับ VIP ที่สอดคล้องกัน",
    vip_tnc_para_3:
      "ระดับโบนัสฟรี เงินคืน และโปรโมชั่นที่สอดคล้องกับระดับ VIP จะได้รับการอัปเดตทันทีที่บัญชีของสมาชิกอัปเดตในวันถัดไป",
    vip_tnc_para_4:
      "โบนัสวันเกิด: สมาชิกที่ฉลองวันเกิดไม่ถึง 90 วันนับจากวันที่ลงทะเบียน จะไม่ได้รับโบนัสวันเกิดปีนี้ เฉพาะสมาชิกที่ลงทะเบียนแล้วเท่านั้น นานกว่า 90 วันสามารถรับได้ปีละครั้ง (โบนัสวันเกิดสามารถถอนได้หลังจากมียอดเทิร์นโอเวอร์ 1 เท่า)",
    vip_tnc_para_5:
      "โบนัสรายเดือน: สมาชิกจะต้องรับโบนัสในหน้าวีไอพีด้วยตนเองหลังจากที่สมาชิกอัปเกรดเป็นระดับใหม่ในวันถัดไป สมาชิกแต่ละคนสามารถรับโบนัส 1 เดือนในเดือนอัปเกรด (โบนัสรายเดือนสามารถถอนได้หลังจาก 3x มูลค่าการซื้อขาย)",
    vip_tnc_para_6:
      "การเดิมพันที่เสมอกัน, ยกเลิกเดิมพัน, เดิมพัน 2 ด้าน, เดิมพันยุโรปแฮนดิแคปต่ำกว่า 1.75, เอเชียนแฮนดิแคปต่ำกว่า 0.75, เกมตัวเลข, กีฬาแฟนตาซี, แจ็คพอต RNG แบบโปรเกรสซีฟ, สล็อตโปรเกรสซีฟ RNG จะไม่ถูกนับในโปรโมชั่นนี้",
    vip_tnc_para_7:
      "Jolly88 ขอสงวนสิทธิ์ในการแก้ไข ปฏิเสธ หรือยกเลิกโปรแกรมสมาชิก VIP นี้ได้ตลอดเวลาโดยไม่ต้องแจ้งให้ทราบล่วงหน้า",
  ...
  error: {
    ...
    608: "มีการเข้าใช้งานมากเกินไป กรุณาลองอีกครั้ง",
    ...
    1004: "ชื่อผู้ใช้มีได้เฉพาะตัวเลขและตัวอักษรเท่านั้น",
    ...
    24001: "มีรายการนี้แล้ว",
    24002: "ตรวจพบ IP เดียวกัน",
    24005: "จำนวนเงินฝากไม่ตรงตามเงื่อนไข",
