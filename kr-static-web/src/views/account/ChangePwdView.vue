      ...
      <el-tab-pane :label="$t('personal.chgPwd')" name="chgPwd">
        <div class="update-pwd-container">
          <el-form ref="updatePwdFormRef" :hideRequiredMark="true" :model="updatePwdInfo" :rules="updatePwdRules">
            <el-form-item ref="refOldPassword" :label="$t('password.initialPwd')" name="oldPassword" prop="oldPassword">
              <el-input
                type="password"
                v-model="updatePwdInfo.oldPassword"
                :placeholder="$t('password.plcInitialPwd')"
                clearable
                show-password
              />
            </el-form-item>

            <el-form-item ref="refPassword" :label="$t('password.newPwd')" name="password" prop="password">
              <el-input
                type="password"
                v-model="updatePwdInfo.password"
                :placeholder="$t('password.plcNewPwd')"
                clearable
                show-password
              />
            </el-form-item>
            ...
            >
              <el-input
                ...
                :placeholder="$t('password.plcCfmNewPwd')"
                clearable
                show-password
              />
            </el-form-item>
...
.standard-button {
  ...
  border: none;
  box-shadow: none;
  background: url(../../assets/images/account/whitebgbtn.png)no-repeat center center;
  background-size: contain;
  &.btn-color-blue {
    background: url(../../assets/images/account/bluebgbtn.png)no-repeat center center;
    background-size: contain;
  }
}
.withdrawBottom {
