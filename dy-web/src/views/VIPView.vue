<template>
  <div class="vip-container">
        ...
        <div class="vip_level">
            <div class="level_img">
              <template v-for="(vip ,n) in vipList" :key="n">
                <img v-if="selectedVIP === (vip.level - 1)" src="../assets/vip/vip_current_bg.png" :class="selectedVIP === (vip.level - 1) ? `btn_vip btn_vip_vip${vip.level} active`: `btn_vip btn_vip_vip${vip.level}`">
                <div :class="selectedVIP === (vip.level - 1) ? `btn_vip btn_vip_vip${vip.level} active`: `btn_vip btn_vip_vip${vip.level}`" @click="!store.token ? selectedVIP = (vip.level - 1) : ''">
    ...
    <Carousel :itemsToShow="1" :wrapAround="true" v-model="selectedVIP">
...
.vip-container .vip-list-container .vip-detail-left-box {
  ...
  height: 263px;
  display: flex;
  /* background-image: url(../img/vip/vip_detail_item_bg.png); */
  background-repeat: no-repeat;
