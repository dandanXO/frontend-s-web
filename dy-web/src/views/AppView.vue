<template>
                ...
                <div class="app-left">  
                    ...
                    <div class="fade-left">
                        ...
                        <template v-if="det.code === 'TY'">
                            <img src="../assets/app/txt_esports_client.png" />
                        </template>
                        ...
                        <div class="app-items">
                            ...
                            <div class="box">
                                <div class="h5"><img src="../assets/app/download_icon_h5.png"></div>
                                <div class="img-desc">使用浏览器输入以下网址<br>免下载访问</div>
                                <a class="app-url" :href="det.mobile">{{ det.mobile }}</a>
                            </div>
                        </div>   
                    </div>
                    <!-- <div class="fade-left">
    ...
    setup() {
      ...
      const platforms = ref([
        ...
        },
        {
          ...
          name: '电竞',
          image: 'dj',
          message: '独立电竞APP，原生态开发，提供业界最多的赛事玩法和最佳水位，竞技视频同步直播，盘口信息准确无误，界面投注一目了然，极速尽享！',
        ...
        },
        {
          ...
          name: '体育',
          image: 'ty',
          message: '独立体育APP，原生态开发，高赔率 玩法多 提供业界最多的赛事玩法和最佳水位，竞技视频同步直播，盘口信息准确无误，界面投注一目了然，极速尽享！',
  ...
  .fade-left {
    -webkit-animation: sport-right-fadein-ani .8s forwards;
      animation: sport-right-fadein-ani .8s forwards;
      -webkit-animation-fill-mode: forwards;
      animation-fill-mode: forwards
  }
  .fade-right {
    -webkit-animation: sport-left-fadein-ani .8s forwards;
      animation: sport-left-fadein-ani .8s forwards;
      -webkit-animation-fill-mode: forwards;
      animation-fill-mode: forwards
  }
    .app-container {
      ...
      .app-container-inner {
        ...
        .app-left {
          ...
          .app-items {
            ...
            .box {
                ...
                .qrcode-bg {
                    background: url(../assets/app/down_qrcode_bg.png) center no-repeat;
                    width: 112px;
                    height: 112px;
                    padding: 7px;
                    display: flex;
        ...
        background: url(../assets/app/sport_phone.png)no-repeat;
          ...
          .app-item-box {
            ...
            &:first-child {
                animation: slide-in 1s forwards cubic-bezier(.83,.97,.05,1.44);
                bottom: 0;
            }
            &:last-child {
                left: 350px;
                top: 250px;
                animation: kick-in 1s forwards cubic-bezier(.83,.97,.05,1.44);
                animation-delay: .5s;
            }
          }
          .absolute {
