export default {
  ...
  referTerms: {
    ...
    howToParticipate1:
      "The referrer must have a TF88 account and have made a minimum deposit of 300 VNDP while participating in betting activities.",
    howToParticipate2:
      "Go to the “Account - Referral” section. From there, members can share their referral link with friends for them to register an account through that link.",
    howToParticipate3:
      "Once the referred person successfully registers an account and accumulates total deposits of 1,000 VDP or more, the referrer will receive a bonus of 10% to 20% based on the total deposits made by the referred individual.",
    howToParticipate4:
      "The maximum bonus for each successful referred person is 800 VNDP, and there is no limit to the number of successful referrals. The more friends you refer, the higher your bonus.",
    ...
    additionalCommissionHint:
      "When referring the 5th person or more, an additional commission from the TF88 affiliate program will be applied, with bonus percentages starting from 40%.",
    termsCondition: "Terms and Conditions:",
    termsCondition1:
      "This promotion is exclusively for TF88 members who have previously made deposits and participated in betting activities.",
    termsCondition2:
      "The referred person must not have registered with TF88 before and must not have any other accounts with TF88.",
    termsCondition3:
      "Bonus calculations occur from Monday to Sunday each week. Referrers should contact customer support on the following Monday to request their previous week’s bonuses.",
    termsCondition4:
      "Referral links will be refreshed on the 1st day of each month, rendering all referrals from the previous month invalid.",
    termsCondition5: "Bonuses must be wagered 5 times before withdrawal.",
    termsCondition6:
      "After the referral bonus is credited to the referrer’s account, the member must complete the required wagering within 60 days. Failure to meet the wagering requirements will result in the bonus and winnings (if any) being revoked.",
    termsCondition7:
      "Certain bet types, including draws, cancellations, two-sided bets, Europe Handicap with odds below 1.75, Asian Handicap below 0.75, virtual sports, horse racing, and Number Game, are not eligible for this program.",
    termsCondition8:
      "TF88 reserves the right to modify, reject, or cancel this promotion at any time without prior notice.",
    termsCondition9:
      "This promotion cannot be combined with other deposit-related promotions. After participating in this promotion, valid turnover requirements must be met within 30 days; otherwise, all profits and bonuses will be deducted.",
