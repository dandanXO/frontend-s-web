export default {
  ...
  referTerms: {
    ...
    presenteeConditions3: "Must have the first successful deposit transaction and have a cumulative valid bet of at least 4,000VNDP.",
    specifiedLink: 'Members can get specified refer a friend link in "Personal information - Refer a friend". You will then send the referral link to your friend for them to click and register an account with via the link. ',
