export default {
  ...
  "placeholder": {
    ...
    "username": "Tên tài khoản dài từ 6-11 ký tự",
    "password": "Mậu khẩu dài từ 6-11 ký tự ",
    passwordDifferent: 'Mật khẩu hai lần nhập không giống nhau',
    ...
    wholeNumber: "Số tiền phải là số dương",
    verificationSuccess: "Gửi mã xác nhận điện thoại thành công",
    validMobileNo: "Vui lòng nhập số điện thoại hợp lệ",
    bankBranchAddress: 'Vui lòng nhập địa chỉ của chi nhánh ngân hàng',
  ...
  "promo": {
    ...
    "check_in_detail_for_this_month": "Chi tiết điểm danh của tháng này",
  ...
  "withdraw": {
    ...
    unbindSuccessful: 'Gỡ bỏ thẻ thành côn',
    incorrectAccNumber: 'Số thẻ không chính xác vui lòng nhập lại',
    cancelUnbind: 'Huỷ bỏ gỡ bỏ',
    inputBankBranch: 'Vui lòng nhập địa chỉ mở thẻ',
    inputAccNumber: 'Vui lòng nhập số tài khoản',
    onlyNumuber: 'Định dạng số thẻ ngân hàng chỉ có thể chứa các chữ số',
    verifyCodeSuccess: 'Gửi mã xác nhận thành công',
    enterUnbind: 'Vui lòng nhập tên ',
    of:'của',
    enterWalletNumber: 'Vui lòng nhập số tài khoản ví ảo',
  ...
  "affiliate": {
    ...
    "afftnc1": "Nếu số lượng thành viên hoạt động ít hơn 5 trong một tháng, sẽ không có hoa hồng.",
    "afftnc2": "Nếu tài khoản đối tác có hoa hồng âm trong tháng (lợi nhuận âm: là số tiền mà đối tác nợ công ty), số tiền âm sẽ được tích lũy vào các tháng tiếp theo cho đến khi số tiền âm được thanh toán. Tất cả các đối tác phải thanh toán phí khi sử dụng nền tảng của chúng tôi, bao gồm:",
    "afftnc2-1": "Phí gửi và rút tiền của ngân hàng.",
    "afftnc2-2": "Khuyến mãi được yêu cầu bởi người dùng của họ.",
    "afftnc2-3": "Phí nền tảng.",
    "afftnc3": "Hoa hồng sẽ được kiểm tra bởi ngày 5 hàng tháng, phát hành vào ngày 10 hàng tháng bằng loại tiền VND. Từ ngày 10 trở đi, đối tác có thể tiến hành rút hoa hồng của mình.",
    "afftnc4": "TF88 giám sát tất cả các người dùng của đối tác và có tiêu chuẩn riêng (mức độ rủi ro, số tiền gửi, chỉ số đặt cược...) khi đánh giá những người dùng như vậy. Nếu họ không đáp ứng được các tiêu chuẩn, TF88 có quyền từ chối việc phát hành hoa hồng cho đối tác.",
    "afftnc5": "Một đối tác duy nhất phải đăng ký chỉ một Email, Số điện thoại và Tên.",
    "afftnc6": "Đại lý cũ thực hiện thanh toán hoa hồng phải có không ít hơn 3 thành viên mới hoạt động trong tháng hiện tại, và tổng số thành viên hoạt động không được ít hơn năm.",
    "afftnc7": "Các hành vi làm giả đối tác (tạo tài khoản hạ tầng giả mạo, can thiệp vào hành vi đặt cược của hạ tầng, đăng nhập từ nhiều thiết bị...) bị chặn bởi hệ thống hoặc chuyên gia của chúng tôi sẽ bị phạt.",
    "afftnc8": "TF.com có quyền thay đổi hoặc điều chỉnh tỷ lệ hoa hồng mà chúng tôi cho là phù hợp.",
    "afftnc9": "TF.com có quyền thay đổi hoặc sửa đổi các điều khoản trên hoặc thêm bất kỳ điều khoản bổ sung nào nếu cần thiết.",
    "afftnc10": "TF.com có quyền hủy tư cách đối tác bất cứ lúc nào mà không cần thông báo trước trong trường hợp tài khoản đối tác không đáp ứng các yêu cầu được đề ra trong một khoảng thời gian nhất định và có hành vi gian lận và vi phạm.",
   "CommissionPlan": "Kế hoạch hoa hồng",
    ...
    realProfit: "Lợi nhuận(VND)",
    realProfit1: "0~2 tỷ",
    realProfit2: "2.01 tỷ~3 tỷ",
    realProfit3: "3.01 tỷ~4 tỷ",
    realProfit4: "4 tỷ trở lên",
    totalLossCustomers: "-Tổng tiền khách thua:",
    totalAmtDepositMth: "-Tổng tiền khách nạp trong tháng:",
    totalAmtWithdrawnInMth: "-Tổng tiền khách rút trong tháng:",
    totalPromoCustomersInMth: "-Tổng thưởng khách nhận trong tháng:",
    bankTransFee: "-Phí giao dịch ngân hàng((tiền nạp+tiền rút)*1%):",
    downlineAffiliate: "THU NHẬP 10% HOA HỒNG ĐẠI LÝ TUYẾN DƯỚI",
    downlineAffiliate1: "Tính từ tổng tiền thua của các thành viên tham gia cược.",
    downlineAffiliatept2: "10% hoa hồng từ các đại lý tuyến dưới của mình. ( khi giới thiệu thành viên thường khi đã đăng ký tài khoản dưới mã đại lý (đại lý A) của mình. Thành viên đó đăng ký và trở thành đại lý (đại lý B). Đại lý A sẽ được nhận 10% hoa hồng trên tổng tiền hoa hồng đại lý B được nhận, với điều kiện Đại lý A tháng đó cũng phải có tiền hoa hồng.",
    downlineAffiliate2: "Ví dụ: Đại lý của bạn Đại lý A -> bạn giới thiệu 1 người nào đó làm đại lý của TF.com (Đại lý B) Thu nhập của đại lý A trong tháng = 10,000 VND. Tiền hoa hồng của Đại lý B trong tháng = 20,000 VND⇨Đại lý A sẽ được nhận 10% hoa hồng từ Đại lý B: 10% x 20,000 = 2000 VND Tổng thu nhập Đại lý A sẽ được nhận: 10,000 + 2000 = 12,000 VND", 
    paymentMethods: "PHƯƠNG THỨC THANH TOÁN",
    paymentMethods1: "Tiền hoa hồng sẽ được thanh toán vào ngày 10 hàng tháng.",
    ...
    "applyAgentNow": "Đăng ký và trở thành đại lý ngay"
  },
  about: {
    affiliate: "Đại Lý",
    "aboutus": "Về TFGaming",
  ...
  vip: {
    ...
    "accumulatedDeposit": "Yêu Cầu Để Nâng Cấp VIP",
    "vipProgram": "ƯU ĐÃI VIP",
    "exclusivePromotions": "ƯU ĐÃI VÀ LỢI ÍCH ĐẶC QUYỀN",
    "3timedeposit": "3 lần nạp tiền",
    ...
    "monthlyReload": "TIỀN THƯỞNG NAP LẠI HÀNG THÁNG",
    "monthlyReloadPercent": "Phần Trăm Nạp Lại Hàng Tháng",
    "minDeposit": "Số Tiền Nạp Tối Thiểu",
    "maxBonus": "Số Tiền Thưởng Tối Đa",
    "returnOver": "Tỉ Lệ Hoàn Trả",
  ...
  app: {
    ...
    live: "Live Casino, Xổ Số, Nổ Hũ v.v… tất cả các trò chơi đều nằm trong tầm tay bạn.",
    hot: "Phát sóng trực tiếp các giải đấu lớn nhỏ và những khuyến mãi hấp dẫn, tặng thưởng không ngừng nghỉ.",
    h5: "Trang web H5 trên thiết bị di động.",
    app: "Tải ứng dụng TF88.",
  ...
  "welcome": {
    ...
    "instantDeposit": "Người chơi nạp tiền ngay sau khi đăng ký có thể nhận được tới 84%",
    "yourFirstDeposit": "Nạp tiền lần đầu của bạn sẽ kích hoạt các ưu đãi sau:",
    "firstDepositBonus": "Nạp tiền lần đầu \"Esports/Sports/Live/Chess\" nhận 68%",
    "completeBeginnerTasks": "Hoàn thành nhiệm vụ mới và nhận được 228 đồng Leihuo!",
    "dailyCashback": "Hoàn tiền toàn bộ trang web hàng ngày, lên tới 2.0% không giới hạn!",
    "dailyInsuranceBets": "Các cược bảo hiểm hàng ngày Esports/Sports đảm bảo bạn có lãi mà không mất!",
  ...
  sports: {
    ...
    sbo: 'Thể thao SBOBET là nhà cung cấp tỷ lệ cá cược tin cậy hàng đầu khu vực, mạng lưới phủ sóng rộng khắp các quốc gia châu Á. Hỗ trợ hàng trăm kiểu cược và hàng nghìn sự kiện mỗi năm. Phát sóng trực tiếp các kèo đấu chính xác tới từng giây tới người chơi đam mê chiến thắng.',
    cmd: 'Tôn chỉ phục vụ của chúng tôi là niềm vui của khách hàng. Bằng việc cung cấp hầu hết các lựa chọn trò chơi và thị trường tương ứng, CMD368 đặt mục tiêu cung cấp dịch vụ và trải nghiệm trò chơi hàng đầu và đưa ra tỷ lệ cược tốt nhất',
  },
  lottery: {
    loto: 'Xổ số tại TF88 có tỷ lệ cược hấp dẫn đa dạng về hình thức đặt cược, trả thưởng cực nhanh sau giờ quay.',
    gpi: 'Xổ số tại TF88 có tỷ lệ cược hấp dẫn đa dạng về hình thức đặt cược, trả thưởng cực nhanh sau giờ quay.',
    tcg: 'Xổ số tại TF88 có tỷ lệ cược hấp dẫn đa dạng về hình thức đặt cược, trả thưởng cực nhanh sau giờ quay.'
  },
  livecasino: {
    ag: 'Live Casino AG có thể lệ 6 lá Poker chia trước đầu tiên trên thế giới, bàn VIP, squeeze baccarat, baccarat điều khiển thông minh và các trò chơi baccarat tương tác khác. Tương thích với nhiều thiết bị đầu cuối cho phép Bạn tận hưởng không ngừng。',
    we: "Cùng WE Vui chơi và Nhận thưởng Từ khi WE thành lập năm 2012 đến nay luôn nỗ lực tạo nên một nền tảng giải trí di động thú vị và sáng tạo, không chỉ cung cấp hỗ trợ kỹ thuật chuyên nghiệp và thiết bị cao cấp ổn định, mà còn hỗ trợ nhiều nền tảng, có nhiều chứng nhận giấy phép quốc tế, mang lại cho người chơi môi trường giải trí đáng tin cậy. Ngoài ra, vài trăm dealer được đào tạo chuyên nghiệp cùng môi trường sòng bạc mô phỏng, càng giúp người chơi tha hồ tận hưởng thú vui giải trí。",
    evo: "Evolution Gaming là nền tảng chia bài trực tuyến mức độ tinh tế cao với hàng loạt các sản phẩm từ Cờ Tỷ Phú đến Blackjack, Roulette, Poker Ba Lá, Casino Hold'em, Ultimate Texas Hold'em, Caribbean Stud Poker với phong cách lịch lãm kiểu Châu Âu. Trải nghiệm Evo Palace trong tầm tay bạn.",
    wm: "Trong hơn 20 năm, ông đã cống hiến hết mình cho việc nghiên cứu và phát triển công nghệ và hệ thống, và đã được công nhận bởi những người lọt vào vòng chung kết hoặc giải thưởng quốc tế của ngành. Trong những năm gần đây,WM Video tích cực tham gia các sự kiện quốc tế và tài trợ cho một số sự kiện nổi tiếng thế giới, bao gồm đua xe công thức, sự kiện bóng, v.v., đồng thời tích cực kêu gọi sự ủng hộ mạnh mẽ cho các tổ chức từ thiện, không tiếc công sức đầu tư vào các vấn đề quốc tế khác nhau và cung cấp cho ngành công nghiệp một góc nhìn đa dạng và rộng hơn.",    
    ae: "AE Casino, video hành động trực tiếp tiềm năng nhất châu Á, tập trung vào việc cung cấp cho khách hàng các sản phẩm trò chơi chất lượng cao và an toàn. Nó cung cấp nhiều trò chơi video trực tiếp như Baccarat, Speed ​​Baccarat, Gongmi Baccarat, Colourful Baccarat, Dragon Tiger, Sic Bo, Roulette, Niu Niu, Fried Golden Flower, v.v. và hỗ trợ đầy đủ PC, H5, APP. Giao diện đơn giản và dễ vận hành, đa nền tảng, không cần tải xuống, vui vẻ mọi lúc, mọi nơi!",
    dg: "Hàng trăm dealer chuyên nghiệp được đào tại bài bản tại Sòng DG sẽ giúp bạn một trải nghiệm hơn cả casino mặt đất khi tham gia chơi tại đây. Với các thiết bị cao cấp ổn định và hỗ trợ kỹ thuật chuyên nghiệp để đảm bảo nền tảng hoạt động ổn định và mang đến cho người chơi trải nghiệm tuyệt vời như thể họ đang ở tại một song Casino đích thực. Hơn nữa song DG còn hỗ trợ truy cập đa nền tảng, bất kể người chơi hiện đang ở đâu, họ có thể tận hưởng trò chơi một cách đầy đam mê bất cứ lúc nào và hơn hết là chiến thắng."
  },
  poker: {
    v8: "Công nghệ hàng đầu của châu Á",
    km: "Nhà cung cấp trò chơi 3D hàng đầu, chơi  Bầu Cua, Xóc Đĩa tại Kingmaker ngay!",
    kp: "Texas Hold'em, Long Hổ Đấu và nhiều thể loại Poker khác tùy Bạn chọn",
    gpi: "Tập đoàn LEG khuếch trương đầu tư phát triển Poker LEG",
    rich88: "Rich88 cung cấp trò chơi 3D với tỷ lệ cược hấp dẫn, Xì Dách, Xóc Đĩa, Sicbo... ",
  },
  cockfight: {
  ...
  status: {
    ...
    suspend: "Đơn đang chờ thẩm định",
    automaticPaymentInProgress: "Đơn đang chờ thanh toán",
    sending: "Đơn đang gửi",
    closed: "Đóng",
    bet: "Cá cược",
    settlement: "Kết cược",
    settled: "Đã kết cược",
    betAndClosed: "Cá cược và đóng cược",
    cancel: "Bỏ hủy",
    fixed: "Sửa thêm",
  ...
  response: {
    ...
    801: "Mã xác nhận mật khẩu đã hết hạn",
    ...
    1305: "Ngân hàng không được tìm thấy",
    1306: "Vượt quá giới hạn thời gian rút hàng ngày",
    ...
    24005: "Không đạt đến số tiền gửi tối thiểu",
    30000: "Không tìm thấy dữ liệu thành viên",
    30001: "Thành viên đã nhận ưu đãi",
    30002: "Thành viên đã gửi số ngày hôm nay",
    ...
    35004: "Số phiếu được cung cấp vượt quá giới hạn phiếu bầu của thành viên",
    35006: "Chúng tôi đã đạt đến hạn mức",
