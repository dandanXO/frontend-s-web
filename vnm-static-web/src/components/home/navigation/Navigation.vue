            ...
            <template v-if="nav.hasicon">
                <div class="header-menu-item">
                    <router-link @mouseover="showSubMenu(nav)" @mouseup="selectedMenu = ''" :to="nav.path">
                        <span>
                            <img class="hover-icon" src="../../../assets/images/home/header-promo-icon.svg"
                                alt="promotion" v-if="nav.code === 'Promotion'" />
                            <img class="hover-icon" src="../../../assets/images/home/header-affiliate-icon.svg"
                                alt="affiliate" v-if="nav.code === 'Agent'" />
                            <img class="hover-icon" src="../../../assets/images/home/header-download-icon.svg"
                                alt="download TF88 app" v-if="nav.code === 'App'" />
                            <img class="hover-icon" src="../../../assets/images/home/header-vip-icon.svg" alt="vip"
                                v-if="nav.code === 'VIP'" />
                        </span>
                        <span>{{ nav.name }}</span>
                    </router-link>
