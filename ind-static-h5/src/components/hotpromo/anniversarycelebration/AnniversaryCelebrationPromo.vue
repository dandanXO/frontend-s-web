  ...
  <div>
    ...
    <div class="prize-container">
      ...
      <!-- <div class="content-item">
        ...
        <div class="item-day">Day 1</div>
        <div class="item-img">
          <img src="../../../assets/images/promotion/anniversary-celebration/prize-01.png" />
        </div>
        <div class="item-free">Free 88rs</div>
      </div>
      <div class="content-item">
        <div class="item-day">Day 2</div>
        <div class="item-img">
          <img src="../../../assets/images/promotion/anniversary-celebration/prize-02.png" />
        </div>
        <div class="item-free">Free 188rs</div>
      </div>
      <div class="content-item">
        <div class="item-day">Day 3</div>
        <div class="item-img">
          <img src="../../../assets/images/promotion/anniversary-celebration/prize-03.png" />
        </div>
        <div class="item-free">Free 288rs</div>
      </div>

      <div class="content-item">
        <div class="item-day">Day 4</div>
        <div class="item-img">
          <img src="../../../assets/images/promotion/anniversary-celebration/prize-04.png" />
        </div>
        <div class="item-free">Free 388rs</div>
      </div>
      <div class="content-item">
        <div class="item-day">Day 5</div>
        <div class="item-img">
          <img src="../../../assets/images/promotion/anniversary-celebration/prize-05.png" />
        </div>
        <div class="item-free">Free 460rs</div>
      </div>
      <div class="content-item">
        <div class="item-day">Day 6</div>
        <div class="item-img">
          <img src="../../../assets/images/promotion/anniversary-celebration/prize-06.png" />
        </div>
        <div class="item-free">Free 588rs</div>
      </div>

      <div class="content-item full-wide">
        <div class="item-day">Day 7</div>
        <div class="item-img">
          <img src="../../../assets/images/promotion/anniversary-celebration/prize-07.png" />
        </div>
        <div class="item-free">Free 888rs</div>
      </div> -->
    </div>
    ...
    <div class="not-available">
      ...
      <p class="font-gold">
        We regret to inform you that you did not meet the eligibility criteria for this event. Please stay tuned for our
        next event
      </p>
    </div>
  </div>
...
const receiveCheckinReward = () => {
  eventapi.put(`/bonus/claim/indwin-check-in`).then((res) => {
    const resp = res.data;
