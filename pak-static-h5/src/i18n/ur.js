...
انعامات کی تقسیم کا وقت: اگلے دن پاکستانی وقت کے مطابق دوپہر 3:00 بجے سے شام 6:00 بجے تک۔ اس وقت کے دوران انعامات اکاؤنٹ میں منتقل کر دیے جائیں گے۔`,
  ...
  hotPromo: {
    ...
    depositSpinWheel: {
      ...
      rule_01: "یہ سرگرمی چار قسم کے کیروسلز پر مشتمل ہے: سلور، گولڈ، ڈائمنڈ، اور اسپیشل۔ آپ ریچارج کرکے مختلف سطحوں کے کیروسلز کو ان لاک کر سکتے ہیں۔ جتنی اعلیٰ سطح ہوگی، انعامات اتنے ہی زیادہ ہوں گے۔",
      ...
      rule_05: "اس ایونٹ کی تشریح کا حق B9.game کے پاس محفوظ ہے۔ اگر آپ کے کوئی سوالات ہوں تو براہ کرم کسٹمر سروس سے رابطہ کریں۔",
      silver: "سلور",
      gold: "گولڈ",
      diamond: "ڈائمنڈ",
      supreme: "سپریم"
    ...
    jackpotAviator: {
      ...
      jackpot: "جیک پاٹ",
      noRank: "کوئی درجہ",
      rules1: "روزانہ کی درجہ بندی کا انعام: پلیٹ فارم کے روزانہ کے مجموعی کاروبار کا 1.5% روزانہ انعامی پول میں شامل کیا جائے گا، یہ پول کھلاڑی کی روزانہ کی درجہ بندی میں اس کی جگہ کے مطابق روزانہ خودبخود تقسیم کیا جائے گا۔",
      rules2: "ہفتہ وار درجہ بندی کا انعام: پلیٹ فارم کے ہفتہ وار مجموعی کاروبار کا 0.6% ہفتہ وار انعامی پول میں شامل کیا جائے گا، یہ پول کھلاڑی کی ہفتہ وار درجہ بندی میں اس کی جگہ کے مطابق ہفتہ وار خودبخود تقسیم کیا جائے گا۔",
      ...
      activityRules3: "روزانہ کی درجہ بندی مقامی وقت کے مطابق صبح 12:00 بجے سے شروع ہوتی ہے اور رات 12:00 بجے ختم ہوتی ہے۔ روزانہ انعامات روزانہ درجہ بندی ختم ہونے کے آدھے گھنٹے کے اندر دیے جائیں گے اور انہیں پروموشن صفحہ پر دستی طور پر وصول کیا جا سکتا ہے۔",
      activityRules4: "ہفتہ وار درجہ بندی کا آغاز پیر کو مقامی وقت کے مطابق صبح 12:00 بجے سے ہوتا ہے اور اتوار کو رات 12:00 بجے ختم ہوتا ہے۔ ہفتہ وار انعامات ہفتہ وار دور ختم ہونے کے آدھے گھنٹے کے اندر دیے جائیں گے اور انہیں پروموشن صفحہ پر دستی طور پر وصول کیا جا سکتا ہے۔",
      termsCondition1: "کھلاڑی کو انعامات وصول کرنے سے پہلے اپنا فون نمبر اور بینک اکاؤنٹ کی معلومات فراہم کرنا ہوں گی۔ فون نمبر، آئی پی ایڈریس اور بینک اکاؤنٹ کی معلومات متعلقہ علاقے اور ذاتی معلومات سے مطابقت رکھنی چاہیے۔ کھلاڑی کی کسی بھی غیر معمولی سرگرمی اس کے انعامات یا فوائد کو ضائع کر دے گی۔",
      termsCondition2: "کھلاڑی جو متعدد اکاؤنٹس یا دھوکہ دہی کے اکاؤنٹس کھولتے ہیں ان کو پلیٹ فارم پر ان کی نامناسب سرگرمی کی وجہ سے سرگرمی میں حصہ لینے کے لیے نااہل کر دیا جائے گا اور متعلقہ اکاؤنٹس کو منجمد کر دیا جائے گا۔",
