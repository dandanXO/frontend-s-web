...
انعامات کی تقسیم کا وقت: اگلے دن پاکستانی وقت کے مطابق دوپہر 3:00 بجے سے شام 6:00 بجے تک۔ اس وقت کے دوران انعامات اکاؤنٹ میں منتقل کر دیے جائیں گے۔`,
  ...
  bankCard: {
    ...
    telephone: "ٹیلیفون",
    captchaSuccess: "عمل کامیاب، براہ کرم اپنے موبائل پر بھیجا گیا کوڈ چیک کریں!",
    captchaFailed: "تصدیقی کوڈ کی جانچ ناکام، براہ کرم صفحہ دوبارہ لوڈ کریں",
    clickAndEnterPhoneCode: "براہ کرم تصدیقی کوڈ حاصل کرنے کے لیے کلک کریں اور اپنے رجسٹرڈ فون نمبر پر بھیجا گیا کوڈ درج کریں",
  },
  promo: {
    all: "سب",
    earn: "کمائیں",
