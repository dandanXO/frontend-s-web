...
انعامات کی تقسیم کا وقت: اگلے دن پاکستانی وقت کے مطابق دوپہر 3:00 بجے سے شام 6:00 بجے تک۔ اس وقت کے دوران انعامات اکاؤنٹ میں منتقل کر دیے جائیں گے۔`,
  ...
  hotPromo: {
    ...
    "consecutiveDepositBonus": "جتنے زیادہ مسلسل دنوں تک آپ ڈپازٹ کی شرائط پوری کریں گے، اتنا ہی زیادہ اضافی بونس حاصل کریں گے۔",
  ...
  content: {
    ...
    "message1": "جب جمع شدہ رقم 1000 روپے تک پہنچ جائے تو آپ رقم نکالنے کی درخواست دے سکتے ہیں (انعام براہ راست آپ کے والیٹ میں شامل کر دیا جائے گا)۔",
    "message2": "جب کوئی دستیاب اسپنز نہ ہوں تو کسی نئے کھلاڑی کو رجسٹر اور ڈپازٹ کروانے پر آپ کو مفت اسپنز ملیں گے۔",
    "message3": "یہ ایونٹ 3 دن تک جاری رہے گا۔ ایونٹ ختم ہونے کے بعد جمع شدہ انعامات ری سیٹ کر دیے جائیں گے اور ایونٹ دوبارہ شروع ہو جائے گا۔",
    ...
    "message7": "مدعو کردہ صارف کو اپنا فون نمبر تصدیق کرنا ہوگا، دعوت دینے والے کے ریفرل لنک سے رجسٹریشن کرنا ہوگی، اور اس کا IP ایڈریس منفرد ہونا چاہیے تاکہ ریفرل اہل ہو۔",
    "aviatorPromoIntro": "Aviator کے ساتھ بیٹنگ کا جوش محسوس کریں! صرف ایک کلک سے آپ کا Aviator حیران کن 3,216 گنا جیت سکتا ہے! ٹاپ 50 کے لیے انعامی رقم 1,250,000 روپے ہے!",
    "aviatorGoldenEgg": "ہر روز Aviator پر بیٹنگ کرتے ہوئے، جب مؤثر بیٹنگ کی رقم 888 روپے تک پہنچ جائے، تو آپ کو سنہری انڈا (SUNEHRI ANDY) توڑنے کا موقع ملتا ہے۔ زیادہ سے زیادہ انعام: 88,888 روپے، جیتنے کا امکان: 3.6٪",
    "aviatorTopTurnover": "Aviator پر بیٹنگ کے دوران، سب سے زیادہ مجموعی ٹرن اوور والا کھلاڑی پہلی پوزیشن کے لیے اہل ہو گا۔",
    ...
    "cashRainClaimCondition": "انعام حاصل کرنے کے لیے کم از کم 300 روپے کا تاریخی ڈپازٹ برقرار رکھیں اور روزانہ کم از کم 100 روپے کی شرطیں مکمل کریں۔",
