    ...
    <div class="player-guide" :class="`${localType}-mode`">
      <div class="steps-portion" :class="`steptopmain-${currentAdditionalStep} ${localType}-mode`">
        ...
        <div class="main-box">
          ...
          <template v-if="localType === 'refer' && localStep === 4">
            <img src="../../assets/images/newplayerguide/inv4.png" />
          </template>
...
const additionalReferSteps = ref([
  ...
  { step: 4, instruction: "Invite 1 person and get a reward of 250 RS (maximum 1000 RS/person)" }
]);
