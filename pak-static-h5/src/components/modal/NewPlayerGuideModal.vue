<template>
    ...
    >
        <div class="player-guide">
          ...
          <div class="close-dialog" @click="closeDialog"><img src="../../assets/images/newplayerguide/close-btn.png"></div>
            <template :key="index" v-for="(step, index) in steps">
              <div class="step" :class="`step-${index+1}`"  v-if="currentStep === (index+1).toString()">
                ...
                <div class="main-box">
                  <div v-if="!isVideo">
                    <div v-if="index+1 === 1" class="language" @click="router.push('/language')">{{ $t("sideNav.language") }}<span class="pen"><img src="../../assets/images/newplayerguide/edit.png"></span></div>
                    ...
                    <div v-else class="other-steps">
                      <div class="midimg"><img :src="require(`../../assets/images/newplayerguide/step-mid-${index+1}.png`)"></div>
                      <div class="mid-content"><div class="ins">{{ step.instruction }}</div><div class="amt">{{ step.earnableAmt }}RS</div></div>
                    </div>
                     
                    <div v-if="index+1 === 1">
                       <div class="welcome">
                        {{ t('playerGuide.welcomeMessage') }} <span class="yellow">B9GAME!</span> {{ t('playerGuide.teachingHowToEarn') }}
                    ...
                    <div v-if="index+1 === 2">
                      <div class="hotgames">
                        <div class="hottitle"><img src="../../assets/images/newplayerguide/hotgameicon.png"><span>{{ t('playerGuide.hotGames') }}</span></div>
                        <div class="hotitems">
                    ...
                    <div v-if="index+1 === 4">
                      <div class="share-steps">
                        <div class="share-step">
                          <img src="../../assets/images/newplayerguide/step-01.png">
                          <div>{{ t('playerGuide.maxReward') }} <span class="yellow">1000</span> {{ t('playerGuide.rs') }}</div>
                        </div>

                        <div class="share-step">
                          <img src="../../assets/images/newplayerguide/step-02.png">
                          <div><span class="yellow">5%</span> {{ t('playerGuide.extraBonus') }}</div>
                        </div>

                        <div class="share-step">
                          <img src="../../assets/images/newplayerguide/step-03.png">
                          <div>{{ t('playerGuide.lifetimeCommission') }} <span class="yellow">0.6%</span> {{ t('playerGuide.commissionDetails') }}</div>
                        </div>
                      </div>
                    ...
                    <div v-if="index+1 === 5">
                      ...
                      <ul class="note">
                        <li>{{ t('playerGuide.arrivalTime') }} <span class="yellow">5-30</span> {{ t('playerGuide.minutes') }}</li>
