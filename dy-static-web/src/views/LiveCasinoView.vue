      ...
      <template v-for="(det, idx) in platforms" :key="idx">
        <template :class="active" v-if="selectedPlat === det.code">
          <div class="live-right fade-right">
            <img class="bgimg" :class="det.image" :src="require('../assets/live/left_person_' + det.image + '.webp')">
          ...
          <div class="live-left">
            <div class="platform-list-box">
                    <span class="platform-list-item platform" v-for="(plat, i) in platforms" :key="i"
