<template>
  <div class="vip-container">
    ...
    <div class="terms-conditions">
      ...
      <h2>五. 每日额外返水红包</h2>
      <ol class="terms">
        <li>统计每日返水金额，对应VIP等级返水加赠比例派发。次日可领取每日额外返水红包彩金，返水红包积累至10元即可领取（不足10元则不可领取），彩金1倍流水即可提款。<br>例：VIP12会员当日的返水金额为1000元，则按照VIP12每日额外返水红包赠送比例2.0%计算：1000*2.0%=20元，返水红包为20元，会员可在页面上点击领取。</li>
      </ol>
      
      <h2>六. 每月15号红包</h2>
      <ol class="terms">
        <li>会员日为每月15号00:00起：雷火会员在上个月有任意一笔有效存款，即可在会员日15号00:00至21号23:59期间领取对应等级的会员日礼金（以领取时的等级为准）会员礼金仅需三倍流水即可出款，过期未领者则视为主动放弃：</li>
      </ol>
      
      <h2>七. 充值赠送20%奖金</h2>
      <ol class="terms got-bullets">
        <li>VIP1及以上会员在会员日当天至21号23:59可登录VIP活动页面领取专属充值加码券且加码券需在15日内在充值页面进行勾选优惠使用，成功使用后需要（本金+彩金）x8倍流水即可提款；</li>
        <li>加码券使用不支持USDT存款方式，加码券使用当日不可与其他存款优惠共享。</li>
      </ol>
