    ...
    <div>
      ...
      <div v-if="activeKey === 1" class="tab-content">
        <div class="tab-section">
          <img class="title-banner-image" src="../assets/images/privilege-invite/act-time.png" width="560" height="28" />
        ...
        <div class="tab-section">
          <img class="title-banner-image" src="../assets/images/privilege-invite/act-rules.png" width="560" height="28" />
      ...
      <div v-if="activeKey === 3" class="tab-content">
        ...
        <div class="tab-section">
          ...
          <div class="rules">
            ...
            <p>3.每日有效投注返利结算发放时间为：奖金将会在次日凌晨00:00至下午16:00之间自动派发至您的主账户（发放前一日的有效投注返利）; 奖金最低派发为1元，等于1元不 派发，奖金只需1倍有效流水提款。</p>
      ...
      <el-dialog v-model="isCheckRecordModalVisible" title="" width="100%" align-center style="max-width: 800px"
