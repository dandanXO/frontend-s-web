<template>
  <div class="cs2">
    ...
    <div class="section third">
      ...
      <div class="content">
        <p>
          1.活动期间,每日投注BLAST Premier 春季总决赛达到100元有效投注即可获得1个开箱钥匙,开箱钥匙与开箱次数每日不设上限
        </p>
        <p>
        ...
        <p>
          ...
          春季总决赛有效投注≥1,000元则视为签到成功,达到指定签到天数则可开启签到宝箱,每个宝箱每位用户仅可开启一次
        </p>
    ...
    .middle-row {
      .item-container {
        ...
        .item {
          ...
          gap: 16px;
          padding: 20px 0;
          background: url(@/assets/images/promotion/hotpromo/blastpremier/treasure-bg.png) no-repeat center center;
          cursor: pointer;
          ...
          &.active,
          &:hover {
            background: url(@/assets/images/promotion/hotpromo/blastpremier/treasure-bg-active.png) no-repeat center
              center;
            color: #01f8f9;
          }
        }
