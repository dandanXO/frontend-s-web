      ...
      <div class="option1" v-if="selected === 'option1'">
        <div class="container">
                ...
                <div class="step-content">
                  ...
                  >
                    <img
                      ...
                      src="@/components/hotpromo/newplayerguide/images/green-check.png"
          ...
          <div class="right-panel">
            <img src="@/components/hotpromo/newplayerguide/images/bigGift.png" alt="Gift" />
          </div>
        </div>
        <div class="container2">
          ...
          <div class="right-panel">
            <img
              style="height: 130px"
              src="@/components/hotpromo/newplayerguide/images/blueEnvelope.png"
              alt="Gift"
            />
          </div>
        </div>
      ...
      <div class="container">
        <div class="left-panel">
          <div style="display: flex; align-items: center; margin-bottom: 12px">
            <img
              class="big-icon"
              src="@/components/hotpromo/newplayerguide/images/mark.png"
              alt="Gift"
              width="32px"
            />
