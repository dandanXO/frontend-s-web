    ...
    <div class="provilege-invite-wrapper">
      ...
      <template v-if="activeTab === 3">
        ...
        <div class="tnc">
          ...
          <div class="note">8.为避免文字理解差异，雷火电竞保留此活动最终解释权。</div>
        </div>
      </template>
    </div>
  </div>
...
const hotPromoNav = [
  ...
  },
  {
    id: 2,
    label: "携手宏图",
    path: "/promotion?name=dy2-refer-bonus"
  },
  {
    id: 3,
    label: "共创未来",
    path: "/promotion?name=Dongying-refer"
  }
];
...
const retrieve = () => {
  claimBonusItem("dy2-vip-upgrade-bonus")
    .then((res) => {
      if (res.code === 0) {
