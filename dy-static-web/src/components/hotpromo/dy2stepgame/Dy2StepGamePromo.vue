    ...
    <div class="stepgame-container">
      ...
      <div class="game-container">
        ...
        <div class="game-header-img">
          <img src="../../../assets/images/promotion/hotpromo/dy2-step-game/stepgame-top-img.png" />
        </div>
...
.stepgame-wrapper {
  ...
  .game-container {
    ...
    background: rgba(8, 9, 43, 0.6);
    border-radius: 36px;
    border: 2px solid #94def9;
  }
