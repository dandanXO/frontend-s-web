    ...
    <div class="livepoker-rebate-container">
      ...
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="little-title">
          ...
          <div class="right">活动期间在PGL 布加勒斯特 2025当日总有效投注≥2,000 元即可获得最高1288元的投注金</div>
        </div>
        ...
        <div class="livepoker-rebate-game-bottom">
          <div class="livepoker-rebate-game-bottom-left-title">
            ...
            会员 在PGL 布加勒斯特 2025赛事期间当日总有效投注 50,000 元，在次日 24 小时内可获得彩金：188元
          </div>
        </div>
      </div>
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              活动期间，活动仅计算电竞场馆中PGL 布加勒斯特 2025赛事，会员在PGL 布加勒斯特
              2025赛事期间当日累计有效投注≥2,000 元即可获得对应彩金，有效投注过期清零；
              <div class="hint">注：奖金不叠加派发，奖金按最高档位派发一次。</div>
            </div>
          </div>
          <div class="item">
            <div class="item-num">2</div>
            活动期间，活动仅计算布加勒斯特 2025已结算的赛事当日总有效投注，次日 24
            小时内在活动页面点击【点击领取】按钮领取。逾期未领取则视为放弃，彩金8 倍流水即可出款；
          </div>
          <div class="item">
...
import { getPGLBucharest2025Bonus, claimPGLBucharest2025Bonus } from "@/api/index/promo";
...
const fetchData = async () => {
  ...
  getPGLBucharest2025Bonus(promoCode.value)
    .then((res) => {
      if (res.code === 0) {
...
const handleClaimBonus = () => {
  loadingClaim.value = true;
  claimPGLBucharest2025Bonus(promoCode.value)
    .then((res) => {
      if (res.code === 0) {
        notify({
          type: "success",
