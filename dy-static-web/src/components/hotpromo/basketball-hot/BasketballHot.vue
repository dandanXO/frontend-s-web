  ...
  <div class="lpl-body">
    <div class="lpl-container">
      ...
      <div :class="`lpl-section-content`">
        ...
        <div class="lpl-ruler">
          <p>
            1. 本活动计算雷火电竞、IM体育与熊猫体育的NBA&CBA当日全部赛事有效投注，每日达到对应有效投注即可领取对应流水彩金。
          </p>
          <p>
          ...
          <p>
            4. 任何低于欧洲盘1.7或亚洲盘0.7水位的投注及在同一局游戏中同时投注对等盘口、当日注单取消或本金退还，将不计算为有效投注额内。
          </p>
          <p>
            5. 每位有效玩家、手机号码、电子邮箱、银行卡、IP地址、每台设备只能使用一个账号享受优惠，如发现有违规者我们将保留在任何时候都可以停止、取消全部优惠的权利。
          </p>
