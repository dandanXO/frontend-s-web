        ...
        <div class="middle-row">
          <div class="item-container">
            ...
            <div v-for="(item, i) in items" :key="i" class="item" :class="{ active: activeItem === item.no }" @click="setActiveItem(item.no)">
                <img :src="require(`../../../assets/images/promotion/hotpromo/cs2/goldbox${item.no}.png`)" />
                <div class="requiredKey">钥匙*{{ item.amt }}</div>
            </div>
          </div>
...
import { getKeyCount, getCheckInRecord, openTreasure, getKeyRecord, getOpenRecord, claimCheckInTreasure } from "@/api/index/promo";
