    ...
    <div class="column">
      ...
      <div class="terms">
        <ol>
          ...
          <li v-if="activeTab === 2">淘汰赛奖金池结算：（300,000➗晋级队伍总票数）*用户投票数量=单票彩金。彩金于赛事阶段结束后次日24小时内派发，彩金3倍流水即可提款；
            <span class="eg">例：用户投注BLG队伍100票，BLG队伍在淘汰赛阶段晋级决赛并且两支晋级队伍总共获得300,000票数，那么用户可获得（300,000➗300000）*100=100元彩金；</span></li>
...
// Tabs data
const tabs = [
  { label: "冠亚赛", period: 3, date: '决赛赛阶段活动投票时间：10月29日00:00至11月2日22:00截止', tabtitle: 'BO5冠亚赛参与队伍：2支队伍中选1支队伍得冠', tabdetail: '活动期间，统计决赛冠军队伍票数瓜分奖金池，根据对应档位条件获取票数后投给任意队伍，若投票的队伍获得冠军后即可瓜分奖金池彩金；' },
  ...
  { label: "淘汰赛", period: 2, date: '淘汰赛阶段活动投票时间：10.17~10.27日21:00 截止', tabtitle: 'BO5淘汰赛参与队伍：8支队伍中选2支队伍进入冠亚决赛', tabdetail: '活动期间，统计两支晋级决赛队伍票数瓜分奖金池，根据对应档位条件获取票数后投给任意队伍，若投票的队伍晋级后即可瓜分奖金池彩金' }
];
