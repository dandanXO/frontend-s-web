    ...
    <div class="livepoker-rebate-container">
      <div class="livepoker-rebate-section">
        <div class="livepoker-rebate-section-left">
          ...
          <div class="reward-info">
            <div class="reward-info-icon">
              <img src="../../../assets/promo/dy2-blast-premier/reward-icon3.png" alt="" width="100%" />
            </div>
            <div class="reward-info-content">
              昨日累计有效投注：
        ...
        <div class="livepoker-rebate-game-bottom">
          <div class="livepoker-rebate-game-bottom-left-title">
            <div class="livepoker-rebate-game-bottom-left-btn">
              <img src="../../../assets/promo/dy2-blast-premier/game-bottom-left-btn.png" alt="" style="width: 10px" />
              <span>示例</span>
            </div>
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              <div>
                活动期间，会员当日投注梦幻联赛S24有效投注≥1,000元且存款≥200元可获得对应投注奖金，满足条件的会员可进入优惠界面点击【领取】按钮获得投注奖金，奖金8倍流水即可提款；
              </div>
          ...
          <div class="item">
            ...
            梦幻联赛S24投注奖金在结算后24小时内有效，每天只能领取一次，超出活动时间未领取不予补偿；
          </div>
          <div class="item">
...
<script setup>
import { getCompetitionBetDepositInit, claimCompetitionBetDepositBonus } from "@/api/index/promo";
...
const handleClaimBonus = () => {
  ...
  claimCompetitionBetDepositBonus(promoCode.value)
    .then((res) => {
      if (res.code === 0) {
        notify({
          type: "success",
...
const fetchData = async () => {
  try {
    const res = await getCompetitionBetDepositInit(promoCode.value);
