    ...
    <div class="livepoker-rebate-container">
      <div class="livepoker-rebate-section">
        <div class="welcomne">
          ...
          <div v-else>
            欢迎您，{{ store.nickName }}
            <span style="color: #fffd66; cursor: pointer" @click="handleClickLogout">退出</span>
          </div>
        </div>
        ...
        <div class="tab-wrapper">
          <div class="tab" :class="{ active: tabValue === 1 }" @click="handleClickTab(1)">投注箱</div>
          <div class="tab" :class="{ active: tabValue === 2 }" @click="handleClickTab(2)">存钱箱</div>
        </div>
      </div>
        ...
        <div>
          <div class="livepoker-rebate-game-info">
            ...
            <div class="livepoker-rebate-game-bottom">
              消耗有效投注 1,500 元可开启，每日最多开启 10 次，每十次必中最高奖励
            </div>
          </div>
      ...
      <template v-else-if="tabValue === 2">
        <div>
          <div class="livepoker-rebate-game-info">
            ...
            <div class="livepoker-rebate-game-bottom" style="justify-content: start">注：每个奖品仅可兑换 1 次</div>
          </div>
          ...
          <div class="livepoker-rebate-game-bottom-rule">
            ...
            <div class="content">
              <div class="item">
                1.活动期间，当日累计存款≥1000 即可计算连续天数，连续存款达档位标准即可获得开启宝箱次数，充值宝箱次数将自动派发至投注宝箱页，点击开启即可参与抽奖；
              </div>
              <div class="item">
...
.livepoker-rebate-game-info {
  background: url("../../../assets/promo/lh-dota2-pgl/reward-section-bg-lt.png") left top no-repeat,
    url("../../../assets/promo/lh-dota2-pgl/reward-section-bg-rt.png") right top no-repeat,
    url("../../../assets/promo/lh-dota2-pgl/reward-section-bg-lb.png") left bottom no-repeat,
    url("../../../assets/promo/lh-dota2-pgl/reward-section-bg-rb.png") right bottom no-repeat,
    url("../../../assets/promo/lh-dota2-pgl/reward-section-bg-l.png") left no-repeat,
    url("../../../assets/promo/lh-dota2-pgl/reward-section-bg-r.png") right center no-repeat,
    url("../../../assets/promo/lh-dota2-pgl/reward-section-bg-t.png") top no-repeat,
    url("../../../assets/promo/lh-dota2-pgl/reward-section-bg-b.png") bottom no-repeat, #1C0D18;
  border-radius: 12px;
  padding: 40px;
  ...
  .reward-btn {
    background: url("../../../assets/promo/lh-dota2-pgl/reward-btn2.png") no-repeat;
    font-size: 28px;
    color: #ffd164;
    width: 367px;
    height: 100px;
  ...
  .reward-box-wrapper {
    ...
    .reward-box-btn {
      ...
      color: white;
      font-size: 20px;
      background: linear-gradient(180deg, rgba(255, 225, 115, 0.5) 0%, rgba(255, 173, 57, 0.5) 100%);
      cursor: pointer;
      font-weight: bold;
