    ...
    <div class="livepoker-rebate-container">
      ...
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="little-title">
          ...
          <div class="right">2025 年 02 月 03 日至 2025 年 02 月 09 日</div>
        </div>
        <div class="little-title">
          <div class="ribbon">活动对象</div>
          <div class="right">投注 BLAST Slam II 的会员</div>
        </div>
        <div class="little-title">
        ...
        <div class="little-title" style="flex-direction: column; justify-content: flex-start; align-items: flex-start">
          ...
          <div class="right">
            会员在本站电竞场馆中，投注 BLAST Slam
            II 赛事在 2 月 3 日 -2 月 9 日的周总负盈利达到 1,000 元及以上，2 月 10 日即可领取救援金，最高可达 1,288 元！
          </div>
        </div>
        ...
        <div class="livepoker-rebate-game-bottom">
          <div class="livepoker-rebate-game-bottom-left-title">
            ...
            会员 A 在电竞场馆投注 BLAST Slam II 赛事，比赛期间产生总负盈利为 6,000 元，2 月 10 日即可获得救援金 38 元。
          </div>
        </div>
      </div>
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              <div>
                活动期间，活动仅计算电竞场馆中 BLAST Slam II 赛事，会员在 BLAST Slam II 赛事中累计负盈利≥1,000
                元即可获得对应彩金；
              </div>
          ...
          <div class="item">
            ...
            活动期间，活动仅计算 BLAST Slam II 赛事已结算的赛事总负盈利，2 月 10 日
            24 小时内在活动页面点击【点击领取】按钮领取。逾期未领取则视为放弃，彩金 5 倍流水即可出款；
          </div>
          <div class="item">
...
import { getCompetitionLossWeeklyInit, claimCompetitionLossWeekly } from "@/api/index/promo";
...
const handleClaimBonus = () => {
  ...
  claimCompetitionLossWeekly(promoCode.value)
    .then((res) => {
      if (res.code === 0) {
        notify({
          type: "success",
...
const fetchData = async () => {
  ...
  try {
    const res = await getCompetitionLossWeeklyInit(props.promoCode);
