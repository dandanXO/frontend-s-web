    ...
    <div class="tnc-content">
      <ol>
        <li>
          ...
          特殊事件竞猜：比赛开始前完成特殊事件竞猜，并在指定赛事中累计投注≥1000元，若竞猜正确，即可获得竞猜彩金。 竞猜机会仅限当天使用有效，隔日无效。
        </li>
        <li>
          竞猜活动仅计算世俱杯赛事。任何低于欧洲盘 1.7 或亚洲盘 0.7 水位的投注及在同一局游戏中同时投注对等盘口、当日注单取消或本金退还，将不计算为有效投注额内；
        </li>
        <li>
          独赢竞猜结果分为：输、和、赢，竞猜结算（赢）猜中 即可获得8元奖金，若竞猜结果结算为“和”将会视为无效竞猜。
        </li>
        <li>竞猜正确的用户在次日24小时内在优惠活动界面点击【立即领取】即可领取昨日竞猜成功的竞猜金，逾期未领取则视为放弃，竞猜金仅需5倍流水出款。</li>
