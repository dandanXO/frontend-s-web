    ...
    <div class="prize-quiz-content-container">
      <div class="prize-quiz-jc-container">
        <div class="prize-quiz-jc-pool">
          <img src="../../../assets/images/promotion/hotpromo/esportquiz2/pool.png" style="width: 100%" />
        </div>
        <div class="prize-quiz-jc-txt" id="pool">$ {{ matchInfo.poolAmount }}</div>
      </div>
      <img
        v-if="uiIsShowStatus.questionBox"
        src="../../../assets/images/promotion/hotpromo/esportquiz2/separator-start-ans.png"
        style="display: flex; align-self: center; width: 60%; margin: 0 auto"
      />
      <img
        v-else
        src="../../../assets/images/promotion/hotpromo/esportquiz2/union.png"
      ...
      <div v-else class="prize-quiz-main prize-quiz-record-container" style="margin-top: 80px">
        ...
        <div :class="`start-answer-box`">
          <div class="flex-div">
            ...
            <div class="book-img">
              <img src="../../../assets/images/promotion/hotpromo/esportquiz2/vs.png" alt="" />
              <div class="match-time">
                {{ matchInfo.matchTime }}
              </div>
              <!--              <img-->
              <!--                src="../../../assets/images/promotion/hotpromo/esportquiz2/img_book_7.png"-->
...
.prize-quiz-container {
  ...
  .prize-quiz-content-container {
    ...
    .prize-quiz-jc-container {
      ...
      width: 780px;
      height: 200px;
      // background: url("../../../assets/images/promotion/hotpromo/esportquiz2/bg_jc_8.png") center no-repeat;
    ...
    .title-record {
      background: url("../../../assets/images/promotion/hotpromo/esportquiz2/title_record.png") center no-repeat;
      margin: 0 auto;
    }
  ...
  .questions-container {
    ...
    .questions-item-box {
      ...
      .item-question {
        ...
        align-items: center;
        justify-content: center;
        background-image: url("../../../assets/images/promotion/hotpromo/esportquiz2/quiz-flag.png");
