  ...
  <div class="livepoker-rebate-wrapper">
    <div class="livepoker-rebate-container">
      ...
      <div class="livepoker-rebate-game-info">
        ...
        <span style="color: red;font-size: 16px;">例：会员A的VIP等级为10，当日投注2024 DOTA2 TI13 国际邀请赛 累计有效流水为50,000元，会员可在次日领取288元彩金。</span>
      </div>
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              <div>
                活动期间，会员当日任意存款且在【2024 DOTA2 TI13 国际邀请赛
                】中累计有效流水达到指定金额，次日即可领取彩金；
              </div>
              <div>注：奖金不叠加派发，奖金按最高档位每日派发一次。</div>
            </div>
          </div>
          <div class="item">
            <div class="item-num">2</div>
            符合领取条件的会员，请在次日24小时内在活动页面点击【点击领取】按钮领取彩金。彩金3倍流水即可提款；
          </div>
          <div class="item">
...
<script setup>
import { getDota2CompetitionBet, claimBonusItem } from "@/api/index/promo";
  ...
  claimBonusItem(props.promoCode)
    .then((res) => {
      if (res.code === 0) {
        ...
        ElMessage.success(`成功领取 ${winAmount} 元`);
        fetchData();
      } else {
...
const fetchData = async () => {
  ...
  try {
    const res = await getDota2CompetitionBet(props.promoCode);
    console.log(res);
