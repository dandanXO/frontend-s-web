<template>
    <div class="bbdacha-belgrade-wrapper">
      <div class="bbdacha-belgrade-container">
        <div class="bbdacha-belgrade-section">
          <div class="bbdacha-belgrade-section-left">
            <div class="bbdacha-belgrade-section-title">
            ...
            <div class="reward-info">
              ...
              <div class="reward-info-content">
                单日最高单笔派彩金额：
                <span class="amount">{{ formatNumber(singleHighestPayout) }}元</span>
              </div>
            </div>
            <div class="reward-info">
              <div class="reward-info-icon">
                <img class="icon-img" src="@/assets/promo/lh-livepoker-rebate/reward-icon2.png" alt="" width="100%" />
              </div>
              <div class="reward-info-content">
                可领取彩金：
          ...
          <div class="bbdacha-belgrade-section-right">
  ...
  <script setup>
  import { getBelgradeInit, claimBelgradeBonus } from "@/api/index/promo";
  ...
  const handleClaimBonus = () => {
    ...
    claimBelgradeBonus(promoCode.value)
      .then((res) => {
        if (res.code === 0) {
  ...
  const fetchData = async () => {
    try {
      const res = await getBelgradeInit(promoCode.value);
  ...
  .bbdacha-belgrade-wrapper {
    display: flex;
    justify-content: center;
    font-family: 'PingFang SC';
  }
  .bbdacha-belgrade-container {
    width: 100%;
    height: 100%;
  }
  
  .bbdacha-belgrade-section {
    ...
    .bbdacha-belgrade-section-left {
      display: flex;
      flex-direction: column;
      justify-content: space-between;
    }
  
    .bbdacha-belgrade-section-right {
      margin-top: auto;
      margin-bottom: auto;
      width: 254px;
    ...
    .bbdacha-belgrade-section-title {
      color: #000000;
      font-size: 24px;
      line-height: 1;
      font-weight: 600;
  ...
  .bbdacha-belgrade-game-bottom {
    display: flex;
    justify-content: space-between;
    align-items: center;
    .bbdacha-belgrade-game-bottom-left-title {
      font-size: 16px;
      font-weight: 500;
      line-height: 22.4px;
      color: #ff0000;
    }
    .bbdacha-belgrade-game-bottom-left-btn {
      font-size: 16px;
      font-weight: 600;
      line-height: 22.4px;
      color: #ff0000;
