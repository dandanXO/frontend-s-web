    ...
    <div class="livepoker-rebate-container">
      ...
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <table class="livepoker-rebate-game-info-table section-table">
          ...
          <tbody>
            <tr>
              <td>2025.6.29 00:00</td>
              <td>世俱杯1/8决赛 帕尔梅拉斯 - 博塔弗戈</td>
            </tr>
            <tr>
              <td>2025.6.30 00:00</td>
              <td>世俱杯1/8决赛 巴黎圣日耳曼 - 迈阿密国际</td>
            </tr>
            <tr>
              <td>2025.7.1 03:00</td>
              <td>世俱杯1/8决赛 国际米兰 - 弗鲁米嫩塞</td>
            </tr>
            <tr>
              <td>2025.7.2 03:00</td>
              <td>世俱杯1/8决赛 皇家马德里 - 尤文图斯</td>
            </tr>
          </tbody>
        </table>
        <div class="livepoker-rebate-game-bottom">
          <div class="livepoker-rebate-game-bottom-left-title">
            ...
            在世俱杯赛事期间，会员在指定赛事开始登录东赢账号，即可领取到最高8,888元的开赛红包。
          </div>
        </div>
      </div>
      ...
      <div class="livepoker-rebate-game-bottom-rule section-bg">
        ...
        <div class="content">
          ...
          <div class="item">
            ...
            指定赛事开始前登录东赢账号即可参与红包雨活动，彩金实时到账，彩金 1倍流水即可出款；
          </div>
          <div class="item">
