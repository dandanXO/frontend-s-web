  ...
  <div>
    ...
    <div class="invitePromo">
      ...
      <div>
        ...
        <p style="margin-bottom: 30px">
          Play4Win Member Open : Personal - Click "Invite Friends" To copy the
          promotional link, share via Facebook, LINE, Instagram, what's app,
          telegram and YouTube, etc. When successfully inviting friends, get
        ...
        <div class="table-inv">
          <table style="width: 600px">
            ...
            <tr>
              <th>Level</th>
              <th>Invite new friends to top up for the first time.</th>
        ...
        <p style="text-align: left; color: #00ff16; margin-top: 10px">
          For example: Member A invites friends to deposit 500 peso for the
          first time. Then he will receive a bonus of 48 peso if he wants to get
          the next level to 68 peso. He needs to deposit another 1000 peso. The
          bonus will be paid automatically to your wallet. if next week The
          friend you invited still has a full deposit balance. You will receive
