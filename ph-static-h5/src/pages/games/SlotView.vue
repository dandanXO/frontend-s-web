...
<script lang="js">
import {defineComponent, onMounted, reactive, ref, watch, computed, toRefs} from "vue";
    ...
    const loadGameList = () => {
      ...
      cached.get(key, () => api.get("/platformGames", {
        ...
        res.forEach(element => {
          ...
          element.icon = `${process.env.IMAGE_CDN}/games/slot/${selectedPlat.value.code}/${element.icon}.png`;
        });
