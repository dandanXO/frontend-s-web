              ...
              <q-list class="q-col-gutter-none">
                ...
                >
                  ...
                  <template v-slot:loading>
                    <img :src="game.default" style="width: 100%; height: 120px; border-radius: 4px; overflow: hidden" />
                  </template>
    ...
    const loadGameList = () => {
      ...
      cached.get(key, () => api.get(platformGamesApiUrl, {
        ...
        res.forEach(element => {
          ...
          element.icon = `${process.env.IMAGE_CDN}/game/1/${selectedPlat.value.code.toLowerCase()}/${element.icon}.png`;
