              ...
              >
                <router-link @mouseover="showSubMenu(nav)" @mouseup="selectedMenu = ''" :to="nav.path">
                  <span style="width: 32px; height: 25px">
                    ...
                    <img
                      class="hover-icon"
                      :src="require(`../../../assets/images/home/header-deposit-icon${isDark ? '-dark' : ''}.svg`)"
                      v-if="nav.code === 'deposit'"
                    />
                    <img
                      class="hover-icon"
                      :src="require(`../../../assets/images/home/header-withdraw-icon${isDark ? '-dark' : ''}.svg`)"
                      v-if="nav.code === 'withdraw'"
                    />
                    <img
                      class="hover-icon"
                      :src="require(`../../../assets/images/home/header-transfer-icon${isDark ? '-dark' : ''}.svg`)"
                      v-if="nav.code === 'transfer'"
                    />
                  </span>
                  <span>{{ nav.name }}</span>
                </router-link>
...
export default defineComponent({
  ...
  setup() {
    ...
    const navigations = reactive([
      ...
      { code: "affiliate", name: "加盟", enName: "Agent", path: "/affiliate", hasicon: true, isTest: false },
          ...
          &.second-nav {
            .header-menu-item {
              > a {
                color: #a98f7c;
                .hover-icon {
                  filter: brightness(0) saturate(100%) invert(78%) sepia(31%) saturate(266%) hue-rotate(340deg)
                ...
                &:hover {
                  .hover-icon {
                    filter: brightness(0) saturate(100%) invert(96%) sepia(99%) saturate(1288%) hue-rotate(138deg)
                      brightness(104%) contrast;
                    filter: none;
                  }
                  span {
                    color: #fff;
