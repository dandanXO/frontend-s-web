      ...
      <div class="livepoker-rebate-section section-bg">
        <div class="livepoker-rebate-section-left">
          <div class="livepoker-rebate-section-title">
            <div class="claim-title-icon-v2"></div>
            {{ $t("hotpromo.baccaratBonus.rewardSection.title") }}
          </div>
          <div class="reward-desc">
            <i18n-t keypath="hotpromo.baccaratBonus.rewardSection.desc" tag="span">
              <template #telegram>
                <span class="link" @click="openTelegram">@xy6vip</span>
              </template>
            </i18n-t>
          </div>
        </div>
        <div class="livepoker-rebate-section-right">
          <div class="bonus-image" @click="openTelegram">
            <template v-if="languageVal !== 'en'">
              <img src="@/assets/promo/lh-livepoker-rebate/reward-btn-5.png" alt="" width="100%" />
            </template>
            <template v-else>
              <img src="@/assets/promo/lh-livepoker-rebate/reward-btn-5-en.png" alt="" width="100%" />
            </template>
          </div>
        </div>
      </div>
...
const openTelegram = () => {
  window.open(ui.telegramUrl, "_blank");
};
</script>
