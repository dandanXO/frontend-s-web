...
.contact-container {
  ...
  .contact-card {
    ...
    .contact-card-right {
      ...
      justify-content: space-between;
      .contact-tag {
        background: linear-gradient(180deg, #edf5fd 0%, #c5e3ff 100%);
        color: #227dce;
        font-size: 13px;
        border-radius: 20px;
        padding: 2px;
...
.section-container {
  ...
  .section-table {
    ...
    margin-bottom: 20px;
    thead {
      background: linear-gradient(180deg, #4b91f5 0%, #c4ddff 100%),
        radial-gradient(103.75% 103.75% at 50% -3.75%, #94c3ff 0%, #4b91f5 100%);
      color: #fff;
