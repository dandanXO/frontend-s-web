<template>
            ...
            <el-form-item tabindex="2" label="验证码" prop="code">
              <el-row :gutter="10" style="justify-content: center; align-items: center">
                ...
                <el-col :span="14">
                  ...
                  <el-button v-else disabled size="small" class="standard-button">已发送（倒数{{ loginCountdown }}秒）</el-button>
                </el-col>
              </el-row>
            </el-form-item>
          </div>
    ...
    >
      ...
      >
        ...
        <el-button size="large" class="standard-button primary-btn" @click="sendOtp">发送</el-button>
      </el-form>
    </el-dialog>
  </template>
