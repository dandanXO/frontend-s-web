  ...
  <div>
    <div class="receive-container">
      ...
      <div @click="getPromotion" v-if="!promoNotReady && !bonusOpened" class="receive-btn">
        <img src="../../../assets/images/promo/hotpromo/hongbaoyu/package_light.png" />
      </div>
...
.receive-container {
  ...
  width: 100%;
  height: 140px;
  background: url(../../../assets/images/promo/hotpromo/hongbaoyu/hongbaoyu.png) no-repeat center center;
  background-size: contain;
  .red-packet {
    width: 50%;
    height: 140px;
    margin: 0 auto 20px;
    background: url(../../../assets/images/promo/hotpromo/hongbaoyu/package_red.png) no-repeat center center;
    background-size: contain;
    &.open {
      background-image: url(../../../assets/images/promo/hotpromo/hongbaoyu/img_repacket_open.png);
    }
  }
