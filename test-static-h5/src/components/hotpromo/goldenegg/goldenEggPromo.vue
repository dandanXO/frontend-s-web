  ...
  <div>
    <div class="goldenegg-container">
      <div class="goldeneggs">
        <img @click="hitEgg" v-for="v in 4" :key="v" src="../../../assets/images/promo/hotpromo/goldenegg/web.png" />
      </div>
...
.goldenegg-container {
  ...
  .goldeneggs {
    ...
    height: 7.5rem;
    min-height: 120px;
    background: url(../../../assets/images/promo/hotpromo/goldenegg/bg.png) no-repeat bottom;
...
body .wonBox {
  width: 500px;
  height: 26.5rem;
  background: url(../../../assets/images/promo/hotpromo/goldenegg/winbox.png) no-repeat center center;
