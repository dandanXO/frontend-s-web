<template>
  <div>
    <div v-if="store.hasToken()" class="table-details">
      <div class="searchbar">
        <q-form layout="inline" :model="searchForm">
          ...
          <q-btn class="q-mt-md" label="搜索" color="brand" @click="searchRecord" :loading="btnLoading" />
        </q-form>
      </div>
      <q-table
        :loading="btnLoading"
    ...
    <div class="invitePromo">
      <p class="menu-title" style="font-weight: bold">邀请好友，领取奖励</p>
      <div>
        <p class="menu-title sub inv-title">活动时间</p>
        <p style="margin-bottom: 30px">开始时间 20/11/2022 时间 00:00:00 (GMT+8)</p>
        ...
        <p style="text-align: left; color: #00ff16; margin-top: 10px">
          ...
          人民币，他需要再存款 1,000
          人民币。奖金将自动支付到您的钱包中。如果在下周，您邀请的朋友的存款总额达到了指定额度，您将在下下周再次获得奖金。
        </p>
      </div>
    </div>
  </div>
...
.invitePromo {
  text-align: center;
  //background: url(../../../assets/images/promo/hotpromo/35/orangeborder.png) no-repeat center center;
  ...
  .inv-title {
    ...
    &:before {
      ...
      // padding: 5px 30px;
      padding: 0.4em 0.8em;
      //background: url(../../../assets/images/promo/hotpromo/35/left.png) no-repeat center center;
    ...
    &:after {
      ...
      // padding: 5px 30px;
      padding: 0.4em 0.8em;
      //background: url(../../../assets/images/promo/hotpromo/35/right.png) no-repeat center center;
      background-size: contain;
      display: inline-block;
      vertical-align: middle;
      margin-left: 10px;
