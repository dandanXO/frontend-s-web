<template>
    <div class="app-tutorial-container">
        ...
        <div class="bottom" data-aos="fade-up">
            ...
            <img data-aos="fade-in" v-if="activeTab === 0" class="ios-tutorial-img" src="../assets/images/app-tutorial/ios-tutorial.png" />
            <img data-aos="fade-in" v-else-if="activeTab === 1" class="android-tutorial-img" src="../assets/images/app-tutorial/android-tutorial.png" />
        </div>
    </div>
</template>
