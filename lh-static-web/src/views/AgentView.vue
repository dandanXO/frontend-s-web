          ...
          <div>
            <div class="contact-left">
              <div class="contact-box mail-buttons">
                ...
                <div class="contact-name">合营QQ</div>
              ...
              <div class="contact-box skype-buttons">
                ...
                <div class="contact-name">合营部Skype</div>
          ...
          <div style="display: flex; flex-direction: column; align-items: start; gap: 20px">
            ...
            <div class="affiliate-sub" style="height: 500px; justify-content: end">
              ...
              <div class="affiliate-inner" style="height: 80%">
                <ul>
                  <li>1.佣金派发时间：每月1号至10号期间，所有佣金由系统直接发放到代理账户，无需流水，即可提款。</li>
                  <li>2.每月至少有五个有效活跃会员才能结算佣金，当月存款≥500，流水≥1000为一个活跃玩家。</li>
                  <li>
                    3.代理推广每月至少需要新注册活跃会员达到3名或以上，如无法达到将视为零推广，代理部有权减少或扣除部分佣金，如果三个月累积新增活跃会员未达到十位，将会停用代理账户，需代理联系平台客服重新开启。
                  </li>
                </ul>
              </div>
            </div>
