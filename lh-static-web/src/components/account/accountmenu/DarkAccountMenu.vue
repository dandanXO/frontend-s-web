      ...
      <div class="account-info-bg">
        ...
        <div class="profile-actions">
          <router-link to="/center/deposit" class="action-btn">
            ...
            <img src="../../../assets/images/home/header-deposit-icon-dark.svg" />
            <!-- </div> -->
            存款
          </router-link>
          <router-link to="/center/withdraw" class="action-btn">
            <!-- <div class="icon-rounded"> -->
            <img src="../../../assets/images/home/header-withdraw-icon-dark.svg" />
            <!-- </div> -->
            取款
          </router-link>
          <router-link to="/center/transfer" class="action-btn">
            <!-- <div class="icon-rounded"> -->
            <img src="../../../assets/images/home/header-transfer-icon-dark.svg" />
            <!-- </div> -->
            转账
          </router-link>
        </div>
