<template>
  <el-form ref="registerRef" :rules="regRules" :model="regForm" label-width="80" size="large" class="register-form">
    ...
    <div class="light-bg form-field" v-if="!hasReferSummon">
      <img style="width: 25px" class="form-field-icon" src="@/assets/home/auth/referral-icon-dark.png" />
    ...
    <div>
      <el-button class="standard-button primary-btn" size="large" @click="submitRegisterForm(registerRef)">
        注册
      </el-button>
    </div>
