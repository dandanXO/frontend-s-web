<template>
  <div class="hotgame-section">
    <div class="hotgame-tabs-wrapper">
        ...
        <img class="title-img" style="display:flex;margin:auto;width:65%;" src="../../../assets//home/hotgame/hotgame-title-dark.png" />
  ...
  .hotgame-section {
    ...
    .hotgame-tabs-wrapper {
      ...
      .hotgame-tabs {
        ...
        :deep(.el-tabs__item.is-active), :deep(.el-tabs__active-bar) {
