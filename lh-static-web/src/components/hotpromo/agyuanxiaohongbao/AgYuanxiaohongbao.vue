    ...
    <div class="livepoker-rebate-container">
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="step-wrapper">
          <div class="step-header">如何参与</div>
          <div class="step-content">
            <div class="step-item">
              <div style="margin-top: 24px;">
                <img src="./images/stepN1.png" alt="" />
              </div>
              <div style="width: 90%; height: 1px; background-color: rgba(172, 212, 246, 1);"></div>
              <div style="margin-top: 24px;">
                <img src="./images/stepO1.png" alt="" />
              </div>
              <div>
                <p style="text-align: center; margin-top: 12px">活动期间内登录游戏，进入任意百家乐桌台</p>
              </div>
            </div>
            <div class="step-item">

              <div style="margin-top: 24px;">
                <img src="./images/stepN2.png" alt="" />
              </div>
              <div style="width: 90%; height: 1px; background-color: rgba(172, 212, 246, 1);"></div>
              <div style="margin-top: 24px;">
                <img src="./images/stepO2.png" alt="" />
              </div>
              <div>
                <p style="text-align: center; margin-top: 12px">点击红包图标，点击“抢红包”。 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
              </div>
            </div>
            <div class="step-item">
              <div style="margin-top: 24px;">
                <img src="./images/stepN3.png" alt="" />
              </div>
              <div style="width: 90%; height: 1px; background-color: rgba(172, 212, 246, 1);"></div>
              <div style="margin-top: 24px;">
                <img src="./images/stepO3.png" alt="" />
              </div>
              <div>
                <p style="text-align: center; margin-top: 12px">在指定时间内累计有效投注金额，挑战更高红包等级与奖金。</p>
              </div>
            </div>
            <div class="step-item">
              <div style="margin-top: 24px;">
                <img src="./images/stepN4.png" alt="" />
              </div>
              <div style="width: 90%; height: 1px; background-color: rgba(172, 212, 246, 1);"></div>
              <div style="margin-top: 24px;">
                <img src="./images/stepO4.png" alt="" />
              </div>
              <div>
                <p style="text-align: center; margin-top: 12px">活动结束后，系统自动结算并发放红包奖励。</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="section-bg">
            <div class="highlight-content">
              ...
              <div style="display: flex; flex-direction: column; align-items: center">
                ...
                <p>随着投注金额的提升，红包等级自动升级，挑战更高奖金！</p>
              </div>
            </div>
          </div>
          <div class="section-bg">
            <div class="highlight-content">
              <img src="./images/highlight3.png" style="height: 353px;" alt="" />
              <div style="display: flex; flex-direction: column; align-items: center">
                <h3 class="title">每日两场限时抢</h3>
                <p>20 分钟的刺激竞速，快人一步抢先拿红包</p>
              </div>
            </div>
          </div>
          <div class="section-bg">
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column; color: #fff;">
              红包等级与条件
              <div class="hint">
                在活动期间，玩家需累计有效投注金额（人民币）以获得对应红包等级：
                <br />
                1.金红包：投注累计达 18,000 元或以上。
                <br />
                2.银红包：投注累计达 1,200 元至 17,999 元。
                <br />
                3.普通红包：领取红包任务。
              </div>
            </div>
          ...
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column;color: #fff;">
              活动红包数量
              <div class="hint">活动期间共派 150,000 份红包，领完即止。</div>
            </div>
          </div>
          <div class="item">
        ...
        <div class="content">
          <div class="item">
            <div style="display: flex; flex-direction: column">
              1. 本次活动仅支持百家乐游戏桌，包括竞咪百家乐及多台百家乐。
            </div>
          </div>
          <div class="item">
            <div style="display: flex; flex-direction: column">2. 每位玩家每天每场仅可领取一个红包。</div>
          </div>
          <div class="item">
            <div style="display: flex; flex-direction: column">3. 所有奖金将于场次结束后自动发放至玩家账户。</div>
          </div>
          <div class="item">
            <div style="display: flex; flex-direction: column">4. 玩家参加本次 AG 活动，即视为同意本活动条款。</div>
          </div>
          <div class="item">
            <div style="display: flex; flex-direction: column">5. 实际奖金将根据当时汇率计算。</div>
          </div>
          <div class="item">
            <div style="display: flex; flex-direction: column">
              6. 严重作弊者 AG 有权在不事先通知的情况下封号或扣除相关获利。
            </div>
          </div>
          <div class="item">
            <div style="display: flex; flex-direction: column">
              7. 任何会员以非法手段，包括使用多个账户参加本活动套利，AG 有权在不事先通知的情况下封号或扣除相关获利。
            </div>
          </div>
          <div class="item">
            <div style="display: flex; flex-direction: column">8. 本平台保有执行、修正、解释与终止等权力。</div>
          </div>
        </div>
      </div>
      ...
      <div class="livepoker-rebate-game-bottom-rule section-bg">
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column;color: #fff;">
              我怎么知道红包的发放情况？
              <div class="hint">1.活动结束后，玩家可以在游戏界面查看红包领取记录，包括红包金额及累计奖金。</div>
            </div>
          </div>
          <div class="item">
            <div class="item-num">2</div>
            <div style="display: flex; flex-direction: column;color: #fff;">
              如果活动中途断线，是否仍然有效？
              <div class="hint">a.系统会计算活动期间内有效投注金额，并按最终累计金额分配对应红包等级。</div>
            </div>
          </div>
          <div class="item">
            <div class="item-num">3</div>
            <div style="display: flex; flex-direction: column;color: #fff;">
              为什么我会获得积分红包？
              <div class="hint">1.玩家有极小概率获得积分红包，用于兑换积分福利。</div>
            </div>
          </div>
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column;color: #fff;">
              是否可以参加多个场次？
              <div class="hint">1.是的，每天两场活动，玩家可以参加所有场次，抢取更多红包！</div>
            </div>
          </div>
          <div class="item">
            <div class="item-num">5</div>
            <div style="display: flex; flex-direction: column;color: #fff;">
              我正在进行投注时活动刚好开始或结束，投注额会被计算吗？
              <div class="hint">1.只有百家乐桌台每局投注结束时间在活动时间内才会被计算！。</div>
            </div>
          </div>
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column;color: #fff;">
              活动有设置人数上限吗？
              <div class="hint">1.每场红包数量有限，达到上限后，其他玩家将无法再领取</div>
            </div>
          </div>
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column;color: #fff;">
              我什么时候会收到奖金？
              <div class="hint">1.每场活动结束后，系统会进行计算，然后自动派发奖金给玩家！</div>
            </div>
          </div>
        </div>
      </div>
...
.livepoker-rebate-wrapper {
  ...
  .section-bg {
    position: relative;
    border: 0px solid #be9457 !important;
    color: #fff;
  ...
  //   left: 0;
  //   opacity: 0.8;
  //   background: url("./images/section-bg.png") no-repeat center center !important;
  // }
}
</style>
