    ...
    <div class="livepoker-rebate-container">
      ...
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="little-title">
          ...
          <div class="right">2025 年 4 月 24 日至 2025 年 4 月 27 日</div>
        </div>
        <div class="little-title">
          <div class="ribbon">活动对象</div>
          <div class="right">投注 CCT 全球总决赛 2025 的会员   </div>
        </div>
        <div class="little-title">
        ...
        <div class="little-title">
          ...
          <div class="right">活动期间，当日 CCT 全球总决赛 2025 有效投注≥1,500 元即可获得 最高 1888 元的奖励金  </div>
        </div>
        ...
        <div class="livepoker-rebate-game-bottom">
          <div class="livepoker-rebate-game-bottom-left-title">
            ...
            用户 A 在 4 月 24 日投注 CCT 全球总决赛 2025 有效投注 50,000 元，在次日 24 小时内可获得彩金 288 元 
          </div>
        </div>
      </div>
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              活动期间，活动仅计算电竞场馆中 CCT 全球总决赛 2025 赛事，会员在当日 CCT 全球总决赛 2025 中累计有效投注≥1,500 元即可获得对应彩金，有效投注次日清零； 
              <div class="hint">注：奖金不叠加派发，奖金按最高档位派发一次。</div>
            </div>
          </div>
          <div class="item">
            <div class="item-num">2</div>
            活动期间，活动仅计算当日 CCT 全球总决赛 2025 已结算的赛事总有效投注，次日 24 小时内在活动页面点击【点击领取】按钮领取。逾期未领取则视为放弃，彩金 6 倍流水即可出款； 
          </div>
          <div class="item">
