<template>
  <div class="match-vote-wrapper">
    ...
    <div class="tips-txt-bottom">注：用户A当日投注世预赛总有效投注30,000元且免费竞猜正确次数8次，用户可获得30,000*3.0%=900元，用户A彩金金额超出彩金上限，用户A最终可获得888元。
    </div>
  </div>
      ...
      <div class="tab-panel" v-if="activeKey === 'tabOne'">
        ...
        <div class="rules-container">
          <ol class="rules-content">
            ...
            <li>本活动仅计算FB体育、IM体育、熊猫体育场馆世预赛总有效投注。沙巴体育与平博体育不在统计范围内；</li>
            <li>
              本活动有效投注额仅对已结算并产生输赢结果的投注额进行计算，任何滚球、走水、串关、提前结算的投注、取消的赛事将不 计算在有效投注，任何低于欧洲盘 1.70 或亚洲盘 0.70 水位的投注以及在同一赛事中同时投注对等盘口，将不计算在投注额内；
            </li>
            <li>每位有效玩家、手机号码、电子邮箱、银行卡、IP地址、每台设备只能使用一个账号享受优惠，如发现有违规者我们将在任何时候保留可以全部停止、取消优惠或索回已支付全部优惠的权利；</li>
