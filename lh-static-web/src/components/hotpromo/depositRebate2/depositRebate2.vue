      ...
      <div class="deposit-card" v-for="(card, i) in depositCards" :key="i">
        ...
        <div class="deposit-buttons">
          <div class="btn deposit-buttons__go-deposit">
            <router-link to="/center/deposit"><img src="./images/depositnow-btn.png" /></router-link>
          </div>
          <div class="btn deposit-buttons__check-lesson" v-if="card.lesson">
            <a :href="card.lesson" target="_blank"><img src="./images/checklesson-btn.png" /></a>
          </div>
        </div>
      </div>
    </div>
...
const depositCards = ref([
  {
    code: "usdt",
    title: "USDT",
    content: `充值即送<em class="light-bg">1.0%</em>彩金 使用USDT充值更安全更便捷，24小时充值不等待。活动期间，每位玩家每笔使用“TRC 20”“ERC20-2”或“ERC20”充值≥100USDT，即可享受存款金额的1.0%加码彩金，单日优惠最高上限 588元。`,
  ...
  //     "code": "jdpay",
  //     "title": "JDpay",
  //     "content": "充值即送1.0%彩金JDpay充值火热上线，速度快，够安全。活动期间，每日用户任何时间在雷火使用“JDpay充值\"方式成功存款，即可获得JDpay存款金额的1.0%的彩金返还，单日优惠最高上限200元。",
  ...
  //   title: "支付宝转卡",
  //   content:
  //     "充值即送<em>0.5%</em>彩金活动期间，每日用户任何时间在雷火使用“支付宝转卡”方式成功存款，即可获得支付宝转卡存款金额的<em>0.5%</em>的彩金返还，单日优惠最高上限50元。"
  // }
]);
</script>
<style lang="scss">
