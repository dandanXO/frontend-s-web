    ...
    <div class="livepoker-rebate-wrapper">
      <div class="livepoker-rebate-container">
        <div class="tab-wrapper">
          <div class="tab" :class="{ active: tabValue === 1 }" @click="tabValue = 1">投注好礼</div>
          <div class="tab" :class="{ active: tabValue === 2 }" @click="tabValue = 2">救援好礼</div>
        </div>
          ...
          <div>
            ...
            <div class="livepoker-rebate-game-info">
              ...
              <div class="little-title">
                ...
                <div class="right">2025 年 1 月 15 日起</div>
              </div>
              <div class="little-title">
                <div class="left">活动内容</div>
                <div class="right">活动期间，当日 LPL&LCK 春季赛 2025 有效投注≥3,000 元即可获得 最高 1288 元的奖励金</div>
              </div>
              ...
              <div class="livepoker-rebate-game-bottom">
                <div class="livepoker-rebate-game-bottom-left-title">
                  ...
                  用户 A 在 1 月 17 日投注 LPL&LCK 春季赛 2025 累计有效投注 50,000 元，用户 A 在次日 24 小时内可获得彩金：288 元
                </div>
              </div>
            </div>
              ...
              <div class="content">
                <div class="item">
                  ...
                  <div style="display: flex; flex-direction: column">
                    <div>活动期间，活动仅计算电竞场馆中 LPL&LCK 春季赛 2025，会员在当日 LPL&LCK 春季赛 2025 中累计有效投注≥3,000 元即可获得对应彩金，有效投注次日清零</div>
                    <div class="hint"> 注：奖金不叠加派发，奖金按最高档位每日派发一次。</div>
                  </div>
                </div>
                <div class="item">
                  <div class="item-num">2</div>
                  活动期间，活动仅计算当日 LPL&LCK 春季赛 2025 已结算的赛事总有效投注，次日 24 小时内在活动页面点击【点击领取】按钮领取。逾期未领取则视为放弃，彩金 8 倍流水即可出款；
                </div>
                <div class="item">
        ...
        <template v-if="tabValue === 2">
          <div>
            ...
            <div class="livepoker-rebate-game-info">
              ...
              <div class="little-title">
                <div class="left">活动时间</div>
                <div class="right">2025 年 1 月 16 日起   </div>
              </div>
              <div class="little-title">
                <div class="left">活动内容</div>
                <div class="right">
                  会员在电竞场馆中投注 LPL&LCK 春季赛 2025，北京时间当日负盈利达到 1500 元及以上，次日即可领取救援金，最高可达 1,188 元！
                </div>
              </div>
              <table class="livepoker-rebate-game-info-table">
                <tbody>
                  <tr>
                    <th>LPL&LCK 春季赛 负盈利</th>
                    <th>救援金</th>
                    <th>流水倍数</th>
                  </tr>
                  <tr>
              ...
              <div class="livepoker-rebate-game-bottom">
                <div class="livepoker-rebate-game-bottom-left-title">
                  ...
                  会员 A 在电竞场馆投注 LPL&LCK 春季赛 2025，当日产生负盈利为 60000 元，次日即可获得救援金 388 元。
                </div>
              </div>
            </div>
            ...
            <div class="livepoker-rebate-game-bottom-rule">
              ...
              <div class="content">
                <div class="item">
                  <div class="item-num">1</div>
                  <div style="display: flex; flex-direction: column">
                    <div>活动期间，活动仅计算电竞场馆中 LPL&LCK 春季赛 2025，会员在当日 LPL&LCK 春季赛 2025 中累计负盈利≥1,500 元即可获得对应彩金，负盈利次日清零； </div>
                    <div class="hint">注：奖金不叠加派发，奖金按最高档位每日派发一次。</div>
                  </div>
                </div>
                <div class="item">
                  <div class="item-num">2</div>
                  活动期间，活动仅计算 LPL&LCK 春季赛 2025 已结算的赛事总负盈利，次日 24 小时内在活动页面点击【点击领取】按钮领取。逾期未领取则视为放弃，彩金 6 倍流水即可出款；
                </div>
                <div class="item">
                  <div class="item-num">3</div>
                  任何低于欧洲盘 1.7 或亚洲盘 0.7 水位的投注及在同一局游戏中同时投注对等盘口、当日注单取消或本金退还，将不计算为有效投注额内；
