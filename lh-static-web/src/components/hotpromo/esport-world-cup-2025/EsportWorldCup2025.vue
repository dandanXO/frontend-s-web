    ...
    <div class="livepoker-rebate-container">
      ...
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="little-title">
          ...
          <div class="right">2025年7月28日至7月19日</div>
        </div>
        <div class="little-title">
          <div class="ribbon">活动内容</div>
          <div class="right">活动期间，当日2025 电竞世界杯累计有效投注≥1000 元即可获得最高1588元的奖金。</div>
        </div>
        ...
        <div class="livepoker-rebate-game-bottom">
          <div class="livepoker-rebate-game-bottom-left-title">
            ...
            会员在2025 电竞世界杯比赛中累计有效投注为50,000 元，在次日 24 小时内可获得彩金：588元
          </div>
        </div>
      </div>
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              活动期间，活动仅计算电竞场馆中2025 电竞世界杯赛事，会员在当日2025 电竞世界杯赛事中累计有效投注≥1000
              元即可获得对应彩金，有效投注次日清零；
          ...
          <div class="item">
            ...
            活动期间，活动仅计算当日2025 电竞世界杯赛事已结算的赛事总有效投注，次日 24
...
import { getEsportWorldCup2025Bonus, claimEsportWorldCup2025Bonus } from "@/api/index/promo";
...
const fetchData = async () => {
  ...
  getEsportWorldCup2025Bonus(promoCode.value)
    .then((res) => {
...
const handleClaimBonus = () => {
  loadingClaim.value = true;
  claimEsportWorldCup2025Bonus(promoCode.value)
    .then((res) => {
      if (res.code === 0) {
        notify({
          type: "success",
