      ...
      <div class="deposit-card" v-for="(card, i) in depositCards" :key="i">
        ...
        <div class="deposit-buttons">
          <div class="btn deposit-buttons__go-deposit">
            <router-link to="/center/deposit"><img src="./euroimages/depositnow-btn.png" /></router-link>
          </div>
          <div class="btn deposit-buttons__check-lesson" v-if="card.lesson">
            <a :href="card.lesson" target="_blank"><img src="./euroimages/checklesson-btn.png" /></a>
          </div>
        </div>
      </div>
    </div>
...
const depositCards = ref([
  {
    ...
    title: "USDT",
    content:
      "充值即送1.5%彩金​ 使用USDT充值更安全更便捷，24小时充值不等待。活动期间，每位玩家每笔使用“TRC 20”“ERC20-2”或“ERC20”充值≥200U，即可享受存款金额的1.5%加码彩金，单日优惠最高上限588元​",
  ...
  },
  {
    ...
    title: "OKpay",
    content:
      '充值即送1.0%彩金​OKpay充值火热上线，速度快，够安全。活动期间，每日用户任何时间在雷火使用“OKpay充值"方式成功存款，即可获得OKpay存款金额的1.0%的彩金返还，单日优惠最高上限200元。​',
  ...
  },
  {
    ...
    title: "EBPAY",
    content:
      "充值即送1.0%彩金，活动期间，每位玩家每笔使用EBpay单笔充值成功存款即可享受存款金额的1.0%加码彩金，单日优惠最高上限200元​​",
  ...
  },
  {
    ...
    title: "K豆",
    content:
      "充值即送1.0%彩金​K豆完全可以满足您不同需求和使用场景。活动期间，每位玩家每笔使用K豆单笔充值成功享受存款金额的1.0%加码彩金，单日优惠最高上限200元​​",
  ...
  // },
  {
    ...
    title: "数字人民币",
    content:
      "充值即送1.0%彩金数字人民币充值火热上线，速度快，够安全。用户每日任何时间在雷火使用“数字人民币”方式成功存款≥300元，即可享受存款金额的1.0%加码彩金，单日优惠最高上限100元​"
  },
  {
    code: "zfb",
    title: "支付宝转卡",
    content:
      "充值即送0.5%彩金活动期间，每日用户任何时间在雷火使用“支付宝转卡”方式成功存款，即可获得支付宝转卡存款金额的0.5%的彩金返还，单日优惠最高上限100元​"
  },
  {
    code: "blbpay",
    title: "808钱包",
    content:
      "充值即送1.5%彩金，808钱包方便快捷、快速到账、安全。用户每日任何时间在雷火使用“808钱包”方式成功存款，即可享受存款金额的1.5%加码彩金，单日优惠最高上限200元​",
