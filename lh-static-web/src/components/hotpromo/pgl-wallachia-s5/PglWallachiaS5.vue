    ...
    <div class="livepoker-rebate-container">
      ...
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="little-title">
          ...
          <div class="right">2025年6月21日至2025年6月29日</div>
        </div>
        <div class="little-title">
          <div class="ribbon">活动内容</div>
          <div class="right">活动期间在PGL 瓦拉几亚 S5当日总有效投注≥2,000 元即可获得最高1288元的投注金</div>
        </div>
        ...
        <div class="livepoker-rebate-game-bottom">
          <div class="livepoker-rebate-game-bottom-left-title">
            ...
            会员 在PGL 瓦拉几亚 S5赛事期间当日总有效投注 50,000 元，在次日 24 小时内可获得彩金：188元
          </div>
        </div>
      </div>
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              .活动期间，活动仅计算电竞场馆中PGL 瓦拉几亚 S5赛事，会员在PGL 瓦拉几亚 S5赛事期间当日累计有效投注≥2,000 元即可获得对应彩金，有效投注过期清零；
              <div class="hint"> 注：奖金不叠加派发，奖金按最高档位派发一次。</div>
            </div>
          </div>
          <div class="item">
            <div class="item-num">2</div>
            活动期间，活动仅计算PGL 瓦拉几亚 S5已结算的赛事当日总有效投注，次日 24 小时内在活动页面点击【立即领取】按钮领取。逾期未领取则视为放弃，彩金 6倍流水即可出款；
          </div>
          <div class="item">
            <div class="item-num">3</div>
            任何低于欧洲盘 1.7 或亚洲盘 0.7 水位的投注及在同一局游戏中同时投注对等盘口、当日注单取消或本金退还，将不计算为总有效投注额内；
          </div>
          <div class="item">
