<template>
  <div class="euro-regen-container">
    ...
    <div class="promo-content-wrapper">
      ...
      <div class="promo-content-header">活动内容：在欧洲杯期间负盈利≥500即可在活动时间内领取回血礼包</div>
      ...
      <div class="promo-rules">
        ...
        <div class="promo-rules-list">
          <div class="promo-rules-list-item">
            <span class="blue-number">1.</span>
            欧洲杯赛事结束后会统一计算负盈利，达标会员在7.17日~7.21日（共5天）领取回血礼金。
          </div>
          <div class="promo-rules-list-item">
            <span class="blue-number">2.</span>
            在7.17日00：00：00开启回血窗口，当天领取时间至7.17日23：59：59截止，彩金仅需8倍流水即可提款，逾期未领取视为放弃。
          </div>
          <div class="promo-rules-list-item">
            <span class="blue-number">3.</span>
            本活动负盈利以结算时间为准，仅对已结算并产生输赢结果进行计算。
          </div>
          <div class="promo-rules-list-item">
            <span class="blue-number">4.</span>
            同一手机号、姓名、邮箱地址、银行卡号等信息的游戏账号，仅可参与一次，若有违规者，将不享受此红利；
          </div>
          <div class="promo-rules-list-item">
            <span class="blue-number">5.</span>
