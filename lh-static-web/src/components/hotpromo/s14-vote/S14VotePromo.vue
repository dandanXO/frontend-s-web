    ...
    <div class="column">
      ...
      <div class="terms">
        <ol>
          ...
          <li v-if="activeTab === 2">
            淘汰赛奖金池结算：（300,000➗晋级队伍总票数）*用户投票数量=单票彩金。彩金于赛事阶段结束后次日24小时内派发，彩金3倍流水即可提款；
            <span class="eg">
              例：用户投注BLG队伍100票，BLG队伍在淘汰赛阶段晋级决赛并且两支晋级队伍总共获得300,000票数，那么用户可获得（300,000➗300000）*100=100元彩金；
            </span>
          </li>
          <li v-if="activeTab === 3">
