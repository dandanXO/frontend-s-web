      ...
      <div class="livepoker-rebate-game-info">
        ...
        <div class="livepoker-rebate-game-bottom">
          <div class="livepoker-rebate-game-bottom-left-title">
            ...
            <div>
              1.所有VIP等级≥1的会员，需有历史存款记录。返水的计算标准依据会员晋升后的最终等级进行统计。返水统计时间按照北京时间每日00:00:01至23:59:59结束；
            </div>
            <div>2.返水奖金无需申请，系统会在次日下午14:00派发到您的主账户；</div>
            <div>3.返水奖金可投注于任何平台游戏，奖金只需1倍投注额即可申请提款；最低返水1元，低于1元不派发；</div>
          </div>
        </div>
      </div>
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              <div>
                返水奖金根据北京时间每天00:00:00-23:59:59之间的有效投注额进行计算，所有游戏场馆投注额都是按照北京时间计算;
              </div>
            </div>
          </div>
          <div class="item">
            <div class="item-num">2</div>
            雷火电竞小游戏、捕鱼和彩票 不参与返水优惠；
          </div>
          <div class="item">
            <div class="item-num">3</div>
            电竞/体育中的连串过关投注额返水将以注单结算时间为准。
          </div>
          <div class="item">
          ...
          <div class="item">
            ...
            此优惠促销只适用于拥有一个独立账户的玩家。住址、电子邮箱地址, 电话号码,
            支付方式(相同借记卡/信用卡/银行账户号码) IP地址，同一网络环境等将可以作为判定是否独立玩家的条件
          </div>
          <div class="item">
            <div class="item-num">7</div>
            对于发现任何有违背、欺骗、或利用规则和条款进行非法获利的会员，雷火保留在任何时候都可以停止、取消优惠或索回已支付的全部优惠的权利
          </div>
          <div class="item">
            <div class="item-num">8</div>
            在某些未知因素超出可控范围的情况下，雷火保留可单方面执行的决定权，并承诺会在这类紧急问题发生时解释给客户原因并听取客户反馈与客户沟通协商解决。
          </div>
          <div class="item">
