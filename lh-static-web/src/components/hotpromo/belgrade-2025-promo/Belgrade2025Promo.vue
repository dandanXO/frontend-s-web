...
注：奖金不叠加派发，奖金按最高档位每日派发一次。
          ...
          <div class="item">
            ...
            活动期间，活动仅计算当日 FISSURE PLAYGROUND 贝尔格莱德 赛事已结算的赛事的单笔最高有效投注，次日 24 小时内在活动页面点击【点击领取】按钮领取。逾期未领取则视为放弃，彩金 6 倍流水即可出款；
          </div>
          <div class="item">
...
<script setup>
import { getBelgrade2025Init, claimBelgrade2025Bonus } from "@/api/index/promo";
...
const handleClaimBonus = () => {
  ...
  claimBelgrade2025Bonus(promoCode.value)
    .then((res) => {
      if (res.code === 0) {
