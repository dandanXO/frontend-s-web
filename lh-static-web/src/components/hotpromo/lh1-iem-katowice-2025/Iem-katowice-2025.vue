    ...
    <div class="livepoker-rebate-container">
      ...
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="little-title">
          ...
          <div class="right">活动期间，当日 IEM 卡托维兹 2025 累计有效投注≥1,000 元即可获得 最高 1,288 元的奖励金</div>
        </div>
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              活动期间，活动仅计算电竞场馆中 IEM 卡托维兹 2025 赛事，会员当日在 IEM 卡托维兹 2025 中累计有效投注≥1,000
              元即可获得对应彩金，有效投注次日清零；
...
<script setup>
import { getCompetitionYesterday, claimVctBangkokBonus } from "@/api/index/promo";
