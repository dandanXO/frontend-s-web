    ...
    <div class="provilege-invite-wrapper">
      ...
      <template v-if="activeTab === 3">
        ...
        <div class="tnc">
          ...
          <div class="note">4.邀请人等级不得低于青铜Ⅰ（vip2）；</div>
          <div class="note">
...
const hotPromoNav = [
  {
    id: 1,
    label: "晋升有礼",
    path: "/promotion?name=lh1-football-fight"
  },
  {
    id: 2,
    label: "携手宏图",
    path: "/promotion?name=lh1-football-fight-2"
  },
  {
    id: 3,
    label: "共创未来",
    path: "/promotion?name=lh1-football-fight-3"
  }
];
...
watch(
  ...
  () => {
    if (route.query === null) {
      route.query.name = "lh1-vip-upgrade-bonus";
    }
