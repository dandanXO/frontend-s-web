<template>
    <div>
            ...
            <el-tabs v-model="tabPosition" class="summoner-tabs">
                <el-tab-pane name="first" label="精英召唤">
                    ...
                    <div class="rules">
                        ...
                        <br>
                        6. 同一姓名、手机号、银行卡号、邮箱地址等信息的用户账号，仅可参与一次，若有违规者，将不享受此优惠。会员与被邀请会员禁止注册IP一致，设备一致；<br>
                        <br>
                        7. 任何用户或团体以不正常的方式进行套取活动优惠，本站保留在不通知的情况下冻结或关闭相关账户的权利，并不退还款项，且用户会被列入黑名单；<br>
                        <br>
                        8. 为避免文字理解差异，本活动最终解释权归雷火电竞所有；</p>
                    </div>
                </el-tab-pane>
        ...
        <el-dialog modal-class="summoner-modal" align-center v-model="isShowFriendDialog">
...
import { getSummonRewardRecord } from "@/api/index/promo.js"
