...
.stepgame-wrapper {
  background-image: url("../../../assets/images/promotion/hotpromo/lh-step-game/game1-bg.jpg");
  ...
  &.step-2 {
    background-image: url("../../../assets/images/promotion/hotpromo/lh-step-game/game2-bg.jpg");
