          ...
          <div class="livepoker-rebate-game-bottom-rule">
            ...
            <div class="content">
              <div class="item">
                ...
                当前活动仅计算体育场馆，在CBA赛季期间内当日有效投注≥1000元并完成下注次数即可获得对应彩金，彩金只需5倍流水即可出款；
              </div>
              <div class="item">
                <div class="item-num">2</div>
                当前活动符合条件的会员可在优惠界面点击【领取】按钮获得彩金，彩金保留24小时；
              </div>
              <div class="item">
        ...
        <div>
          ...
          <div class="livepoker-rebate-game-info">
            ...
            <div class="little-title">
              <div class="left">活动内容</div>
              <div class="right">
                在CBA常规赛季期间的每周一到周日完成至少一次存款且一周内累计负盈利≥5000元的会员在下一周的周一即可获得回馈奖金，最高可获888元
              </div>
            </div>
            <table class="livepoker-rebate-game-info-table">
              <tbody>
            ...
            <div class="livepoker-rebate-game-bottom">
              <div class="livepoker-rebate-game-bottom-left-title">
                例：用户A在10月12日至10月18日一周内累计负盈利为20000元，在下周一至周日的任意一天即可在优惠页面点击【领取】获得周包赔奖金，根据规则会员可获得200元包赔奖金，奖金仅需8倍水即可出款。
              </div>
            </div>
          </div>
          ...
          <div class="livepoker-rebate-game-bottom-rule">
            ...
            <div class="content">
              <div class="item">
                <div class="item-num">1</div>
                当前活动仅计算体育场馆，在CBA赛季期间内以周为单位根据累计负盈利计算会员应获得的彩金，彩金只需8倍流水即可出款
              </div>
              <div class="item">
                <div class="item-num">2</div>
                当前活动符合条件的会员可在活动开始后的次周任意一天在优惠界面点击【领取】按钮获得包赔奖金。彩金保留7天，每周领取一次。
              </div>
              <div class="item">
                <div class="item-num">3</div>
                流水仅计算当天下注且结算的注单，若提前兑现、注单未结算、取消或走盘皆不及不计算为有效投注；
