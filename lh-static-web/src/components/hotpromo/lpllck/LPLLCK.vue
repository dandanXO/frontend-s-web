        ...
        <div class="match-container">
            ...
            <div class="match-game-info">
                ...
                <div class="subtitle">
                    ...
                    <span class="subtitle-2">活动期间，投注LPL与LCK赛事当日累计总有效投注≥2,000元即可符合获取活动彩金条件，最高可获1,288元</span>
                </div>
                ...
                <div class="content-sub-title">
                    ...
                    <span>
                        用户A当日投注LPL总有效投注共4,000元，LCK总有效投注共4,000,用户次日可在活动页面点击领取到28元；</span>
                </div>
            </div>
            <div class="match-game-bottom-rule">
                ...
                <div class="content">
                    <div class="item">
                        ...
                        <span>活动期间，会员当日LPL夏季赛季后赛与LCK夏季赛季后赛赛事累计有效投注≥2,000元即可符合获得彩金资格，符合条件的会员需在次日前往活动页面点击领取彩金；</span>
                    </div>
                    <div class="item">
                    ...
                    <div class="item">
                        ...
                        <span>仅统计电竞场馆所产生的有效投注，其他场馆不在统计范围内，彩金需在次日24小时内前往活动页面点击领取按钮进行领取，彩金5倍电竞场馆流水即可提款，超出领取彩金时间则视为放弃；</span>
                    </div>
                    <div class="item">
                        <span class="rounded-number">4</span>
                        <span>本活动有效投注额仅对已结算并产生输赢结果的投注额进行计算，任何滚球、走水、串关、提前结算的投注、取消的赛事将不计算在有效投注;</span>
                    </div>
                    <div class="item">
                        <span class="rounded-number">5</span>
                        <span>根据博彩公平有序规则，任何用户或团体以不正常的方式进行投注，如有风险投注、对赌行为或欺骗方式，本站保留权力在不通知的情况下冻结或关闭相关账户；</span>
                    </div>
                    <div class="item">
                        <span class="rounded-number">6</span>
                        <span>此活动只适用于拥有一个账户的会员，每一个住址、每一个电子邮箱地址、每一个电话号码、相同支付方式及IP地址视为同一账户，若有违规者，将不享受此红利；</span>
                    </div>
                    <div class="item">
                        <span class="rounded-number">7</span>
                        <span>为避免文字理解差异，雷火电竞保留此活动最终解释权；</span>
                    </div>
                </div>
            </div>
