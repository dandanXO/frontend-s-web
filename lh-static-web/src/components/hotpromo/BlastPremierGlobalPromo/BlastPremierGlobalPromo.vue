<template>
  <div class="cs2">
    ...
    <div class="section third">
      ...
      <div class="content">
        <p>1. 活动期间,每日投注BLAST Premier 全球总决赛达到100元有效投注即可在次日12：00点左右自动获得1个开箱钥匙,开箱钥匙与开箱次数每日不设上限；</p>
        <p>2. 活动期间,开箱钥匙可积攒使用,获得开箱钥匙满足开箱条件可在活动期间任意时间开启宝箱,超出活动时间未开启宝箱则视为放弃，不予补偿；</p>
        <p>3. 开启宝箱后获得彩金由系统自动实时派发至会员主钱包内.彩金5倍流水即可出款；</p>
        <p>4. 活动期间,参与BLAST Premier 全球总决赛有效投注≥1,000元在次日12:00点左右获得签到天数,达到指定签到天数则可开启签到宝箱,每个宝箱每位用户仅可开启一次；</p>
