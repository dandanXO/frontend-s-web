<template>
    <div class="cs2">
      <div class="section first">
        ...
        <div class="tips">
          <div class="tips-inner">活动期间，每日投注 BLAST Premier 赛事达到≥100元即可获得开箱钥匙</div>
        </div>
        <div class="title">
      ...
      .middle-row {
        .item-container {
          ...
          .item {
            ...
            gap: 16px;
            padding: 10px 0;
            background: url(@/assets/images/promotion/hotpromo/blastpremier/global-treasure-bg.png) no-repeat center center;
            cursor: pointer;
            ...
            &.active,
            &:hover {
              background: url(@/assets/images/promotion/hotpromo/blastpremier/global-treasure-bg-active.png) no-repeat center
                center;
              transform: scale(1.2);
              .required-key {
                color: #FFFD66;
