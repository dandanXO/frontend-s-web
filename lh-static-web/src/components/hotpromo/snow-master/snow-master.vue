    ...
    <div class="livepoker-rebate-container">
      ...
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="little-title">
          ...
          <div class="right">2025年7月28日至2025年8月03日</div>
        </div>
        <div class="little-title">
          <div class="ribbon">活动内容</div>
          <div class="right">活动期间，当日2025 雪如意大师赛累计有效投注≥1,000 元即可获得 最高1388元的奖励金 </div>
        </div>
        ...
        <div class="livepoker-rebate-game-bottom">
          <div class="livepoker-rebate-game-bottom-left-title">
            ...
            用户 A 在7月28日投注2025 雪如意大师赛累计有效投注 50,000 元，用户 A 在次日 24 小时内可获得彩金：388元 
          </div>
        </div>
      </div>
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              活动期间，活动仅计算电竞场馆中2025 雪如意大师赛赛事，会员在当日2025 雪如意大师赛中累计有效投注≥1,000 元即可获得对应彩金，有效投注次日清零； 
              <div class="hint">注：奖金不叠加派发，奖金按最高档位每日派发一次。</div>
            </div>
          </div>
          <div class="item">
            <div class="item-num">2</div>
            活动期间，活动仅计算当日投注2025 雪如意大师赛且当日已结算的赛事注单，次日 24 小时内在活动页面点击【立即领取】按钮领取。逾期未领取则视为放弃，彩金 6 倍流水即可出款； 
          </div>
          <div class="item">
          ...
          <div class="item">
            ...
            据博彩公平有序规则，任何用户或团体以不正常的方式进行投注，如有风险投注、对赌行为或欺骗方式，本站保留权力在不通知的情况下冻结或关闭相关账户； 
          </div>
          <div class="item">
            <div class="item-num">5</div>
            活动只适用于拥有一个账户的会员，每一个住址、每一个电子邮箱地址、每一个电话号码、相同支付方式及 IP 地址视为同一账户，若有违规者，将不享受此红利；
          </div>
          <div class="item">
