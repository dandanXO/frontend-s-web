export default {
  ...
  hotPromo: {
    ...
    invite_to_earn_spin: "Invitation Wins",
    time: "time",
    rotate: "rotate",
    ...
    spinReferWheel: {
      ...
      message2:
        "When you have no spins left, invite new players to register and deposit to earn additional free spins.",
      message3:
    ...
    depositSpinWheel: {
      ...
      rule_05:
        "The right to interpret this event belongs to 97PKR. If you have any questions, please contact customer service.",
      silver: "Silver",
      gold: "Gold",
      diamond: "Diamond",
      supreme: "Supreme"
