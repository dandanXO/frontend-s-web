<template>
  <q-footer v-if="ui.footer" :style="ui.bottomInsetHeight > 0 ? `bottom: ${ui.bottomInsetHeight}px;` : ''">
    <q-tabs v-model="tab" no-caps :breakpoint="0" align="justify" narrow-indicator>
