      ...
      <div class="account-content last">
        ...
        <q-form v-if="!isSelectedWithdrawalMethodInMaintenance" ref="withdrawFormRef" class="q-mt-md">
          ...
          <div v-if="isUSDT && selectedWithdrawalMethod.exchangeRate">
            ...
            <div class="q-mt-sm text-neontb" style="display: flex; justify-content: center; align-items: center">
...
const openWithdrawTutorialPage = () => {
  window.open(
    "https://docs.google.com/presentation/d/1ZoIE9VOzjmr9r4poShqyxceJbm-P5-MZ/edit?usp=sharing&ouid=110900271170800899072&rtpof=true&sd=true",
    "_blank"
  );
};
