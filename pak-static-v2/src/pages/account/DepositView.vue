<template>
  ...
  <q-dialog width="100%" v-model="isDeposited">
    <q-card style="width: 100%">
      <q-card-section style="padding: 10px 20px" class="q-pa-md bg-primary">Deposited</q-card-section>
...
<script setup>
import { ref, reactive, onMounted, shallowRef, onActivated, watch, computed } from "vue";
