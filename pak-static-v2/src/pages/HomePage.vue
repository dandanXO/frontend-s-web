      ...
      <template v-for="(item, index) in translatedCategoriesList" :key="index">
        <swiper-slide>
          <div class="cat-selection-item" :class="item.active && 'active'" @click="activateSlide(item)">
            <img
              v-if="!item.active"
              :src="require(`../assets/images/index/category/cat-${item.icon.toLowerCase()}.png`)"
              alt=""
            />
            <img
              v-else
              :src="require(`../assets/images/index/category/cat-${item.icon.toLowerCase()}-active.png`)"
              alt=""
            />
            <div class="cat-title">{{ item.icon }}</div>
          </div>
          <!-- <div class="cat-selection-item" :class="item.active && 'active'" @click="activateSlide(item)">
            <div class="cat-icon">
            </div>
