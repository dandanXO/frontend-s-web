<template>
  ...
  <!-- <q-dialog width="100%" v-model="showCaptchaDialog">
    <q-card style="width: 100%; padding: 20px" class="bg-dark text-center">
  ...
  <q-dialog v-model="showCaptchaDialog" width="100%">
    <q-card width="100%">
      <q-card-section style="padding: 10px 20px" class="q-pa-md bg-dark">OTP</q-card-section>
  ...
  <q-dialog width="100%" v-model="bindEmailDialog" presistent>
    <div class="popout-dialog">
      <q-btn dense rounded icon="close" class="popout-close" @click="openBindEmailDialog()" v-close-popup />
      <div class="popout-dialog-container">
  ...
  <q-dialog width="100%" v-model="changePasswordDialog" presistent>
    <div class="popout-dialog">
      <q-btn dense rounded icon="close" class="popout-close" @click="openChangePasswordDialog()" v-close-popup />
      <div class="popout-dialog-container">
