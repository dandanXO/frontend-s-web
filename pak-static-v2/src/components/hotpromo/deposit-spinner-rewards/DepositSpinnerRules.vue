...
<style lang="scss">
    .rules-container {
        ...
        .badges {
            ...
            margin: 10px auto;
            .badge {
                // background: url(./img/greensquare.png)no-repeat center center;
                background-size: contain;
                padding: 5px;
                border: 1px solid rgba(97, 139, 251, 1);
                border-radius: 10px;
                display: flex;
    ...
    .badgetitle {
        color:rgba(97, 139, 251, 1);
    }
    .back-button{
        width: 100%;
        background: #fff;
        box-shadow:inset 0 -5px 8px 0 #c3d4e6, 0 2px 0 0 #a7c2dd
    }
</style>
