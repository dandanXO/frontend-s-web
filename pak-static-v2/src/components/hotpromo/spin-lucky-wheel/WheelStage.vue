<template>
  <div class="wheel-stage-wrapper">
    ...
    <div class="summary-outer-wrapper">
      <div class="summary-wrapper">
        <button class="record-btn" @click="handleRecordClick">{{ $t("hotPromo.record") }}</button>

        <img class="header-ribbon"
          src="../../../assets/images/promotion/hotpromo/spin-lucky-wheel/wheel-stage/lucky-wheel-ribbon.svg" />
    ...
    <div class="wheel-wrapper">
      ...
      <div class="wheel-inner-wrapper">
        <img ref="spinWheelRef" class="wheel"
      ...
      <img class="decoration wheel-stage" src="../../../assets/images/promotion/hotpromo/spin-lucky-wheel/wheel-stage/wheel-stage.png" />
      <img class="decoration rabbit" src="../../../assets/images/promotion/hotpromo/spin-lucky-wheel/decoration-rabbit.png" />
      <img class="decoration penguin" src="../../../assets/images/promotion/hotpromo/spin-lucky-wheel/decoration-penguin.png" />
    ...
    <!-- <div class="block-wrapper">
      ...
      <ol>
        ...
        <li>{{ $t("hotPromo.spinReferWheel.message2") }}</li>
        <li>{{ $t("hotPromo.spinReferWheel.message3") }}</li>
    ...
    <q-dialog v-model="showWithdrawDialog">
      <div class="withdraw-container">
        ...
        <div class="withdraw-amount">
          ...
          <BlueGradientTextAmount :amountText="`${info.accumulatedBonus}`"  />
        ...
        <div class="desc">* {{ $t("hotPromo.spinReferWheel.inviteFriendsToHelp") }}</div>

        <div class="invite-friends-btn" @click="handleInviteClick">
          {{ $t("hotPromo.spinReferWheel.referFriendToRegister") }}
        </div>
      </div>
    </q-dialog>
...
import BlueGradientTextAmount from "./withdrawDialog/GradientTextAmount.vue";
...
const handleWheelClick = () => {
  ...
  eventapi.post("/session/refer-wheel-spin/spin?promoCode=pk2-refer-wheel-spin").then((res) => {
    if (res.code === 0) {
...
const handleReceiveClick = () => {
  eventapi.post("/session/refer-wheel-spin/claimBonus?promoCode=pk2-refer-wheel-spin").then((res) => {
    if (res.code === 0) {
      $q.notify({
...
const getRecords = () => {
  eventapi.get("/session/refer-wheel-spin/getRecords?promoCode=pk2-refer-wheel-spin").then((res) => {
    if (res.code === 0) {
...
.countdown {
  ...
  background: url(../../../assets/images/promotion/hotpromo/spin-lucky-wheel/wheel-stage/countdown-bg.png) no-repeat;
...
.winning-record-outer-wrapper {
  margin-top: 60px;
  width: 100%;
  background: url(../../../assets/images/promotion/hotpromo/spin-lucky-wheel/wheel-stage/winning-record-bg.png) center center no-repeat;
  background-size: 100% 100%;
  border-radius: 8px;
  padding: 26px 22px;
...
.summary-wrapper {
  ...
  .extraction-progress-bar {
    ...
    .progress {
      ...
      background: url(../../../assets/images/promotion/hotpromo/spin-lucky-wheel/wheel-stage/progress-bar-bg.png) no-repeat;
      background-size: 100% 100%;
      border-radius: 4px;
    }
...
.next-spin-remaining-time {
    ...
    display: block;
    margin-top: 8px;
    background: url(../../../assets/images/promotion/hotpromo/spin-lucky-wheel/wheel-stage/secondary-countdown-bg.png) no-repeat;
    background-size: 100% 100%;
    text-align: center;
    padding: 10px 15px;
    position: absolute;
...
.block-wrapper {
  background: url(../../../assets/images/promotion/hotpromo/spin-lucky-wheel/wheel-stage/winning-records-bg.png) no-repeat;
  background-size: 100% 100%;
  padding: 20px 15px;
