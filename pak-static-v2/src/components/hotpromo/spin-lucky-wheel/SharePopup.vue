<template>
  ...
  <q-dialog v-model="modalSocialShare">
    <div class="popout-dialog" style="
    margin-top: auto;">

      <div class="popout-dialog-container" style="
    padding: 0;
    min-height: 100px;
    background: unset;">
...
const shareCaptions = [
  "Mujhe madad chahiye withdraw karne mein, tu bhi aaja 97PKR pe, dono milke bonus lete hain!",
  "Mujhe paisay mile aur withdraw bhi successfully ho gaya! Bhai, ab teri bari hai — 97PKR join kar aur free reward le!",
  "Sach mein, maine bhi nahi socha tha ke mil jayega — lekin 97PKR ne sach mein diya! Ab tu bhi aaja — free bonus ready hai!",
  "Free ka paisa milta hai bhai! Register kar, phone verify kar, aur free bonus le! Main already le chuka hoon!",
  "Mujhe bas ek click se paisay mil gaye — 97PKR par! Tu bhi sirf ek click door hai — join kar aur reward le!"
]
...
.carousel-container {
  ...
  :deep(.carousel__pagination-button--active) {
    ...
    width: 30px !important;
    background: linear-gradient(90deg, #009CFB 0%, #005DF3 100%);
  }
...
.bottom-panel {
  ...
  .invite-share-social {
    ...
    .social-item {
      position: relative;
      background: linear-gradient(90deg, #5B60F7 0%, #0087FE 100%);
      border-radius: 30px;
