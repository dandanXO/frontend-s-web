  ...
  <div class="team-management-wrapper">
    ...
    <div class="result-table">
      ...
      <div class="pagination">
        <q-btn @click="prevPage" :disabled="currentPage === 1" icon="chevron_left" round></q-btn>
        <span>{{ currentPage }} / {{ totalPages }}</span>
        <q-btn @click="nextPage" :disabled="currentPage === totalPages" icon="chevron_right" round></q-btn>
      </div>
    </div>
