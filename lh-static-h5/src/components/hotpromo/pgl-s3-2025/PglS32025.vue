  ...
  <div class="livepoker-rebate-wrapper">
    <div class="livepoker-rebate-container">
      ...
      <template v-if="tabValue === 1">
        <div>
          <div
            class="livepoker-rebate-game-info"
            :style="{
              background: `url(${require('../../../assets/promo/lh-dota2-pgl/reward-section-bg-t.png')}) no-repeat top / 100%, url(${require('../../../assets/promo/lh-dota2-pgl/reward-section-bg-b.png')}) no-repeat bottom / 100%, url(${require('../../../assets/promo/lh-dota2-pgl/reward-section-bg-l.png')}) no-repeat left center, url(${require('../../../assets/promo/lh-dota2-pgl/reward-section-bg-r.png')}) no-repeat right center, #1C0D18 !important`
            }"
          >
            ...
            <div>
              <div class="reward-wrapper">
                <template v-for="(bonus, index) of bonuses" :key="index">
                  <div class="reward-item">
                    <div class="reward-item-content" style="color: #8c5b00 !important">{{ bonus }} 元</div>
                  </div>
                </template>
              ...
              <div class="reward-btn-wrapper" @click="handleClaimBonus">
                <div class="reward-btn" style="color: #ffd164 !important">开启宝箱</div>
              </div>
            </div>
          </div>

          <div
            class="livepoker-rebate-game-bottom-rule"
            :style="{
              background: `url(${require('../../../assets/promo/lh-dota2-pgl/reward-section-bg-t.png')}) no-repeat top / 100%, url(${require('../../../assets/promo/lh-dota2-pgl/reward-section-bg-b.png')}) no-repeat bottom / 100%, url(${require('../../../assets/promo/lh-dota2-pgl/reward-section-bg-l.png')}) no-repeat left center, url(${require('../../../assets/promo/lh-dota2-pgl/reward-section-bg-r.png')}) no-repeat right center, #1C0D18 !important`
            }"
          >
            ...
            <div class="content">
              ...
              <div class="item" style="color: #ffd164 !important">
                3. 获得的开启宝箱次数在当天内积累，次日清零，请在当天内使用，逾期未使用不予补偿；
              </div>
              <div class="item" style="color: #ffd164 !important">
        ...
        <div style="width: 100%">
          ...
          >
            ...
            <div class="carousell-div">
              <Carousel v-model="slide" snapAlign="center" :items-to-show="3" :wrap-around="true" height="230">
                <Slide @click="handleSlideClick(index)" v-for="(box, index) in boxes" :key="box.title">
                  <div class="reward-box">
                    <img :src="require(`../../../assets/promo/lh-dota2-pgl/reward2-${index}.png`)" alt="" />
                    <div style="color: #ffd164 !important">{{ box.title }}</div>
            ...
            <!-- <div class="reward-btn-wrapper" @click="handleClaimBonus">
              <div class="reward-btn2" style="color: #000000 !important">领取</div>
            </div> -->

            <div class="livepoker-rebate-game-bottom" style="justify-content: center; color: #ffd164 !important">
              注：每个奖品仅可兑换 1 次
            </div>
          </div>
...
.livepoker-rebate-game-info {
  ...
  .reward-box {
    background: url("../../../assets/promo/lh-dota2-pgl/reward-box-bg2.png") no-repeat;
    background-size: 100% 100%;
    width: 226px;
    height: 230px;
    display: flex;
