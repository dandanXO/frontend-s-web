  ...
  <div class="cs2">
    <div class="section first">
      <div class="title">
        ...
        <img class="top" src="../../../assets/images/promo/hotpromo/blastbounty/section-1-spring.png" />
      </div>
      <div class="tips">
...
.cs2 {
  ...
  .first .content .top-row {
    background: url(../../../assets/images/promo/hotpromo/blastbounty/container.png) no-repeat center center;
    background-size: contain;
  }
  .content {
    margin: 10px auto;
    ...
    .middle-row {
      .item-container {
        ...
        .item {
          ...
          flex-direction: column;
          gap: 6px;
          background: url(../../../assets/images/promo/hotpromo/blastbounty/treasure-bg.png) no-repeat center center;
          background-size: 100% 100%;
          ...
          &.active {
            background: url(../../../assets/images/promo/hotpromo/blastbounty/treasure-bg-active.png) no-repeat center
              center;
            color: #fffd66;
            background-size: 100% 100%;
      ...
      .use-Keys {
        background: url(../../../assets/images/promo/hotpromo/blastbounty/open-btn-bg.png) no-repeat center center;
        color: #003434;
        padding: 15px 15px;
        background-size: contain;
        margin: 0 auto;
      ...
      .sign-container {
        ...
        .item {
          ...
          .sign-day {
            color: #fffd66;
            padding: 8px 12px;
            // background: url(../../../assets/images/promo/hotpromo/blastbounty/daily-bonus-title.png) no-repeat center
            //   center;
            font-weight: bold;
            font-family: "Microsoft YaHei UI";
            font-size: 14px;
