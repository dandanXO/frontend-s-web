    ...
    <div class="livepoker-rebate-container">
      ...
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="little-title row">
          ...
          <div class="right">2025年5月19日至2025年6月1日</div>
        </div>
        <div class="little-title row">
          <div class="ribbon">活动对象</div>
          <div class="right">投注梦幻联赛S26的会员</div>
        </div>
        ...
        <div class="livepoker-rebate-game-bottom">
          <div class="livepoker-rebate-game-bottom-left-title">
            ...
            用户 A 在5月20日的梦幻联赛S26赛事中有效投注 50,000 元，在次日 24 小时内可获得彩金：288元。
          </div>
        </div>
      </div>
      ...
      <div class="livepoker-rebate-game-bottom-rule section-bg">
        ...
        <div class="content">
          ...
          <div class="item">
            ...
            活动期间，活动仅计算当日梦幻联赛S26已结算的赛事总有效投注，次日 24
...
import { getDreamLeagueS26Bonus, claimDreamLeagueS26Bonus } from "../../../api/index/promo";
...
const handleClaimBonus = () => {
  ...
  claimDreamLeagueS26Bonus(promoCode.value)
    .then((res) => {
      if (res.code === 0) {
        notify({
          type: "success",
...
const fetchData = async () => {
  loadingClaim.value = true;
  getDreamLeagueS26Bonus(promoCode.value)
    .then((res) => {
      if (res.code === 0) {
