<template>
  <div>
          ...
          <div class="teams-list" id="countrylist">
            <div id="btn_1" class="teams-item" v-for="(votesListItem, i) in votesData.votesList.slice(0, 8)" :key="i">
              ...
              <div class="flexcast">
                ...
                <q-input v-model.number="votesListItem.votes" type="number" filled disable style="max-width: 200px" />
    ...
    <div class="columne">
      ...
      <div @click="goToDeposit()" class="votebtn">
...
const tabs = [
  {
    label: "淘汰赛",
    period: 2,
    date: "淘汰赛阶段活动投票时间：10.17~10.27 截止",
