    ...
    <div class="livepoker-rebate-container">
      ...
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="little-title">
          ...
          <div class="right">2025年3月22日至3月30日</div>
        </div>
        <div class="little-title">
          <div class="ribbon">活动内容</div>
          <div class="right">活动期间，当日裂变宇宙第四季赛事中累计有效投注≥500 元即可获得最高1588元的奖金。</div>
        </div>
        ...
        <div class="livepoker-rebate-game-bottom">
          <div class="livepoker-rebate-game-bottom-left-title">
            ...
            用户在3月25日的裂变宇宙第四季赛事中累计有效投注为3000元，则次日会员可登录优惠页面点击领取58元投注金。
          </div>
        </div>
      </div>
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              活动期间，活动仅计算电竞场馆中裂变宇宙第四季赛事，会员在当日裂变宇宙第四季赛事中累计有效投注≥500
          ...
          <div class="item">
            ...
            活动期间，活动仅计算裂变宇宙第四季 赛事当日累计有效投注，满足条件的会员可在次日 24 小时内在活动页面点击【点击领取】按钮领取。逾期未领取则视为放弃，彩金 6倍流水即可出款；
          </div>
          <div class="item">
