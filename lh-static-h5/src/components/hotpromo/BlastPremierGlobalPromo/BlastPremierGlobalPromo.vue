<template>
  <div class="cs2">
    <div class="section first">
      ...
      <div class="tips">
        <div class="tips-inner">每日投注 BLAST Premier 赛事达到≥100元即可获得开箱钥匙</div>
      </div>
      <div class="title">
    ...
    <div class="section third">
      ...
      <div class="content">
        <p>
          1. 活动期间,仅计算电竞场馆每日投注BLAST Premier 全球总决赛达到100元有效投注即可在次日12：00点左右自动获得1个开箱钥匙,开箱钥匙与开箱次数每日不设上限；
        </p>
        <p>
          2.
        ...
        <p>
          4. 活动期间,仅计算电竞场馆参与BLAST Premier 全球总决赛有效投注≥1,000元在次日12:00点左右获得签到天数,达到指定签到天数则可开启签到宝箱,每个宝箱每位用户仅可开启一次；
        </p>
        <p>
          5.
