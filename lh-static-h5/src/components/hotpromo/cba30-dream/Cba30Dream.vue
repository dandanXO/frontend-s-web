          ...
          <div class="livepoker-rebate-game-info">
            ...
            <div class="livepoker-rebate-game-bottom">
              <div class="livepoker-rebate-game-bottom-left-title">
                例：用户A在10月12日当天在常规赛辽宁本钢VS浙江稠州金租比赛中单笔下注2,000元客胜、500元总比分大小和500元客队让分，比赛最终赛果为客胜，根据规则会员可获得18元奖金，奖金仅需5倍水即可出款。
              </div>
            </div>
          </div>
          ...
          <div class="livepoker-rebate-game-bottom-rule">
            ...
            <div class="content">
              <div class="item">
                ...
                当前活动仅计算体育场馆，在CBA赛季期间内当日有效投注≥1,000 元并完成下注次数即可获得对应彩金，彩金只需5
                倍流水即可出款；
              </div>
              <div class="item">
