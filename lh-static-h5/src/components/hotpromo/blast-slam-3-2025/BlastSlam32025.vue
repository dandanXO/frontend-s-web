    ...
    <div class="livepoker-rebate-container">
      ...
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="little-title">
          ...
          <div class="right">2025年05月06日至2025年05月11日</div>
        </div>
        <div class="little-title">
          <div class="ribbon">活动内容</div>
          <div class="right">活动期间，会员在当日BLAST Slam III 赛事中累计有效投注≥1,500元在次日即可获得最高1,588元的奖励金！</div>
        </div>
        ...
        <div class="livepoker-rebate-game-bottom">
          <div class="livepoker-rebate-game-bottom-left-title">
            ...
            用户 A 在5月6日投注BLAST Slam III赛事有效投注 50,000 元，用户 A 在次日 24 小时内可获得彩金：288元
          </div>
        </div>
      </div>
        ...
        <div class="content">
          <div class="item">
            ...
            <div style="display: flex; flex-direction: column">
              活动期间，活动仅计算电竞场馆中BLAST Slam III赛事，会员在当日BLAST Slam III赛事中累计有效投注≥1,500元即可获得对应彩金，有效投注次日清零； 
              <div class="hint">注：奖金不叠加派发，奖金按最高档位每日派发一次。</div>
            </div>
          </div>
          <div class="item">
            <div class="item-num">2</div>
            活动期间，活动仅计算当日BLAST Slam III已结算的赛事总有效投注，次日 24 小时内在活动页面点击【点击领取】按钮领取。逾期未领取则视为放弃，彩金 6倍流水即可出款；
          </div>
          <div class="item">
