        ...
        <div class="box-area">
          <div v-for="(box,index) in sectionOneBoxItems" :key="box.requiredActivePoint" >
            <template v-if="index === 0">
              <img class="box"  :src="box.claimState === 'OPEN' ? require('./images/box-blue.png') : box.claimState === 'CLOSE' ? require('./images/box-blue-lock.png') : require('./images/box-blue-gray.png') " />
            </template>
            <template v-if="index === 1">
              <img class="box" :src="box.claimState === 'OPEN' ? require('./images/box-blue.png') : box.claimState === 'CLOSE' ? require('./images/box-blue-lock.png') : require('./images/box-blue-gray.png') " />
            </template>
            <template v-if="index === 2">
              <img class="box"  :src="box.claimState === 'OPEN' ? require('./images/box-purple.png') : box.claimState === 'CLOSE' ? require('./images/box-purple-lock.png') : require('./images/box-purple-gray.png') " />
            </template>
            <template v-if="index === 3">
              <img class="box"  :src="box.claimState === 'OPEN' ? require('./images/box-yellow.png') : box.claimState === 'CLOSE' ? require('./images/box-yellow-lock.png') : require('./images/box-yellow-gray.png') " />
            </template>
          </div>
        </div>
            ...
            <div class="task-left">
              ...
              <div>
                ...
                <div style="font-size: 12px;">
                  <img v-if="todayCheckInState === 'YES'" style="display: inline; vertical-align: middle;width: 12px; height: 12px;"  :src="require('./images/icon-done.png')">
  ...
  <q-dialog v-model="showSuccessDialog" persistent>
    <q-card class="win-rebate-model">
      <q-card-section class="row items-center justify-center">
        ...
        <img @click="showSuccessDialog = false" style="width: 122px; height: 43px;" :src="require('./images/success-4.png')">
      </div>
      </q-card-section>
    </q-card>
  </q-dialog>
    ...
    <q-card class="win-rebate-model">
      <q-card-section class="row items-center justify-center">
        <div class="dialog-header">
          ...
          <img @click="showErrorDialog = false" style="width: 122px; height: 43px;" :src="require('./images/failure-4.png')">
        </div>
      </q-card-section>
    </q-card>
  </q-dialog>
