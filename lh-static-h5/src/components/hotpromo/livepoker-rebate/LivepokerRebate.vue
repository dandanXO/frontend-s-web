      ...
      <div class="livepoker-rebate-section">
        <div class="livepoker-rebate-section-left">
          <div class="livepoker-rebate-section-title">
            <div><img src="../../../assets/images/promotion/hotpromo/lh-livepoker-rebate/section-title-img.png" style="width: 20px; height: 20px; margin-bottom: 0px;" /></div>
            每日彩金
          </div>
          <div class="reward-info">
            <div class="reward-info-icon">
              <img src="../../../assets/images/promotion/hotpromo/lh-livepoker-rebate/reward-icon1.png" alt="" width="100%">
            </div>
          ...
          <div class="reward-info">
            <div class="reward-info-icon">
              <img src="../../../assets/images/promotion/hotpromo/lh-livepoker-rebate/reward-icon2.png" alt="" width="100%">
            </div>
            <div class="reward-info-content">
              当日可领彩金：
              <span
        ...
        <div class="livepoker-rebate-section-right">
          <div class="bonus-image" @click="handleClaimBonus">
            <img src="../../../assets/images/promotion/hotpromo/lh-livepoker-rebate/reward-btn.png" alt="" width="100%" />
          </div>
        </div>
      </div>
