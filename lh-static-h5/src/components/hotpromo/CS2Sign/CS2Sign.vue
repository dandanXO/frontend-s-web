<template>
  <div class="cs2">
    <div class="section first">
      <div class="title"><img src="../../../assets/images/promo/hotpromo/cs2/fuli1.png" /></div>
      <div class="tips">
        ...
        <div class="middle-row">
          <div class="item-container">
            <!-- <div v-for="i in items" :key="i" class="item" :class="{ active: activeItem === i }" @click="setActiveItem(i)">
                <img :src="require(`../../../assets/images/promo/hotpromo/cs2/goldbox${i}.png`)" />
            ...
            >
              <img
                ...
                :src="require(`../../../assets/images/promo/hotpromo/cs2/${item.treasureLevel}.png`)"
              />
    ...
    <div class="section second">
      ...
      <div class="content">
        <div class="top-row">
          <div class="lft">
            <img src="../../../assets/images/promo/hotpromo/cs2/gun.png" />
            签到天数：
    ...
    <div class="section third">
      <div class="content">
        ...
        <p>7.任何会员或团体以不正常的方式进行套取活动优惠，平台方保留在不通知的情况下冻结或关闭相关账户的权利，并不退还款项，且会员会被列入黑名单;</p>
  ...
  .content {
    ...
    .top-row {
      ...
      .buttons {
        ...
        .btn {
          cursor: pointer;
          background: url(../../../assets/images/promo/hotpromo/cs2/metal-btn.png) no-repeat center center;
          padding: 20px 40px;
          color: #ffffff;
    ...
    .middle-row {
      ...
      .sign-container {
        ...
        .btn {
          ...
          &.toClaim {
            cursor: pointer;
            background: url(../../../assets/images/promo/hotpromo/cs2/btnbg-open.png) no-repeat center center;
            background-size: cover;
            color: #3d1600;
          }
          &.notComplete {
            cursor: default;
            background: url(../../../assets/images/promo/hotpromo/cs2/btnbg-close.png) no-repeat center center;
            background-size: cover;
            filter: grayscale(1);
          }
        }
...
.amt {
  ...
  .coin {
    flex: 6;
    // background: url(../../../assets/images/promo/hotpromo/cs2/coin.png)no-repeat center center;
    // margin-left: -100px;
    img {
      width: 100%;
    }
