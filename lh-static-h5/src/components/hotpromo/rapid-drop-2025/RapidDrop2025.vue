    ...
    <div class="livepoker-rebate-container">
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="little-title">
          ...
          <div class="right">2025年7月15日 00:00 - 2025年7月27日 23:59</div>
        </div>
        <div class="little-title">
          <div class="ribbon">活动内容</div>
          <div class="right">投注乘数与免费旋转，奖池每日16,000份奖励高达 ¥696,500</div>
        </div>
        ...
        <img src="../../../assets/images/promotion/hotpromo/rapid-drop-2025/rapid-games.png" alt="" width="100%" />
      </div>
