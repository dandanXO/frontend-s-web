      ...
      <div v-if="activeKey === 1" class="tab-content">
        <div class="tab-section">
          ...
          <div class="blue-content-para">
            ...
            <p class="red q-mt-lg">
              例：会员A邀请一位好友首存1,000元，会员A可获得58元，被邀请人可获得58元；若想获取下一档位108元，则需好友再次存1000元；
          ...
          <div class="blue-content-rules">
            ...
            <ol>
              ...
              <li>
                邀请人与受邀请人必须为不同身份的真实玩家，每每位有效玩家、手机号码、电子邮箱、银行卡、IP地址、每台设备只能使用一 个账号享受优惠，如发现有违规者我们将保留在任何时候都可以停止、取消优惠或索回已支付的全部优惠的权利。
              </li>
              <li>
