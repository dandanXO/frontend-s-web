<template>
  <q-page class="transfer-container">
    ...
    <div class="transfer-mid-div">
      <div class="station-notice-wrapper" @click="showAnnouncementDialog">
        <div class="volume">
          <img src="../../assets/images/home/announce-icon.svg" />
        </div>
  ...
  <CommonModal v-model="isShowAnnouncementDialog" header="信息" :actions="[]">
    <template #content>
      <template v-for="(announcement, i) in announcementList" :key="i">
        {{ announcement }}
      </template>
    </template>
  </CommonModal>
...
.account-tabs-div {
  ...
  .account-item {
    ...
    justify-content: center;
    align-items: center;
    background-image: url("../../assets/images/common/common-md-white-btn.png");
    background-size: 100% 100%;
