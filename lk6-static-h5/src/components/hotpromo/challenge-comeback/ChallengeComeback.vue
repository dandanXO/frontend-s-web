    ...
    <div class="livepoker-rebate-section">
      <div class="livepoker-rebate-section-left">
        <div class="livepoker-rebate-section-title">
          <div>
            <img
              src="../../../assets/images/promotion/hotpromo/dy2-challenge-comeback/section-title-img.png"
        ...
        <div class="reward-info">
          <div class="reward-info-icon">
            <img
              src="../../../assets/images/promotion/hotpromo/dy2-challenge-comeback/reward-icon1.png"
              alt=""
              width="100%"
            />
          </div>
        ...
        <div class="reward-info">
          <div class="reward-info-icon">
            <img
              src="../../../assets/images/promotion/hotpromo/dy2-challenge-comeback/reward-icon2.png"
              alt=""
              width="100%"
            />
          </div>
      ...
      <div class="livepoker-rebate-section-right">
        <div class="bonus-image" @click="handleClaimBonus" :class="{ disabled: bonus <= 0 }">
          <img src="../../../assets/images/promotion/hotpromo/dy2-challenge-comeback/claim-btn.png" alt="" width="100%" />
        </div>
      </div>
    </div>
...
.challenge-comeback-container {
  ...
  .challenge-comeback-block {
    ...
    .challenge-comeback-block-title {
      background: url(../../../assets/images/promotion/hotpromo/dy2-challenge-comeback/block-title-bg.png) no-repeat;
...
.livepoker-rebate-section {
  ...
  background: url("../../../assets/images/promotion/hotpromo/dy2-challenge-comeback/section-bg.png");
