export default {
  ...
  fields: {
    ...
    eggs: '달걀',
    memberInquiry: '회원문의',
    depositApplication: '입금 신청',
    withdrawApplication: '탈퇴 신청',
    affiliateApplication: '제휴 신청',
    totalMembers: '전체 회원',
  ...
  message: {
    ...
    verifyMinDayDepositAmountRequired: '일일 최소 입금액이 필요합니다',
    verifyMaxDayDepositAmountRequired: '일일 최대 입금액이 필요합니다',
  },
  menu: {
    undefined: '',
    Dashboard: '대시보드',
