export default {
  ...
  fields: {
    ...
    dateType: '日期类型',
    deduct: '扣除',
    deductMemberAmountAdjust: '扣除会员账变',
  ...
  message: {
    ...
    validateRebatePercentageRequired: '回扣率必填',
    ...
    validateSupportTypeRequired: '支援类型必填',
  ...
  error: {
    ...
    1000: '登录名或密码错误',
    1001: '登录失败, 账号已被禁用',
    1002: '登录失败, 账号已被封锁, 请于明日再尝试',
    1003: '登录失败, 账号不存在',
    1004: '该提款订单已经提交, 请于20分钟后在尝试',
    9000: '创建定时任务失败',
    9001: '更新定时任务失败',
    9002: '删除定时任务失败',
    10000: '请输入至少一个搜索条件',
    ...
    11002: '站点代理分红不存在',
    11003: '代理信息不存在',
    11004: '代理分红必须少于上级代理分红',
    11005: '代理分红必须多于下级代理分红',
    12000: '优惠名称已存在',
    12001: '优惠代码已存在',
    12010: '货币名称已存在',
    12011: '此站点已设置汇率',
