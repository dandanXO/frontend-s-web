export default {
  ...
  fields: {
    ...
    reviewRule: '审核规则',
    formMode: '表单模式',
    directEditMode: '直接编辑模式',
    enterRuleString: '直接输入规则字符串...',
    rewardGroup: '奖金组',
  ...
  message: {
    ...
    enterSabaTransactionId: '输入SABA注单号',
    ...
    logicalConflict: '逻辑冲突：变量 "{variable}" 同时具有比较运算符 (<, >) 和相等运算符 (==, !=)。这会造成逻辑不一致。',
