export default {
  ...
  summonFailReason: {
    ...
    SUMMONER_VIP_LEVEL_NOT_REACH: '唤醒人未达VIP要求',
    MEMBER_VIP_LEVEL_EXCEED_1: '被唤醒人超过VIP要求',
  ...
  fields: {
    ...
    needIpUniqueInMonth: '注册IP一个月内唯一',
  ...
  message: {
    ...
    validateAffiliateFbIdRequired: 'Facebook 像素ID必填',
  ...
  monitorTitle: {
    ...
    DOMAIN_VALID: '域名有效期',
    JOB_IDLE_CHECK_GAME_BET_RECORD_FETCH_TASK: '排程任务闲置',
  },
  domain: {
    domainMainType: {
      FRONTEND: '前台域名',
