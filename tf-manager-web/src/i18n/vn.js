export default {
  ...
  dashboard: {
    ...
    depositTransactionNumChartName: 'Số lần nạp tiền của thành viên / Số lượng giao dịch nạp tiền',
  ...
  summonFailReason: {
    ...
    MEMBER_HISTORY_DEPOSIT_AMOUNT_NOT_REACH: 'Số tiền nạp lịch sử của thành viên chưa đạt',
    ...
    MEMBER_AND_SUMMONER_SAME_REGISTER_DETAIL: 'Thông tin đăng ký của thành viên và người triệu hồi là giống nhau',
  ...
  fields: {
    ...
    redPacketMinDayBetAmount: 'Số tiền cược tối thiểu hàng ngày để nhận bao lì xì',
    rule: 'Quy tắc',
    ...
    superiorAffiliatePaymentChannel: 'Kênh Thanh Toán Của Đối Tác Liên Kết Cấp Cao',
    supplement: 'Bổ Sung',
    ...
    please_add_at_least_one_date_time: 'Vui lòng thêm ít nhất một ngày và một thời gian.',
    ...
    add_single_date_steps: 'Bước: Chọn phạm vi ngày và thời gian, sau đó nhấp vào "Thêm".',
    add_multiple_date_steps: 'Bước: Chọn tất cả các kết hợp của phạm vi ngày và thời gian, sau đó nhấp vào "Thêm phạm vi ngày" và "Thêm thời gian", sau đó nhấp vào "Thêm" để thêm chúng.',
    pick_date: 'Chọn ngày',
  ...
  message: {
    ...
    confirmCancelBbDacha: 'Bạn có chắc chắn muốn hủy BB Dacha này? Hành động này không thể hoàn tác.',
    confirmCancelMatch: 'Bạn có chắc chắn muốn hủy trận đấu này? Hành động này không thể hoàn tác.',
    confirmCancelQuiz: 'Bạn có chắc chắn muốn hủy bài kiểm tra này? Hành động này không thể hoàn tác.',
    confirmCancelRebate: 'Bạn có chắc chắn muốn hủy ghi nhận hoàn tiền này? Hành động này không thể hoàn tác.',
    confirmCopy: 'Bạn có muốn sao chép không?',
    confirmCopyTo: 'sao chép đến',
    confirmDelete: 'Bạn có chắc chắn muốn xóa dữ liệu này? Hành động này không thể hoàn tác.',
    confirmRunAtOnce: 'Bạn có muốn chạy hành động này ngay bây giờ không? (Hành động sẽ được thực hiện ngay cả khi bị vô hiệu hóa)',
    confirmDelivered: 'Bạn có đã giao hàng thành công chưa? Hành động này không thể hoàn tác.',
    confirmEndMatch: 'Bạn có chắc chắn muốn kết thúc trận đấu này? Hành động này không thể hoàn tác.',
    confirmRebate: 'Bạn có chắc chắn muốn phân phối tất cả hoàn tiền không? Hành động này không thể hoàn tác.',
    confirmBatchRebate: 'Vui lòng xác nhận phân phối hoàn tiền cho các mục đã chọn. Hành động này không thể hoàn tác.',
    confirmSingleRebate: 'Vui lòng xác nhận phân phối hoàn tiền cho mục này. Hành động này không thể hoàn tác.',
    confirmRedeem: 'Bạn có chắc chắn muốn đổi món quà này thành tiền mặt không? Hành động này không thể hoàn tác.',
    confirmRefer: 'Bạn có chắc chắn muốn phân phối tất cả chương trình giới thiệu không? Hành động này không thể hoàn tác.',
    confirmReset: 'Bạn có chắc chắn muốn đặt lại dữ liệu này không? Hành động này không thể hoàn tác.',
    ...
    confirmToChecking: 'Bạn có chắc chắn muốn chuyển thanh toán này thành kiểm tra không?',
    ...
    giftNoCashRedeemAmount: "không có số tiền đổi quà thành tiền mặt. Vui lòng thiết lập số tiền đổi quà thành tiền mặt trước.",
    ...
    memberFreeGameLogin: "tên đăng nhập, nếu nhiều hơn một, hãy phân tách bằng dấu phẩy (tối đa 200 người)",
    memberFreeGameRound: "vòng chơi game miễn phí",
    memberFreeGameIds: "có thể sử dụng ID game và nếu nhiều hơn một, hãy phân tách bằng dấu phẩy. Độ dài tối đa (bao gồm cả dấu phẩy) là 200",
    multipleQuerySeparatedBySpace: "điều kiện truy vấn nhiều được phân tách bằng dấu cách",
    ...
    paymentUpdate: "Bạn có muốn sao chép sang một phương thức hoặc một cấp độ khác không? Nếu không, hãy nhấn nút Cập nhật",
    paySuccess: "Thanh toán thành công",
    pleaseEnterAffiliateNameOrAffiliateCode: "Vui lòng nhập tên đối tác hoặc mã đối tác",
    promoDistributionSuccess: "Phân phối khuyến mãi thành công",
    redeemCashSuccess: "Đổi tiền mặt thành công",
    reenterPassword: "Nhập lại mật khẩu",
    rebateSuccess: "Phân phối hoàn tiền VIP đang được xử lý. Vui lòng kiểm tra lại sau để xem lịch sử.",
    registerSuccess: "Đăng ký thành công",
    registerSuccessInd: "Đăng ký thành công. Vui lòng thiết lập cài đặt hiển thị tiền gửi của đối tác mới.",
    ...
    selectDateNotMoreThan3Month: "Phạm vi ngày không được vượt quá 3 tháng. Vui lòng chọn lại",
    selectPreviousLevel: "Chọn cấp độ trước",
    selectSiteFirst: "Vui lòng chọn trang web trước",
    selectSiteAndGameTypeFirst: "Vui lòng chọn trang web và loại trò chơi trước",
    ...
    success: "Thành công",
    summarySuccess: "Tóm tắt cho khoảng thời gian đã nhập sẽ được tạo. Vui lòng kiểm tra lại sau để xem lịch sử.",
    ...
    validateAnswerOneAtLeastTwoChoices: "Câu trả lời cho câu hỏi 1 cần ít nhất hai lựa chọn",
    validateAnswerTwoRequired: "Câu trả lời cho câu hỏi 2 là bắt buộc",
    validateAnswerTwoAtLeastTwoChoices: "Câu trả lời cho câu hỏi 2 cần ít nhất hai lựa chọn",
    validateAnswerThreeRequired: "Câu trả lời cho câu hỏi 3 là bắt buộc",
    validateAnswerThreeAtLeastTwoChoices: 'Câu hỏi 3 cần có ít nhất hai lựa chọn',
    ...
    validateCustomerSupportAddressFormat: 'Địa chỉ hỗ trợ khách hàng không hợp lệ',
    ...
    validateMaxDailyWithdrawNumber: 'Số tiền rút tối đa không thể nhỏ hơn hoặc bằng 0',
    validateMaxDailyWithdrawGreater: 'Số tiền rút tối đa phải lớn hơn số tiền rút tối thiểu',
    validateMaxDailyWithdrawTimesRequired: 'Yêu cầu số lần rút tối đa hàng ngày',
    validateMaxDailyWithdrawTimesNumber: 'Số lần rút tối đa không thể nhỏ hơn hoặc bằng 0',
    validateMaxDepositRequired: 'Yêu cầu số tiền nạp tối đa',
    validateMaxDepositGreater: 'Số tiền nạp tối đa phải lớn hơn số tiền nạp tối thiểu',
    validateMaxWithdrawAmountRequired: 'Yêu cầu số tiền rút tối đa',
    validateMaxWithdrawAmountNumber: 'Số tiền rút tối đa không thể nhỏ hơn hoặc bằng 0',
    validateMaxWithdrawAmountGreater: 'Số tiền rút tối đa phải lớn hơn số tiền rút tối thiểu',
    ...
    validateMinDepositLesser: 'Số tiền nạp tối thiểu không thể lớn hơn số tiền nạp tối đa',
    validateMinWithdrawRequired: 'Yêu cầu số tiền rút tối thiểu',
    validateMinWithdrawNumber: 'Số tiền rút tối thiểu không thể nhỏ hơn hoặc bằng 0',
    validateMinWithdrawLesser: 'Số tiền rút tối thiểu không thể lớn hơn số tiền rút tối đa',
    ...
    validatePayTypeNameCodeDifferent: 'Tên và mã loại thanh toán không thể giống nhau',
  ...
  menu: {
    ...
    "Affiliate Monthly Settlement Detail": "Chi tiết thanh toán hàng tháng Đối tác liên kết",
    ...
    "Crypto Affiliate Payment on going": "Đang thanh toán Đối tác liên kết tiền điện tử",
    "Ewallt Affiliate Payment on going": "Đang thanh toán Đối tác liên kết ví điện tử",
    "Alipay Affiliate Payment on going": "Đang thanh toán Đối tác liên kết Alipay",
  ...
  google: {
    ...
    popup_msg: "Google Xác thực là công cụ mật khẩu động tự động làm mới mỗi 30 giây. Khi thực hiện các hoạt động nhạy cảm như chuyển khoản tiền, rút tiền hoặc điều chỉnh cài đặt bảo mật trên backend, bạn cần nhập mã xác minh 6 chữ số này để xác thực.",
    ...
    if_cannot_download_you_can: "2. Nếu không thể tải xuống, bạn có thể tìm kiếm trên Apple App Store.",
    ...
    tips_installed: "Mẹo: Sau khi tải xuống và cài đặt xong, nhấn \"Tiếp theo\" để tiếp tục.",
    qr_code: "Mã QR",
    secret_key: "Khóa bí mật",
    add_step: "Bước thêm",
    add_step_desc: "Mở Google Xác thực, nhấn vào \"+\" ở góc phải dưới cùng, chọn \"Nhập khóa bằng tay\" và nhập khóa bí mật được đề cập trước và liên kết với tài khoản bạn muốn. (Bạn có thể tự động thêm bằng cách quét mã QR.)",
    check_example: "Xem ví dụ",
    back: "Quay lại",
    small_tips: "Mẹo nhỏ:",
    small_tips_info_1: "1. Nếu bạn mất điện thoại hoặc xóa ứng dụng xác thực, bạn có thể khôi phục xác thực bằng cách sử dụng khóa bảo mật. Hãy lưu trữ khóa một cách an toàn.",
    small_tips_info_2: "2. Để bảo vệ an ninh tài khoản, không hiển thị tài khoản proxy và địa chỉ backend proxy trong quá trình liên kết.",
    ...
    if_not_google_auth_then: "Nếu bạn chưa liên kết Google Xác thực, bạn có thể bỏ qua bước này.",
