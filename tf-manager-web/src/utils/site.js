...
export const isCnySite = siteId => {
  return (
    parseInt(siteId) === XF_SITE_ID ||
    parseInt(siteId) === DY_SITE_ID ||
    parseInt(siteId) === LH_SITE_ID
  )
}
...
export const isPak = siteId => {
  return (
    parseInt(siteId) === PAK_SITE_ID ||
    parseInt(siteId) === PAK2_SITE_ID ||
    parseInt(siteId) === BGD_SITE_ID ||
    parseInt(siteId) === BPK_SITE_ID ||
    parseInt(siteId) === PK4_SITE_ID
  )
}
...
export const isLk6 = siteId => {
  return parseInt(siteId) === LK6_SITE_ID
}
