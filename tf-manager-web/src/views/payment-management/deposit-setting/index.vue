  ...
  <div class="roles-main">
    ...
    <el-row v-show="isShow">
          ...
          <div class="form-body">
            ...
            >
              <el-form-item :label="t('fields.minDeposit')" prop="depositMin">
                <el-input v-if="!hasRole(['SUB_TENANT']) && hasPermission(['sys:payment:deposit-set:update'])" v-model="form.web.depositMin" style="width: 200px" maxlength="10" />
              ...
              <el-form-item :label="t('fields.maxDeposit')" prop="depositMax">
                <el-input v-if="!hasRole(['SUB_TENANT']) && hasPermission(['sys:payment:deposit-set:update'])" v-model="form.web.depositMax" style="width: 200px" maxlength="10" />
      ...
      <el-col :span="4" style="margin-left: 10px;">
        <div class="form-border">
          ...
          <div class="form-body">
            ...
            >
              <el-form-item :label="t('fields.minDeposit')" prop="depositMin">
                <el-input v-if="!hasRole(['SUB_TENANT']) && hasPermission(['sys:payment:deposit-set:update'])" v-model="form.mobile.depositMin" style="width: 200px" maxlength="10" />
                <el-input v-else v-model="form.mobile.depositMin" style="width: 200px" maxlength="10" disabled />
              </el-form-item>
              <el-form-item :label="t('fields.maxDeposit')" prop="depositMax">
                <el-input v-if="!hasRole(['SUB_TENANT']) && hasPermission(['sys:payment:deposit-set:update'])" v-model="form.mobile.depositMax" style="width: 200px" maxlength="10" />
      ...
      <el-col :span="1" style="margin-left: 10px;">
        <el-button v-if="!hasRole(['SUB_TENANT']) && hasPermission(['sys:payment:deposit-set:update'])" type="primary" @click="submit">{{ t('fields.update') }}</el-button>
