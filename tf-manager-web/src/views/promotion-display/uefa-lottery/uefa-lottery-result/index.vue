  ...
  <div class="roles-main">
    ...
    <el-card class="box-card" shadow="never" style="margin-top: 40px">
      ...
      >
        ...
        <el-table-column
          prop="firstPrizeWinner"
          :label="t('lottery.prizeLevel.FIRST_PRIZE')"
          min-width="150"
        />
        <el-table-column
          prop="groupThreeWinner"
          :label="t('lottery.prizeLevel.GROUP_THREE')"
          min-width="150"
        />
        <el-table-column
          prop="groupSixWinner"
          :label="t('lottery.prizeLevel.GROUP_SIX')"
          min-width="150"
        />
        <el-table-column
          prop="twoDWinner"
          :label="t('lottery.prizeLevel.TWO_D')"
          min-width="150"
        />
      </el-table>
      <el-pagination
...
import {
  getUefaLotteryResults,
  addLotteryResult,
  getUefaLotteryPrivilege,
...
async function loadResults() {
  ...
  const { data: ret } = await getUefaLotteryResults(query)
