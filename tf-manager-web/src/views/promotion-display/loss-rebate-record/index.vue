<template>
  <div class="roles-main">
      ...
      <div class="search">
        ...
        <div class="btn-group">
          ...
          <el-button
            ...
            size="mini"
            type="warning"
            v-permission="['sys:loss-rebate-record:export']"
            @click="exportExcel"
    ...
    <el-card class="box-card" shadow="never" style="margin-top: 20px">
      <template #header>
        <div class="clearfix">
          <span class="role-span">{{ t('fields.lossRebateRecord') }}</span>
        </div>
      </template>
...
import { adjustAmount, distribute, getTotal, getLossRebateRecord } from '../../../api/loss-rebate-record';
