<template>
  <div class="roles-main">
    <div class="header-container">
      ...
      <div class="btn-group">
        <el-button
          size="mini"
          type="success"
          v-permission="['sys:sport-match-record:update']"
    ...
    >
      ...
      <el-table-column :label="t('fields.operate')" align="center" v-if="!hasRole(['SUB_TENANT']) && hasPermission(['sys:sport-match-record:update'])" fixed="right" width="280">
        <template #default="scope">
          <el-button
