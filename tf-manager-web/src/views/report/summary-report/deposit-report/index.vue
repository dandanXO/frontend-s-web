    ...
    <div class="header-container">
      <div class="search">
        ...
        <el-button
          size="mini"
          type="primary"
          v-permission="['sys:report:summary:deposit:export']"
...
import { getSummaryDepositReport, getExportSummaryDepositReport } from '../../../../api/report-summary'
...
async function loadSummaryDepositRecord() {
  page.loading = true
  ...
  const { data: ret } = await getSummaryDepositReport(query)
...
onMounted(async () => {
  ...
  await loadSummaryDepositRecord()
})
...
async function requestExportExcel() {
  ...
  const { data: ret } = await getExportSummaryDepositReport(query);
  if (ret) {
