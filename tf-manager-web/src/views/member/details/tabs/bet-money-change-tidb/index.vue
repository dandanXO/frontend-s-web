...
import {
  getBetMoneyChangeTidb,
  requestBetMoneyChangeExportTidb,
  updateBetStatusTypeTidb,
...
async function loadMemberBetMoneyChange(frombutton) {
  ...
  const { data: ret } = await getBetMoneyChangeTidb(query)
...
async function requestExportExcel() {
  ...
  const { data: ret } = await requestBetMoneyChangeExportTidb(query)
  if (ret) {
...
async function editBetStatusType() {
  ...
  await updateBetStatusTypeTidb(query);
