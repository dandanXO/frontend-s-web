...
import {
  ...
  getAllAffiliateWithdrawRecordPay,
...
async function loadRecord() {
  ...
  const { data: ret } = hasPermission(['sys:withdraw:all:pay']) ? await getAllAffiliateWithdrawRecordPay(query) : await getAffiliateWithdrawRecordPay(query)
