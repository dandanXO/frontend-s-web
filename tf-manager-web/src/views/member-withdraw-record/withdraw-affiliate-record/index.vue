      ...
      >
        ...
        >
          <template #default="scope">
            ...
            <el-button
              v-if="scope.row.status === 'SUCCESS' && hasPermission(['sys:withdraw:affiliate-fail'])"
              size="mini"
              type="danger"
...
import {
  ...
  getExportAffiliateWithdrawRecord,
...
async function requestExportExcel() {
  ...
  const { data: ret } = await getExportAffiliateWithdrawRecord(query);
  if (ret) {
