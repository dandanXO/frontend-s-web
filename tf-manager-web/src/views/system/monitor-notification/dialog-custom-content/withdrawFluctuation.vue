<template>
  <div>
    <el-form ref="formRef" :model="formData" :rules="rules" class="combined-form" label-width="auto">
      ...
      <el-form-item label="回推时段(小时)" prop="monitorSetting.setting.totalWithdrawLastHours">
        <el-input-number :min="1" :step="1" v-model="formData.monitorSetting.setting.totalWithdrawLastHours" :disabled="formData.monitorSetting.setting.scanMode !== 'LAST_HOURS'" />
      </el-form-item>
