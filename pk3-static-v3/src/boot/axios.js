...
var rstApi = getInitApi(rstArray, "PK3_RST_URL");
var crtApi = getInitApi(crtArray, "PK3_CRT_URL");
var evtApi = getInitApi(evtArray, "PK3_EVT_URL");
...
export default boot(({ app, router }) => {
  ...
  const onResponse = (response) => {
    ...
    if (res.code !== ResponseCode.SUCCESS) {
      ...
      if (res.code === ResponseCode.ERROR_DEPOSIT_SUGGESTION_AMOUNT) {
        return res;
      }
