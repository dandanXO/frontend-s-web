  ...
  <q-layout view="hHh Lpr fFf">
    <q-header v-if="hasPage">
      ...
      <q-card-section class="page-title" v-if="hasPage">
        ...
        {{ pageName }}
        <q-btn v-if="hasDrawer" style="position:absolute; right: 10px;" flat @click="ui.drawerRight = !ui.drawerRight" round dense icon="menu" />
      </q-card-section>
    ...
    <div class="platforms">
      ...
      <q-scroll-area class="fit">
        <div class="q-pa-sm platform-list">
          <q-btn @click="changePlatform(plat)" size="xs" color="brightbtn" v-for="(plat, n) in platformsList" :key="n" :label="plat.icon" />
        </div>
      </q-scroll-area>
    </q-drawer>
    <!-- <q-scroll-area
