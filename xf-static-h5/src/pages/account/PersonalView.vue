<template>
  <div class="personal-account">
    ...
    <q-form>
      ...
      <q-input label="生日" 
        label-color="secondary"
        color="secondary" lazy-rules class="q-pb-xs" hide-bottom-space filled v-model="formDetail.birthday" mask="date" :rules="[ val => val && val.length > 0 || '请输入生日']">
      ...
      >
        <template v-slot:append>
          <q-btn size="sm" color="bright" label="验证" />
        </template>
      </q-input>
      <div class="text-center">
       <q-btn type="submit" label="更新信息" color="brightbtn" />
      </div>
    </q-form>
  </div>
