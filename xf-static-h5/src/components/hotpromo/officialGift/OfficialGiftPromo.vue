...
.body--dark {
  ...
  .official-gift-block {
    ...
    .official-gift-block-title {
      background: url(../../../assets/images/promotion/hotpromo/official-gift/h5-title-dark.png) no-repeat;
...
.official-gift-block {
  ...
  .official-gift-block-title {
    background: url(../../../assets/images/promotion/hotpromo/official-gift/h5-title.png) no-repeat;
    background-size: contain;
    aspect-ratio: 337 / 20;
    margin: 0 auto;
    font-size: 1.2rem;
