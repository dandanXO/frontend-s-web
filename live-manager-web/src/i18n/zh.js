export default {
  ...
  stream: {
    ...
    vertical: '垂直',
    host: '主播',
    supplierStreamID: '供应商串流ID',
    hostStreamID: '主播串流ID',
    currentQuality: '当前质量',
    supplierPlaybackLink: '供应商播放链结',
    hostPlaybackLink: '主播播放链结',
    hostPushLink: '主播推流链结',
    supplierPlayer: '供应商播放器',
    hostPlayer: '主播播放器',
  },
  sensitiveWord: {
    sensitiveWord: '敏感字',
  ...
  fields: {
    ...
    unblockSuccess: '解封成功',
    blockSuccess: '封锁成功',
    blockFailed: '封锁用戶失敗，請稍後再試',
    streamerLogin: '主播登录',
    adminLogin: '管理员登录',
    unableLoadBlockList: '无法载入封锁列表',
    streamerStatus: '主播状态',
    other: '其他',
    end: '结束',
    prepare: '准备中',
  ...
  message: {
    ...
    validateBlockReasonRequired: '请填写完整的封锁资讯',
    roomTitleUpdatedSuccess: '房间标题更新成功',
    cancelEditRoomTitle: '取消修改房间标题',
  },
