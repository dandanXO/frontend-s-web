  ...
  <div class="wrapper">
    <div class="affiliate">
      ...
      <div class="information">
        ...
        <div class="boxes">
          <div class="box">
            ...
            <div class="bx-table">
              ...
              <div class="rw-rgt">433,000x30%= 129,900</div>
            </div>
          </div>
        </div>
        ...
        <div class="boxes">
          <div class="box">
            <p>{{ $t("lang.affiliate_example_b") }}</p>
            <div class="bx-table">
              <div class="rw-left">
                {{ $t("lang.affiliate_example_b_table_1_left") }}
              </div>
              <div class="rw-rgt">500,000</div>
            </div>
            <div class="bx-table">
              <div class="rw-left">
                {{ $t("lang.affiliate_example_b_table_2_left") }}
              </div>
              <div class="rw-rgt">15,000</div>
            </div>
            <div class="bx-table">
              <div class="rw-left">
                {{ $t("lang.affiliate_example_b_table_3_left") }}
              </div>
              <div class="rw-rgt">2%</div>
            </div>
            <div class="bx-table">
              <div class="rw-left">
                {{ $t("lang.affiliate_example_b_table_4_left") }}
              </div>
              <div class="rw-rgt">8%</div>
            </div>
            <div class="bx-table">
              <div class="rw-left">
                {{ $t("lang.affiliate_example_b_table_5_left") }}
              </div>
              <div class="rw-rgt">600,000</div>
            </div>
            ...
            <div class="bx-table">
              <div class="rw-left">
                {{ $t("lang.affiliate_example_b_table_7_left") }}
              </div>
              <div class="rw-rgt">433,000x50%= 216,500</div>
            </div>
          </div>
        ...
        <div class="game-title sub">
          {{ $t("lang.downline_partners_title") }}
        </div>
        <p>{{ $t("lang.downline_partners_para") }}</p>
        <div class="game-title sub">
          {{ $t("lang.steps_for_receiving_commission") }}
        </div>
        <ol>
          <li>
  ...
  .affiliate {
    ...
    .information {
      ...
      .table {
        ...
        :deep(.ant-table .ant-table-thead > tr > th:nth-child(odd)),
        :deep(.ant-table .ant-table-tbody > tr > td:nth-child(odd)) {
          background: #303450;
        }
      }
      .boxes {
