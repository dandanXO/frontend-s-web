  ...
  <div class="main-section">
    <div class="q-pa-xs">
      <div class="q-gutter-y-xs">
        ...
        <!--        </div>-->
        <q-card>
          <q-form v-if="!isEmailSent" class="q-gutter-y-xs rounded-borders q-pa-xs q-ma-xs">
            <q-input
              ref="loginNameRef"
              filled
          ...
          <q-form v-if="isEmailSent" class="q-gutter-y-md rounded-borders q-pa-md bg-primary q-ma-md">
            ...
            <q-input
              ...
              lazy-rules
              :rules="[(val) => (val && val.length > 0) || $t('lang.enter_new_password')]"
              color="white"
              autocomplete="off"
            >
              <template v-slot:prepend>
