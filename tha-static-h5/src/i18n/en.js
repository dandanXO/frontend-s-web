export default {
  lang: {
    ...
    affiliate_calulate_para_1_1: "Affiliate Net Profit = (Total Win/Loss) - (Total Bonus) - (Bank Transaction Fee) - (Platform Fee) => In it: Total Win/Loss = Total Bets - Total Payouts",
    affiliate_calulate_para_1_2: "Bank Transaction Fee:( Deposit + Withdrawal) x 8%",
    ...
    affiliate_example_a_table_3_left: "- Bank Transaction Fee:",
    ...
    affiliate_example_b_table_3_left: "- Bank Transaction Fee:",
    ...
    event_details_content: "Jolly88 member opens: Personal - Click 'Invite Friends' to copy the promotion link, share via Facebook, LINE, Instagram, WhatsApp, Telegram, and YouTube, etc. When successfully inviting friends, receive instant cash rewards!",
    share_now: "Share Now",
    level_grade: "Level",
