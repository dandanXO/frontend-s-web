export default {
  lang: {
    ...
    withdraw_method: "วิธีถอนเงิน",
    verification_account: "การตรวจสอบบัญชี",
    withdraw_money: "ถอนเงิน",
    select_bank_account: "เลือกบัญชีธนาคาร",
    please_select_bank_account: "โปรดเลือกบัญชีธนาคาร",
    no_usable_cards: "ไม่มีบัตรที่สามารถใช้งานได้",
    add_card: "เพิ่มบัตร",
    please_enter_the_amount: "กรุณาใส่จำนวนเงินที่ต้องการถอน",
    enter_amount_money: "ใส่ยอดเงิน",
    amount_should_more_than_min: "จํานวนเงินควรเป็นไปตามที่กำหนด",
    amount_should_less_than_max: "จํานวนเงินควรเป็นไปตามที่กำหนด",
    min_max_amount: "วงเงินต่ำสุด/วงเงินสูงสุด",
    withdrawal_today: "ถอนวันนี้: ",
    remaining: " เหลือ: ",
    attempt_time:" ครั้ง",
