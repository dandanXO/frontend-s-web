<template>
                ...
                <div class="mail-action-container">
                  <div class="left">
                    <div v-if="isShowSelect" class="mail-action" @click="deleteMultipleMsg()">
                      <div>
                        <img src="../../assets/images/account/icon-maildelete.png" />
                    </div>
                      删除
                    </div>
  ...
  import {
    ...
    readMultipleMail,
    deleteMultipleMail,
    mailUnreadTotal as getUnreadTotal,
    readMail
