<template>
  ...
  <!--          <VueQRCodeComponent :size="150" :text="referralLink" />-->
  <!--          &lt;!&ndash; <qr-code :text="referralLink" error-level="L"></qr-code> &ndash;&gt;-->
  <!--          &lt;!&ndash; <img src="../../assets/images/account/share/qr_code.png" /> &ndash;&gt;-->
  <!--        </div>-->
  <!--        <div class="right-container">-->
  ...
  <!--        </div>-->
  <!--      </div>-->
  <!--&lt;!&ndash;      <div class="otherlinks">&ndash;&gt;-->
  <!--&lt;!&ndash;        <span class="note">备注：您的邀请奖励还未被分享。</span>&ndash;&gt;-->

  <!--&lt;!&ndash;        <div class="links">&ndash;&gt;-->
  <!--&lt;!&ndash;          <RiFacebookCircleLine /><RiWhatsappLine />&ndash;&gt;-->
  <!--&lt;!&ndash;          <RiTelegramLine /><RiTwitterLine />&ndash;&gt;-->
  <!--&lt;!&ndash;          <RiInstagramLine />&ndash;&gt;-->
  <!--&lt;!&ndash;        </div>&ndash;&gt;-->
  <!--&lt;!&ndash;      </div>&ndash;&gt;-->
  <!--    </div>-->
  <!--  </div>-->
...
import { getReferralLink, getInviteFriendListCount, getReferredBonus } from "@/api/personal/share"
