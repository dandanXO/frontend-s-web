  ...
  <div class="platform-title">
    ...
    <div class="flex-wrapper">
      ...
      <div class="platform-list-box" :class="pageType">
            ...
            :key="i"
            @click="pageType === 'SLOT' ? openSlotGame(plat.name, plat.code) : openGame(plat.name, plat.code, plat.gameCode)"
            ...
            >
              ...
              <template v-else>
                <img :src="require(`./img/${pageType.toLowerCase()}/${pageType.toLowerCase()}-img-${plat.code.toLowerCase()}.png`)">
                <div class="bottom">
                  <div class="txt">
                    <img :src="require(`./img/${pageType.toLowerCase()}/${pageType.toLowerCase()}-logo-${plat.code.toLowerCase()}.png`)">
    ...
    useScriptTag(
      ...
      return result;
        ...
        Ticker.prototype.showJackpot = function()
        {
          ...
          var text = "LOADING...";
          if (newvalue > 0) {
            text = (this.signpos != 0 ? formatNumberWithSpans(newvalue) + this.sign
              : this.sign + formatNumberWithSpans(newvalue));
          }
