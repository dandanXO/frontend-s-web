  ...
  <div class="official-gift-container">
    ...
    <div class="official-gift-block detail-block">
      ...
      <div class="detail-block-content">
        ...
        <img
          class="detail-block-content-suffix"
          src="../../../assets/images/promotion/hotpromo/official-gift/detail-block-suffix.png"
        />
      </div>
    </div>
...
import QuestionSvg from "../../../assets/images/promotion/hotpromo/official-gift/question.svg";
import StackSvg from "../../../assets/images/promotion/hotpromo/official-gift/stack.svg";
import ClockSvg from "../../../assets/images/promotion/hotpromo/official-gift/clock.svg";
import DateSvg from "../../../assets/images/promotion/hotpromo/official-gift/date.svg";
import ThumbSvg from "../../../assets/images/promotion/hotpromo/official-gift/thumb.svg";
...
.dark {
  ...
  .official-gift-block {
    ...
    .official-gift-block-title {
      max-width: 966px;
      margin: 0 auto;
      background: url("../../../assets/images/promotion/hotpromo/official-gift/web-title-dark.png") no-repeat;
...
.official-gift-block {
  ...
  .official-gift-block-title {
    ...
    max-width: 966px;
    margin: 0 auto;
    background: url("../../../assets/images/promotion/hotpromo/official-gift/web-title.png") no-repeat;
    background-size: contain;
    height: 44px;
    width: 100%;
    // background: url(@/components/hotpromo/officialGift/img/block-title-bg.png) no-repeat;
...
.download-block {
  ...
  align-items: center;
  padding: 40px 80px;
  background: url(../../../assets/images/promotion/hotpromo/official-gift/download-block-bg.png) no-repeat;
  background-size: cover;
