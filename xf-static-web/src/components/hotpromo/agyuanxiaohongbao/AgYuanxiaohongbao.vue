    ...
    <div class="livepoker-rebate-container">
      <div class="livepoker-rebate-game-info section-bg">
        ...
        <div class="little-title" style="flex-wrap: nowrap; flex-direction: unset">
          ...
          <div class="right">
            2025 年 2 月 18 日至 2 月 20 日，每日两场活动时间 下午场 15:00 至 15:20(北京时间) 晚间场 22:00 至 22:20(北京时间
          </div>
        </div>
        ...
        <div class="step-wrapper">
          ...
          <div class="step-content">
            <div class="step-item">
              ...
              <div style="margin-top: 24px">
                <img class="logo-img" src="./images/stepO1.png" alt="" />
              </div>
              <div>
            ...
            <div class="step-item">
              ...
              <div style="width: 90%; height: 1px; background-color: rgba(172, 212, 246, 1)"></div>
              <div style="margin-top: 24px">
                <img class="logo-img" src="./images/stepO2.png" alt="" />
              </div>
              <div>
            ...
            <div class="step-item">
              ...
              <div style="width: 90%; height: 1px; background-color: rgba(172, 212, 246, 1)"></div>
              <div style="margin-top: 24px">
                <img class="logo-img" src="./images/stepO3.png" alt="" />
              </div>
              <div>
                <p style="text-align: center; margin-top: 12px">
                  在指定时间内累计有效投注金额，挑战更高红包等级与奖金。
                </p>
              </div>
            </div>
            <div class="step-item">
              ...
              <div style="width: 90%; height: 1px; background-color: rgba(172, 212, 246, 1)"></div>
              <div style="margin-top: 24px">
                <img class="logo-img" src="./images/stepO4.png" alt="" />
              </div>
              <div>
