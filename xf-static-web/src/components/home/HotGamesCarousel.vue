        ...
        >
          <el-carousel-item v-for="(page, index) in paginatedItems" :key="index">
            <div class="carousel-grid">
              <div @click="openGame(item.label, item.platformCode, item.code)" class="carousel-item" v-for="item in page" :key="item.id">
                <div class="image-container">
                  <img :src="`${imgURL}/game/${item.icon}` || defaultImage" alt="Item image" class="carousel-image" @error="onImageError" />
                </div>
