export default {
  ...
  home: {
    ...
    futureGaming: "The future of gaming is here.Great games on all devices.KAKA App",
  ...
  affiliate: {
    ...
    afftnc4:
      "KAKA monitors all affiliate’s users and has its own criterion (risk level, deposit amount, betting index…) when evaluating such users. If they fail to meet the criteria, KAKA reserves the right to refuse to release commission to the affiliate.",
  ...
  vip: {
    ...
    tnc1: "When a member meets the level-up conditions, the system will immediately update to the new VIP level. There is no limit to the number of VIP level-ups and the number of times you can receive VIP level-up bonuses each day.",
    tnc2: "Level-up bonus: After reaching a new VIP level, members can click the CLAIM button on the VIP page to receive the level-up bonus.",
    tnc3: "Retention condition: Members need to maintain valid bets as stated above within 30 days after leveling up to maintain their level. If the valid bets are not completed within 30 days, the member will be downgraded by one level. The system ends the statistics at 23:59 on the 30th day.",
    tnc4: "Monthly bonus: From 01:00 on the 1st to 23:59 on the 7th of each month, members need to contact 24/7 customer service to receive the monthly bonus. If overdue, it is considered forfeited.",
    tnc5: "Birthday bonus: After registering an account and having a deposit history of at least 15 days, members need to contact 24/7 customer service on their birthday to receive the bonus.",
    tnc6: "Each member can only receive the level-up bonus once for each VIP level.",
    tnc7: "The bonus only requires 1x betting turnover to withdraw.",
    tnc8: "This VIP member program can be combined with other KAKAGAME promotions.",
    tnc9: "To avoid misunderstanding of the text, KAKAGAME reserves the final interpretation right and can change, reject, or cancel this VIP member program without prior notice.",
    ...
    upgrade: "LEVEL UP BONUS",
    birthday: "BIRTHDAY",
    monthly: "MONTHLY",
    tableHeader1: "VIP Level",
    tableHeader2: "Total Valid Bets",
    tableHeader3: "Accumulated Deposits",
    tableHeader4: "Retention Condition",
    tableHeader5: "Level-Up Bonus",
    tableHeader6: "Monthly Bonus",
    tableHeader7: "Birthday Gift",
    tableHeader8: "Daily Withdrawal Limit",
    tableHeader9: "Daily Withdrawal Limit Amount",
    header1: "ROYAL VIP PROMOTION, ENJOY REWARDS",
    target: "PARTICIPANTS: ",
    targetdet: "ALL MEMBERS OF KAKAGAME",
    duration: "DURATION: ",
    durationdet: "FROM ACCOUNT REGISTRATION UNTIL ANNOUNCED END",
    note: "Note: ",
    notedet: "1 point = 1000 VND"
  },
  app: {
  ...
  lottery: {
    loto: "Lottery at KAKA offers attractive odds and diverse betting options, with fast payouts after the draw.",
    gpi: "Lottery at KAKA offers attractive odds and diverse betting options, with fast payouts after the draw.",
    tcg: "Lottery at KAKA offers attractive odds and diverse betting options, with fast payouts after the draw."
  },
  livecasino: {
