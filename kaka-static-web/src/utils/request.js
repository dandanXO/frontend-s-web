...
if(isGlobalVN){
  ...
  var rstApi = getInitApi(rstGlobalArray, "KAKA_WEB_RST_URL");
  var evtApi = getInitApi(evtGlobalArray, "KAKA_WEB_EVT_URL");
  var crtApi = getInitApi(crGlobalArray, "KAKA_WEB_CRT_URL");
  ...
  var rstApi = getInitApi(rstArray2, "KAKA_WEB_RST_URL");
  var evtApi = getInitApi(evtArray2, "KAKA_WEB_EVT_URL");
  var crtApi = getInitApi(crArray2, "KAKA_WEB_CRT_URL");

}else{
  var rstApi = getInitApi(rstArray, "KAKA_WEB_RST_URL");
  var crtApi = getInitApi(crArray, "KAKA_WEB_CRT_URL");
  var evtApi = getInitApi(evtArray, "KAKA_WEB_EVT_URL");
}
