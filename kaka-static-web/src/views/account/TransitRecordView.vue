              ...
              >
                <template v-if="tbl.dataIndex === 'depositDate'" #default="scope">
                  <div style="display: flex; align-items: center">
                    <span>{{ humanDatetime(scope.row.depositDate) }}</span>
                  </div>
                </template>
            ...
            <el-table :data="dataState.turnover" v-loading="loading">
              ...
              >
                ...
                <template v-if="tbl.dataIndex === 'recordTime'" #default="scope">
                  <div style="display: flex; align-items: center">
                    <span>{{ humanDatetime(scope.row.recordTime) }}</span>
                  </div>
                </template>
              </el-table-column>
            </el-table>
          ...
          <div class="unbind-record-wrapper">
            <el-table :data="dataState.withdraw" :loading="loading">
              ...
              >
                ...
                <template v-if="tbl.dataIndex === 'withdrawDate'" #default="scope">
                  <div style="display: flex; align-items: center">
                    <span>{{ humanDatetime(scope.row.withdrawDate) }}</span>
                  </div>
                </template>
            ...
            <el-table :data="dataState.gameBetRecord" :loading="loading">
              ...
              >
                <template v-if="tbl.dataIndex === 'betTime'" #default="scope">
                  <div style="display: flex; align-items: center">
                    <span>{{ humanDatetime(getFormatBetTime(scope.row.betTime)) }}</span>
                  </div>
                </template>
                <template v-if="tbl.dataIndex === 'recordTime'" #default="scope">
                  <div style="display: flex; align-items: center">
          ...
          <div class="unbind-record-wrapper">
            <el-table :data="dataState.reminderRecord" :loading="loading">
              ...
              <el-table-column
                ...
                :label="tbl.title"
              >
                <template v-if="tbl.dataIndex === 'feedbackTime'" #default="scope">
                  <div style="display: flex; align-items: center">
                    <span>{{ humanDatetime(scope.row.feedbackTime) }}</span>
                  </div>
                </template>
  ...
  setup() {
    ...
    const submitReminder = () => {
      ...
      if (!reminderForm.photos) {
        ElMessage.warning(t("account.please_upload_image"));
      } else {
