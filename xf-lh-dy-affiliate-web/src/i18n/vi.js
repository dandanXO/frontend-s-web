export default {
  ...
  fields: {
    ...
    affiliate: 'Đại lý',
    affiliateAccount: 'Tài khoản Đại lý',
    ...
    downlineMember: 'Thành viên Thấp hơn',
    ...
    lastMonthTotal: 'Tổng tháng trước',
    lastWeek: 'Tuần trước',
    link: 'Liên kết Mời',
    ...
    monthBeforeLastTotal: 'Tổng trước tháng trước',
  ...
  google: {
    ...
    if_cannot_download_you_can: '2. Nếu bạn không thể tải xuống, bạn có thể tìm kiếm trên Apple App Store."',
    ...
    if_not_google_auth_then: "Nếu bạn chưa ràng buộc Google Authenticator, không cần phải điền vào.",
  ...
  forgetPassword: {
    ...
    noSecurityQuestionSet: 'Tài khoản này không thiết lập câu hỏi bảo mật, vui lòng liên hệ bộ phận hỗ trợ khách hàng',
  ...
  message: {
    ...
    confirmToAdjust: 'Bạn có chắc chắn muốn điều chỉnh? Không thể thực hiện điều chỉnh khác sau khi xác nhận.',
    ...
    passwordLength: 'Mật khẩu không được ít hơn 6 chữ số hoặc nhiều hơn 12 chữ số',
    redirectBankDeposit: 'Bạn đã được chuyển hướng đến ngân hàng cụ thể của bạn để tiến hành nạp tiền. Khi nạp tiền thành công, nó sẽ được phản ánh ở đây.',
    ...
    requiredLoginName: 'Tên đăng nhập là bắt buộc',
    ...
    requiredTelephone: 'Số điện thoại là bắt buộc',
    ...
    depositNotification1: 'Bạn sẽ được chuyển hướng đến trang của ngân hàng để hoàn tất việc nạp tiền.',
    depositNotification2: 'Nếu thành công, bạn sẽ nhận được thông báo trên trang này.',
    validateTagDescriptionRequired: 'Mô tả thẻ là bắt buộc',
    confirmDelete: 'Xác nhận bạn muốn xóa dữ liệu này, hành động này không thể hoàn tác',
