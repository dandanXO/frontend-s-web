export default {
  ...
  creditFlowType: {
    ...
    COMISSION_WALLET_WITHDRAWAL: 'Withdraw',
    COMISSION_WALLET_AFFILIATE_DEPOSIT: 'Affiliate Deposit',
  ...
  referralLink: {
    ...
    affiliateH5PlatformLink: 'H5 Platform Affiliate Link (Recommeded)',
  ...
  fields: {
    ...
    comissionWallet: 'Comission Wallet',
