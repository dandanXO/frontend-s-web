export default {
  ...
  fields: {
    ...
    affiliateSuccessSubmit: 'เรียนคู่ค้าที่เคารพ ข้อมูลของท่านได้ถูกส่งเรียบร้อยแล้ว ตัวแทนของเราจะแจ้งผลการตรวจสอบให้ท่านทราบภายใน 24 ชั่วโมง หากมีคำถาม กรุณาติดต่อตัวแทนของเราหรือบริการลูกค้าออนไลน์ของเรา ขอบคุณค่ะ',
