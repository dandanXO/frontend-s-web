export default {
  ...
  fields: {
    ...
    estimatedAffiliateCommission: '예상 대리 커미션',
    ...
    rollover: '롤오버 배수',
    search: '검색',
    secondLevelAffiliateCommission: '2급 에이전트 커미션',
    securityInfo: '보안 정보',
    ...
    transfer: '대출',
    transferAmount: '대출 금액',
    transferDate: '대출 날짜',
    transferIn: '입금',
    transferOut: '출금',
    transferRecord: '대출 기록',
    transferType: '대출 유형',
    transferUsers: '대출 회원 수',
    unread: '읽지 않음',
    upperName: '상위 명칭',
    usdtWallet: '지갑 계정',
  ...
  message: {
    ...
    requiredTransferAmount: '대출 금액을 입력하십시오',
