...
const whiteList = ['/login', '/my/login', '/my/register', '/kaka/login', '/kaka/register', '/ph/login', '/ph/register', '/th/login', '/th/register', '/xf/login', '/xf/register', '/dy/login', '/dy/register', '/ind/login', '/ind/register', '/lh/login', '/lh/register', '/vi/login', '/vi/register', '/ind2/login', '/ind2/register', '/kr/login', '/kr/register', '/pak/login', '/pak/register', '/ph1/summary']
...
router.beforeEach(async (to, _, next) => {
  ...
  if (store.state.user.token) {
    ...
    if (whiteList.indexOf(to.path) !== -1) {
      ...
      const ph1Host = "http://localhost:9998"
